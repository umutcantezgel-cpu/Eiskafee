...
- Name: tier3_forms_state.spec.ts >> Tier 3: Form Submissions & State Management >> User Authentication >> should show validation errors on empty submit
- Location: tests/e2e/tier3_forms_state.spec.ts:46:5
...
- main:
    - link "Hey Fede!":
        - /url: /
    - heading "Willkommen zurück" [level=1]
    - paragraph: Schön, dass du wieder da bist!
    - text: E-Mail
    - textbox "hallo@example.de"
    - text: Passwort
    - textbox "••••••••"
