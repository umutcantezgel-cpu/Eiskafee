...
- Name: physics-playground.spec.ts >> PhysicsPlayground >> Interaction Safety: Simulate click-and-drag events inside the canvas coordinates; verify no unhandled JS exceptions
- Location: tests/e2e/physics-playground.spec.ts:28:7
