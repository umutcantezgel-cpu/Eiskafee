...
- Name: tier3_forms_state.spec.ts >> Tier 3: Form Submissions & State Management >> Order Flow Fragments >> Confirmation page renders
- Location: tests/e2e/tier3_forms_state.spec.ts:145:5
...
Locator: getByText(/bestätigt|eingegangen/i).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/bestätigt|eingegangen/i).first()
