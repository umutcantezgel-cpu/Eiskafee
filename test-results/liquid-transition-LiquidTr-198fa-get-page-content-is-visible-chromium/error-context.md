...
- Name: liquid-transition.spec.ts >> LiquidTransition >> URL & Content Update: Verify that after the transition overlay disappears, the URL has updated and target page content is visible
- Location: tests/e2e/liquid-transition.spec.ts:25:7
