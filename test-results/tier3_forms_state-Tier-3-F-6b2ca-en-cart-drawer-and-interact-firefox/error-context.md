...
Call log:
  - waiting for getByRole('button', { name: /Hinzufügen|\+/i }).first()
    - locator resolved to <button tabindex="0" aria-label="Zum Warenkorb hinzufügen" class="bg-terracotta text-white p-2 rounded-full hover:bg-brown transition-colors shadow-sm">…</button>
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <div class="max-w-7xl mx-auto px-6 h-[88px] flex items-center justify-between gap-4">…</div> from <div class="fixed top-0 left-0 right-0 z-[900] flex flex-col">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
    - scrolling into view if needed
    - done scrolling
    - <div class="relative flex flex-col p-5 rounded-2xl bg-white shadow-clay cursor-pointer transition-shadow duration-300 hover:shadow-lg">…</div> intercepts pointer events
  4 × retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <div class="flex flex-col h-full relative">…</div> intercepts pointer events
    - retrying click action
      - waiting 500ms
      - waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
    ...
    - retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <div class="pointer-events-auto bg-cream border-2 border-peach rounded-3xl shadow-clay p-6 w-full max-w-4xl flex flex-col gap-6 relative overflow-hidden">…</div> from <div class="fixed bottom-0 left-0 right-0 z-[100] p-4 pointer-events-none flex justify-center">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 500ms
    - waiting for element to be visible, enabled and stable
    - element is not stable
...
- generic [active] [ref=e1]:
    ...
    - main [ref=e34]:
                    ...
                    - generic [ref=e47]:
                        - button "Fede Boxen" [ref=e48]:
                            - generic [ref=e49]:
                                - img [ref=e50]
                                - text: Fede Boxen
                        - button "Bubble Waffle" [ref=e54]:
                            - generic [ref=e56]:
                                - img [ref=e57]
                                - text: Bubble Waffle
                        - button "Crêpes" [ref=e65]:
                            - generic [ref=e66]:
                                - img [ref=e67]
                                - text: Crêpes
                        - button "Kuchen" [ref=e71]:
                            - generic [ref=e72]:
                                - img [ref=e73]
                                - text: Kuchen
                        - button "Cookies" [ref=e78]:
                            - generic [ref=e79]:
                                - img [ref=e80]
                                - text: Cookies
                        - button "Eisbecher 500ml" [ref=e85]:
                            - generic [ref=e86]:
                                - img [ref=e87]
                                - text: Eisbecher 500ml
                        - button "Special Shakes" [ref=e92]:
                            - generic [ref=e93]:
                                - img [ref=e94]
                                - text: Special Shakes
                        - button "Iced Drinks" [ref=e98]:
                            - generic [ref=e99]:
                                - img [ref=e100]
                                - text: Iced Drinks
                        - button "Stullen" [ref=e106]:
                            - generic [ref=e107]:
                                - img [ref=e108]
                                - text: Stullen
                        - button "Getränke" [ref=e113]:
                            - generic [ref=e114]:
                                - img [ref=e115]
                                - text: Getränke
                    - generic [ref=e123]:
        ...
        - region "Wissenswertes rund um unsere Speisekarte" [ref=e284]:
            - region "Hey Fede! Menü — Ausführliche Beschreibungen" [ref=e286]:
                ...
                - paragraph [ref=e315]:
                    - strong [ref=e316]: "Unsere Pairing-Empfehlung:"
                ...
                - list [ref=e354]:
                    ...
                    - listitem [ref=e357]:
                        - strong [ref=e358]: "Pancake Picknick Box:"
                    ...
                    - listitem [ref=e359]:
                        - strong [ref=e360]: "Sweet Lovers Box:"
            ...
            - generic [ref=e385]:
                - generic [ref=e386]:
                    ...
                    - generic [ref=e393]:
                        ...
                        - generic [ref=e399]:
                            - img [ref=e400]
                            - link "06441 7890426" [ref=e402] [cursor=pointer]:
                    ...
                    - link "Instagram" [ref=e404] [cursor=pointer]:
                        ...
                        - text: Instagram
                - generic [ref=e408]:
                    - heading "Hey Fede!" [level=3] [ref=e409]
                    - navigation "Footer Navigation" [ref=e410]:
                        - link "Startseite" [ref=e411] [cursor=pointer]:
                            - /url: /
                            - text: Startseite
                        - link "Speisekarte" [ref=e412] [cursor=pointer]:
                            - /url: /menu
                            - text: Speisekarte
                        - link "Über Uns" [ref=e413] [cursor=pointer]:
                            - /url: /about
                            - text: Über Uns
                        - link "Besuchen & Liefern" [ref=e414] [cursor=pointer]:
                            - /url: /visit
                            - text: Besuchen & Liefern
                    - heading "Entdecke Mehr" [level=3] [ref=e415]
                    - navigation "SEO Navigation" [ref=e416]:
                        - link "Bubble Waffles" [ref=e417] [cursor=pointer]:
                            - /url: /bubble-waffles-wetzlar
                        - link "Lieferservice" [ref=e418] [cursor=pointer]:
                            - /url: /lieferservice-desserts-lahn-dill
                        - link "Eisdiele & Shakes" [ref=e419] [cursor=pointer]:
                            - /url: /eisdiele-wetzlar-special-shakes
                        - link "Event Catering" [ref=e420] [cursor=pointer]:
                            - /url: /events-catering-hessen
                        - link "Vegane Desserts" [ref=e421] [cursor=pointer]:
                            - /url: /vegane-desserts-wetzlar
                - generic [ref=e422]:
                    - heading "Öffnungszeiten" [level=3] [ref=e423]
                    - generic [ref=e426]:
                        - generic [ref=e427]:
                            - generic [ref=e429]: Montag
                            - generic [ref=e431]: Geschlossen
                        - generic [ref=e432]:
                            - generic [ref=e434]: Dienstag
                            - generic [ref=e436]: Geschlossen
                        - generic [ref=e437]:
                            - generic [ref=e440]: Mittwoch
                            - generic [ref=e441]:
                                - generic [ref=e442]: 12:00 – 19:00 Uhr
                                - generic [ref=e443]: Heute
                        - generic [ref=e444]:
                            - generic [ref=e446]: Donnerstag
                            - generic [ref=e448]: 12:00 – 19:00 Uhr
                        - generic [ref=e449]:
                            - generic [ref=e451]: Freitag
                            - generic [ref=e453]: 12:00 – 19:00 Uhr
                        - generic [ref=e454]:
                            - generic [ref=e456]: Samstag
                            - generic [ref=e458]: 12:00 – 19:00 Uhr
                        - generic [ref=e459]:
                            - generic [ref=e461]: Sonntag
                            - generic [ref=e463]: 13:00 – 19:00 Uhr
                    - generic [ref=e464]: ✓ Keine Liefergebühr bei Lieferando
                - generic [ref=e465]:
                    - heading "Stay Sweet" [level=3] [ref=e466]
                    - paragraph [ref=e467]: Abonniere unseren Newsletter für exklusive Angebote und neue Bubble Waffle Kreationen.
                    - generic [ref=e469]:
                        - textbox "Bleib hungrig..." [ref=e470]
                        - button "Abonnieren" [ref=e472]:
                            - generic [ref=e473]: Abonnieren
            - generic [ref=e474]:
                - generic [ref=e475]: Frisch
                - generic [ref=e476]: ·
                - generic [ref=e477]: Selbstgemacht
                - generic [ref=e478]: ·
                - generic [ref=e479]: Mit Liebe
            - generic [ref=e480]:
                - img [ref=e481]
                - img [ref=e483]
                - img [ref=e485]
                ...
                - img [ref=e489]
            - generic [ref=e491]:
                - heading "Wir sind hier zuhause" [level=3] [ref=e492]
                - paragraph [ref=e493]:
                    - generic [ref=e494]: Hessen
                    - generic [ref=e495]: ›
                    - generic [ref=e496]: Lahn-Dill-Kreis
                    - generic [ref=e497]: ›
                    - generic [ref=e498]: Wetzlar
                    - generic [ref=e499]: ›
                    - generic [ref=e500]: Langgasse
            - generic [ref=e501]:
                - heading "Besuche uns auch auf" [level=3] [ref=e502]
                - generic [ref=e503]:
                    - link "G Google" [ref=e504] [cursor=pointer]:
                        - /url: https://maps.google.com/?q=Langgasse+68+Wetzlar
                        - generic [ref=e505]: G
                        - text: Google
                    - link "● TripAdvisor" [ref=e506] [cursor=pointer]:
                        - /url: https://www.tripadvisor.de/HeyFede-Wetzlar
                        - generic [ref=e507]: ●
                        - text: TripAdvisor
                    - link "yelp" [ref=e508] [cursor=pointer]:
                        - /url: https://www.yelp.de/biz/hey-fede-wetzlar
                        - generic [ref=e509]: yelp
            - img "Made with Love in Wetzlar" [ref=e512]
            - generic [ref=e513]:
                - paragraph [ref=e514]: © 2026 Hey Fede! Dessertbar & Café
                - generic [ref=e515]:
                    - link "Impressum" [ref=e516] [cursor=pointer]:
                        - /url: /legal#impressum
                    - link "Datenschutz" [ref=e517] [cursor=pointer]:
    ...
    - generic [ref=e520]:
        - img [ref=e522]
        - generic [ref=e529]:
            - heading "Cookies für dich!" [level=3] [ref=e530]
            - paragraph [ref=e531]: Wir verwenden Cookies, um dir das beste Erlebnis auf unserer Website zu bieten. Manche sind essenziell, andere helfen uns, unseren Service zu verbessern. Bist du einverstanden?
        - generic [ref=e532]:
            - button "Ablehnen" [ref=e533]
            - button "Anpassen" [ref=e534]
            - button "Akzeptieren" [ref=e536]:
                - generic [ref=e537]: Akzeptieren
    - alert [ref=e538]
```
