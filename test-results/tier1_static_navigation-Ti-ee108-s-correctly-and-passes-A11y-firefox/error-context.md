...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 1.46 (foreground color: #d1dfcc, background color: #b4b99d, font size: 12.0pt (16px), font weight: bold). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<a href=\"https://wa.me/49123456789\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"bg-[#3a9d52] text-white px-8 py-4 rounded-full font-black uppercase tracking-wider hover:scale-105 transition-transform shadow-lg shadow-[#3a9d52]/30\">WhatsApp Chat Starten</a>",
+                 "target": Array [
+                   ".px-8",
+                 ],
+               },
...
+   Element has insufficient color contrast of 1.46 (foreground color: #d1dfcc, background color: #b4b99d, font size: 12.0pt (16px), font weight: bold). Expected contrast ratio of 4.5:1",
+         "html": "<a href=\"https://wa.me/49123456789\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"bg-[#3a9d52] text-white px-8 py-4 rounded-full font-black uppercase tracking-wider hover:scale-105 transition-transform shadow-lg shadow-[#3a9d52]/30\">WhatsApp Chat Starten</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
