...
- Array []
+ Array [
+   [Fetch API cannot load http: /localhost:39485/visit?_rsc=5CB68i4pnAekjehf due to access control checks.],
+   [Fetch API cannot load http: /localhost:39485/menu?_rsc=5CB68i4pnAekjehf due to access control checks.],
+   [Fetch API cannot load http: /localhost:39485/auth?_rsc=5CB68i4pnAekjehf due to access control checks.],
+   [Fetch API cannot load http: /localhost:39485/about?_rsc=5CB68i4pnAekjehf due to access control checks.],
+   [Fetch API cannot load https: /firestore.googleapis.com/google.firestore.v1.Firestore/Listen/channel?gsessionid=qdykLX7WyZr_l_wek-E4UWNBABukiGC2TBim-PajxmGND3Gouhk6Kg&VER=8&database=projects%2Fhey-fedee%2Fdatabases%2F(default)&RID=rpc&SID=MvWaPXIi0AhsFwENVC9yZA&AID=17&CI=0&TYPE=xmlhttp&zx=xx4n3kylnw5a&t=1 due to access control checks.],
+   [Fetch API cannot load https: /firestore.googleapis.com/google.firestore.v1.Firestore/Listen/channel?gsessionid=qdykLX7WyZr_l_wek-E4UWNBABukiGC2TBim-PajxmGND3Gouhk6Kg&VER=8&database=projects%2Fhey-fedee%2Fdatabases%2F(default)&RID=rpc&SID=MvWaPXIi0AhsFwENVC9yZA&AID=17&CI=0&TYPE=xmlhttp&zx=mc3b7ieqbzmz&t=2 due to access control checks.],
+   [Fetch API cannot load http: /localhost:39485/about?_rsc=5oha_MqiFWlStH9F due to access control checks.],
+   [Fetch API cannot load http: /localhost:39485/about?_rsc=6Q1v7HcIw7d_mkmQ due to access control checks.],
+   [Fetch API cannot load http: /localhost:39485/about?_rsc=H4cBBCPLm59dhouN due to access control checks.],
+   [Fetch API cannot load http: /localhost:39485/about?_rsc=FZs6buFk0mTwgE8c due to access control checks.],
+   [Fetch API cannot load http: /localhost:39485/about?_rsc=PNBFcsmrOgDw5zsg due to access control checks.],
+   [Fetch API cannot load https: /firestore.googleapis.com/google.firestore.v1.Firestore/Listen/channel?VER=8&database=projects%2Fhey-fedee%2Fdatabases%2F(default)&RID=38922&CVER=22&X-HTTP-Session-Id=gsessionid&zx=19ab7pypwdr7&t=1 due to access control checks.],
+   [Fetch API cannot load https: /firestore.googleapis.com/google.firestore.v1.Firestore/Listen/channel?VER=8&database=projects%2Fhey-fedee%2Fdatabases%2F(default)&RID=89174&CVER=22&X-HTTP-Session-Id=gsessionid&zx=m124xu6x4c0z&t=1 due to access control checks.],
+ ]
```
