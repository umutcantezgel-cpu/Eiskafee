...
- Name: tier1_static_navigation.spec.ts >> Tier 1: Core Navigation & Static Content >> Info & Legal Page: /faq loads correctly and passes A11y
...
Received: "/localhost:39485/bubble-waffles-wetzlar?_rsc=QgfnF85fYcrwyI4V due to access control checks."
```
