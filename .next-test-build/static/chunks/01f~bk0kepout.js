(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
        ...
        function ({
          ...
          let v = (e) => {
            ...
            k = (0, t.jsxs)(i.motion.button, {
              ...
              className: `relative inline-flex items-center justify-center font-nunito font-extrabold text-white bg-[#CC624C] border-none rounded-full overflow-visible ${p ? "px-9 py-[15px] text-[0.96rem]" : "px-[26px] py-[11px] text-[0.88rem]"} ${x ? "opacity-60 cursor-not-allowed" : "cursor-pointer"} ${h}`,
              style: {
                boxShadow:
                  m && !x
  ...
  (e) => {
    ...
    e.s([
      ...
      function ({
        visible: e = !0,
        children: n,
        ariaLabel: r = "Über Hey Fede! — Hintergrundinformationen",
      }) {
        return e
          ? (0, t.jsx)("section", {
              "aria-label": r,
  ...
  (e) => {
    "use strict";
    var t = e.i(843476);
    let n = (0, e.i(770703).default)(() => e.A(134729), {
      loadableGenerated: { modules: [702846] },
      ssr: !1,
      loading: () =>
        (0, t.jsx)("div", {
          style: { height: 320, borderRadius: 22, background: "#eedfcc" },
        }),
    });
    e.s([
  ...
  (e) => {
    e.v((t) =>
      Promise.all(
        [
          "static/chunks/062gqflaodi99.js",
          "static/chunks/0rv_hf.cj.-1f.js",
