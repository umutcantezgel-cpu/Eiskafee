      ...
      eh =
        ((r = () => {
          let e = z("color"),
            ...
            G = () => [Z, D, i],
            C = () => [T, "full", "auto", ...G()],
            O = () => [P, "none", "subgrid", Z, D],
            W = () => ["auto", { span: ["full", P, Z, D] }, P, Z, D],
            I = () => [P, "auto", Z, D],
          ...
          return {
            ...
            classGroups: {
              ...
              grow: [{ grow: ["", $, Z, D] }],
              shrink: [{ shrink: ["", $, Z, D] }],
              order: [{ order: [P, "first", "last", "none", Z, D] }],
        ...
        (a = (e) => {
          ...
          let s = ((e, r) => {
            ...
            for (let e = i.length - 1; e >= 0; e -= 1) {
              ...
              let h =
                  0 === p.length ? "" : 1 === p.length ? p[0] : s(p).join(":"),
                k = b ? h + "!" : h,
                x = k + r;
