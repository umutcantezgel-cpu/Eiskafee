(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    e.s(["Component", 0, R, "ComponentContainer", 0, L], 308070);
    let M = [];
    ...
    function W(e) {
        ...
        if ("function" == typeof e)
          return e !== IDBDatabase.prototype.transaction ||
            ...
            ? (
              ...
              ? function (...t) {
                  return (e.apply(Q(this), t), W(q.get(this)));
                }
              : function (...t) {
                  return W(e.apply(Q(this), t));
                }
            : function (t, ...r) {
                let n = e.call(Q(this), t, ...r);
                return ($.set(n, t.sort ? t.sort() : [t]), W(n));
              };
        return (
      ...
      return (n !== e && (K.set(e, n), G.set(n, e)), n);
    }
    let Q = (e) => G.get(e),
    ...
    function eh(e) {
      ...
      if (el.has(t))
        return (
          en.debug(`There were multiple attempts to register component ${t}.`),
          !1
        );
      for (let r of (el.set(t, e), ea.values())) eu(r, e);
      for (let t of eo.values()) eu(t, e);
      return !0;
    }
    function ec(e, t) {
      let r = e.container
    ...
    class ef {
      ...
      checkDestroyed() {
        if (this.isDeleted)
          throw ed.create("app-deleted", { appName: this._name });
      }
    }
    function ep(e, t = {}) {
      let r = e;
      "object" != typeof t && (t = { name: t });
      let n = { name: ei, automaticDataCollectionEnabled: !0, ...t },
        i = n.name;
      if ("string" != typeof i || !i)
        throw ed.create("bad-app-name", { appName: String(i) });
      if ((r || (r = y()), !r)) throw ed.create("no-options");
      let s = ea.get(i);
      if (s)
        if (A(r, s.options) && A(n, s.config)) return s;
        else throw ed.create("duplicate-app", { appName: i });
      let a = new L(i);
      for (let e of el.values()) a.addComponent(e);
      let o = new ef(r, n, a);
      return (ea.set(i, o), o);
    }
    function eg(e, t, r) {
      ...
      eh(new R(`${n}-version`, () => ({ library: n, version: t }), "VERSION"));
    }
    ...
    function ev() {
      return (
        ey ||
          (ey = (function (
            e,
            { blocked: t, upgrade: r, blocking: n, terminated: i } = {},
          ) {
            ...
            throw ed.create("idb-open", { originalErrorMessage: e.message });
          })),
        ey
      );
    }
    async function ew(e) {
      try {
        let t = (await ev()).transaction(em),
          r = await t.objectStore(em).get(eI(e));
        return (await t.done, r);
      } catch (e) {
        if (e instanceof T) en.warn(e.message);
        else {
          let t = ed.create("idb-get", { originalErrorMessage: e?.message });
          en.warn(t.message);
        }
      }
    }
    async function eb(e, t) {
      try {
        let r = (await ev()).transaction(em, "readwrite"),
          n = r.objectStore(em);
        (await n.put(t, eI(e)), await r.done);
      } catch (e) {
        if (e instanceof T) en.warn(e.message);
        else {
          let t = ed.create("idb-set", { originalErrorMessage: e?.message });
          en.warn(t.message);
        }
      }
    }
          ...
          let e = e_(),
            { heartbeatsToSend: t, unsentEntries: r } = (function (
              ...
              for (let i of e) {
                ...
                if (e) {
                  if ((e.dates.push(i.date), eS(r) > t)) {
                    e.dates.pop();
                    break;
                  }
                } else if (
                  (r.push({ agent: i.agent, dates: [i.date] }), eS(r) > t)
                ) {
                  r.pop();
                  break;
                }
            ...
            n = d(JSON.stringify({ version: 2, heartbeats: t }));
          return (
    ...
    (eh(new R("platform-logger", (e) => new ee(e), "PRIVATE")),
      eh(new R("heartbeat", (e) => new eE(e), "PRIVATE")),
      eg(et, er, ""),
      eg(et, er, "esm2020"),
      eg("fire-js", ""),
      e.s(
        [
          ...
          0,
          function (e, t, r = ei) {
            ec(e, t).clearInstance(r);
          },
          "getApp",
          0,
          function (e = ei) {
            let t = ea.get(e);
            if (!t && e === ei && y()) return ep();
            if (!t) throw ed.create("no-app", { appName: e });
            return t;
          },
          "getApps",
          0,
          function () {
            return Array.from(ea.values());
          },
          "initializeApp",
          0,
          ep,
  ...
  (e) => {
    ...
    function u(e, ...t) {
      l.logLevel <= i.LogLevel.ERROR &&
        l.error(`Auth (${r.SDK_VERSION}): ${e}`, ...t);
    }
    function h(e, ...t) {
      throw p(e, ...t);
    }
    ...
    async function k(e, t, r, n, i = {}) {
      ...
      return (
        "mfaPendingCredential" in s &&
          h(e, "multi-factor-auth-required", { _serverResponse: s }),
        s
      );
    }
    async function x(e, t, r, n) {
      let i = `${t}${r}?${n}`,
        s = e.config.emulator ? b(e.config, i) : `${e.config.apiScheme}://${i}`;
      return _.includes(r) &&
        ...
        ((this.auth = e),
          ...
          (this.promise = new Promise((e, t) => {
            this.timer = setTimeout(
              () => t(c(this.auth, "network-request-failed")),
              T.get(),
            );
          })));
      }
    ...
    async function F(e, t = !1) {
      ...
      return {
        claims: s,
        token: i,
        authTime: V(U(s.auth_time)),
        issuedAtTime: V(U(s.iat)),
        expirationTime: V(U(s.exp)),
    ...
    function B(e) {
      ...
      try {
        ...
        if (!e) return (u("Failed to decode base64 JWT payload"), null);
        return JSON.parse(e);
      } catch (e) {
        return (
          u("Caught error parsing JWT payload as JSON", e?.toString()),
          null
        );
      }
    }
    ...
    async function K(e) {
      ...
      let n = e.auth,
        ...
        s = await q(e, M(n, { idToken: i }));
      g(s?.users.length, n, "internal-error");
      let a = s.users[0];
      e._notifyReloadListener(a);
      let o = a.providerUserInfo?.length ? H(a.providerUserInfo) : [],
        l =
          ((t = e.providerData),
          (r = o),
          [
        ...
        u = e.isAnonymous,
        h = !(e.email && a.passwordHash) && !l?.length;
      Object.assign(e, {
        uid: a.localId,
    ...
    async function W(e, t) {
      let r = await A(e, {}, async () => {
        let r = (0, n.querystring)({
          ...
          a = await x(e, i, "/v1/token", `key=${s}`),
          o = await e._getAdditionalHeaders();
        o["Content-Type"] = "application/x-www-form-urlencoded";
        let l = { method: "POST", headers: o, body: r };
        return (
          e.emulatorConfig &&
            (0, n.isCloudWorkstation)(e.emulatorConfig.host) &&
    ...
    class J {
      ...
      async getToken(e, t = !1) {
        return t || !this.accessToken || this.isExpired
          ? (g(this.refreshToken, e, "user-token-expired"), this.refreshToken)
      ...
      async refresh(e, t) {
        let { accessToken: r, refreshToken: n, expiresIn: i } = await W(e, t);
      ...
      static fromJSON(e, t) {
        let { refreshToken: r, accessToken: n, expirationTime: i } = t,
          s = new J();
        return (
          r &&
    ...
    function Y(e, t) {
      g("string" == typeof e || void 0 === e, "internal-error", { appName: t });
    }
    class X {
      ...
      async delete() {
        ...
        return (
          await q(this, L(this.auth, { idToken: e })),
      ...
      static _fromJSON(e, t) {
        ...
        g(h && p, e, "internal-error");
        let m = J.fromJSON(this.name, p);
        (g("string" == typeof h, e, "internal-error"),
          Y(r, e.name),
          Y(n, e.name),
          g("boolean" == typeof c, e, "internal-error"),
        ...
        return (
          f && Array.isArray(f) && (y.providerData = f.map((e) => ({ ...e }))),
          o && (y._redirectEventId = o),
          y
        );
      }
      ...
      static async _fromGetAccountInfoResponse(e, t, r) {
        ...
        let i = void 0 !== n.providerUserInfo ? H(n.providerUserInfo) : [],
    ...
    class en {
      constructor(e, t, r) {
        ...
        ((this.fullUserKey = er(this.userKey, n.apiKey, i)),
          (this.fullPersistenceKey = er("persistence", n.apiKey, i)),
      ...
      async getCurrentUser() {
        ...
        if (!e) return null;
        if ("string" == typeof e) {
          let t = await M(this.auth, { idToken: e }).catch(() => void 0);
        ...
        for (let r of t)
          try {
            ...
            if (t) {
              let n;
              if ("string" == typeof t) {
                let r = await M(e, { idToken: t }).catch(() => void 0);
                if (!r) break;
                n = await X._fromGetAccountInfoResponse(e, r, t);
              } else n = X._fromJSON(e, t);
              (r !== i && (a = n), (i = r));
              break;
            }
          } catch {}
    ...
    function ei(e) {
        ...
        return "Opera";
      {
        ...
        if (eh(t)) return "Blackberry";
        if (ec(t)) return "Webos";
        if (ea(t)) return "Safari";
        if ((t.includes("chrome/") || eo(t)) && !t.includes("edge/"))
          return "Chrome";
        if (eu(t)) return "Android";
    ...
    function ef(e = (0, n.getUA)()) {
      return (
        ed(e) || eu(e) || ec(e) || eh(e) || /windows phone/i.test(e) || el(e)
      );
    }
    function ep(e, t = []) {
      let i;
    ...
    class ev {
      constructor(e, t, r, n) {
        ((this.app = e),
          ...
          (this.authStateSubscription = new eb(this)),
          (this.idTokenSubscription = new eb(this)),
          (this.beforeStateQueue = new eg(this)),
      ...
      _initializeWithPersistence(e, t) {
        return (
          t && (this._popupRedirectResolver = ee(t)),
          (this._initializationPromise = this.queue(async () => {
            if (!this._deleted) {
              if (
                ((this.persistenceManager = await en.create(this, e)),
      ...
      async initializeCurrentUserFromIdToken(e) {
        try {
          let t = await M(this, { idToken: e }),
            r = await X._fromGetAccountInfoResponse(this, t, e);
      ...
      async initializeCurrentUser(e) {
        ...
        return (g(this._popupRedirectResolver, this, "argument-error"),
        await this.getOrInitRedirectPersistenceManager(),
        this.redirectUser &&
      ...
      async getOrInitRedirectPersistenceManager(e) {
        if (!this.redirectPersistenceManager) {
          ...
          (g(t, this, "argument-error"),
            (this.redirectPersistenceManager = await en.create(
              this,
              [ee(t._redirectPersistence)],
              "redirectUser",
            )),
            (this.redirectUser =
      ...
      async _getAppCheckToken() {
        ...
        return (
          e?.error &&
            (function (e, ...t) {
              l.logLevel <= i.LogLevel.WARN &&
                l.warn(`Auth (${r.SDK_VERSION}): ${e}`, ...t);
    ...
    class eC {
      ...
      async verify(e = "verify", t = !1) {
        ...
        return this.auth.settings.appVerificationDisabledForTesting
          ? new e_().execute("siteKey", { action: "verify" })
          : new Promise((e, i) => {
              r(this.auth)
                .then((r) => {
                  if (!t && R(window.grecaptcha)) n(r, e, i);
                  else {
                    var s;
                    if ("u" < typeof window)
                      return void i(
    ...
    async function ex(e) {
      ...
      (null == t.tenantId
        ...
        r.isAnyProviderEnabled() && new eC(t).verify());
    }
    function eD(e, t, r) {
      let i = ew(e);
      g(/^https?:\/\//.test(t), i, "invalid-emulator-scheme");
      let s = !!r?.disableWarnings,
        a = eN(t),
        { host: o, port: l } = (function (e) {
          let t = eN(e),
          ...
          if (i) {
            let e = i[1];
            return { host: e, port: eR(n.substr(e.length + 1)) };
          }
          {
            let [e, t] = n.split(":");
            return { host: e, port: eR(t) };
          }
        })(t),
        u = null === l ? "" : `:${l}`,
        h = { url: `${a}//${o}${u}/` },
      ...
      if (!i._canInitEmulator) {
        (g(i.config.emulator && i.emulatorConfig, i, "emulator-config-failed"),
          g(
    ...
    async function eM(e, t) {
      return C(e, "POST", "/v1/accounts:sendOobCode", S(e, t));
    }
    ...
    class eB extends eO {
      ...
      static _fromEmailAndPassword(e, t) {
        return new eB(e, t, "password");
      }
      static _fromEmailAndCode(e, t, r = null) {
        return new eB(e, t, "emailLink", r);
      }
      toJSON() {
        return {
          email: this._email,
    ...
    class eq extends eO {
      ...
      static fromJSON(e) {
        ...
        let i = new eq(t, r);
        return (
          (i.idToken = n.idToken || void 0),
          (i.accessToken = n.accessToken || void 0),
          (i.secret = n.secret),
          (i.nonce = n.nonce),
          (i.pendingToken = n.pendingToken || null),
          i
        );
      }
      _getIdTokenResponse(e) {
    ...
    async function eK(e, t) {
      ...
      if (r.temporaryProof)
        throw N(e, "account-exists-with-different-credential", r);
      return r;
    }
    let eG = { USER_NOT_FOUND: "user-not-found" };
    async function eH(e, t) {
      return k(
        e,
        "POST",
        "/v1/accounts:signInWithPhoneNumber",
        S(e, { ...t, operation: "REAUTH" }),
        eG,
      );
    }
    class eW extends eO {
      ...
      static _fromVerification(e, t) {
        return new eW({ verificationId: e, verificationCode: t });
      }
      static _fromTokenResponse(e, t) {
        return new eW({ phoneNumber: e, temporaryProof: t });
      }
      _getIdTokenResponse(e) {
        return e$(e, this._makeVerificationRequest());
      }
      _linkToIdToken(e, t) {
        return eK(e, { idToken: t, ...this._makeVerificationRequest() });
      }
      _getReauthenticationResolver(e) {
        return eH(e, this._makeVerificationRequest());
      }
    ...
    class eJ {
      ...
      static credential(e, t) {
        return eB._fromEmailAndPassword(e, t);
      }
      static credentialWithLink(e, t) {
        let r = eQ.parseLink(t);
        return (
          g(r, "argument-error"),
          eB._fromEmailAndCode(e, r.code, r.tenantId)
        );
      }
    }
    ((eJ.PROVIDER_ID = "password"),
      (eJ.EMAIL_PASSWORD_SIGN_IN_METHOD = "password"),
      (eJ.EMAIL_LINK_SIGN_IN_METHOD = "emailLink"));
    class eY {
      constructor(e) {
        ((this.providerId = e),
    ...
    class eZ extends eX {
      ...
      static credential(e) {
        return eq._fromParams({
          ...
          signInMethod: eZ.FACEBOOK_SIGN_IN_METHOD,
          accessToken: e,
        });
      }
      ...
      static credentialFromTaggedObject({ _tokenResponse: e }) {
        if (!e || !("oauthAccessToken" in e) || !e.oauthAccessToken)
          return null;
        try {
          return eZ.credential(e.oauthAccessToken);
        } catch {
          return null;
        }
      }
    }
    ((eZ.FACEBOOK_SIGN_IN_METHOD = "facebook.com"),
      (eZ.PROVIDER_ID = "facebook.com"));
    class e0 extends eX {
      constructor() {
      ...
      static credential(e, t) {
        return eq._fromParams({
          ...
          signInMethod: e0.GOOGLE_SIGN_IN_METHOD,
          idToken: e,
          accessToken: t,
        });
      }
      ...
      static credentialFromTaggedObject({ _tokenResponse: e }) {
        ...
        if (!t && !r) return null;
        try {
          return e0.credential(t, r);
        } catch {
          return null;
        }
      }
    }
    ((e0.GOOGLE_SIGN_IN_METHOD = "google.com"),
      (e0.PROVIDER_ID = "google.com"));
    class e1 extends eX {
      constructor() {
        super("github.com");
      }
      static credential(e) {
        return eq._fromParams({
          ...
          signInMethod: e1.GITHUB_SIGN_IN_METHOD,
          accessToken: e,
        });
      }
      static credentialFromResult(e) {
    ...
    ((e1.GITHUB_SIGN_IN_METHOD = "github.com"),
      (e1.PROVIDER_ID = "github.com"));
    class e2 extends eX {
      constructor() {
        super("twitter.com");
      }
    ...
    async function e6(e, t) {
      return k(e, "POST", "/v1/accounts:signUp", S(e, t));
    }
    ((e2.TWITTER_SIGN_IN_METHOD = "twitter.com"),
      (e2.PROVIDER_ID = "twitter.com"));
    class e5 {
      constructor(e) {
        ((this.user = e.user),
      ...
      static async _fromIdTokenResponse(e, t, r, n = !1) {
        return new e5({
          user: await X._fromIdTokenResponse(e, r, n),
          providerId: e3(r),
          _tokenResponse: r,
          operationType: t,
        });
    ...
    class e4 extends n.FirebaseError {
      constructor(e, t, r, n) {
        (super(t.code, t.message),
          (this.operationType = r),
          (this.user = n),
          Object.setPrototypeOf(this, e4.prototype),
          (this.customData = {
            appName: e.name,
    ...
    async function e9(e, t, n = !1) {
      ...
      try {
        let r = await q(e, e8(i, s, t, e), n);
        g(r.idToken, i, "internal-error");
        let a = B(r.idToken);
        g(a, i, "internal-error");
        let { sub: o } = a;
        return (g(e.uid === o, i, "user-mismatch"), e5._forOperation(e, s, r));
      } catch (e) {
        throw (e?.code === "auth/user-not-found" && h(i, "user-mismatch"), e);
      }
    }
    ...
    async function ta(e, t, r) {
      ...
      (r &&
        (g(r.url?.length > 0, n, "invalid-continue-uri"),
        g(
        ...
        g(
          void 0 === r.linkDomain || r.linkDomain.length > 0,
          n,
          "invalid-hosting-link-domain",
        ),
        (i.continueUrl = r.url),
        (i.dynamicLinkDomain = r.dynamicLinkDomain),
        (i.linkDomain = r.linkDomain),
        (i.canHandleCodeInApp = r.handleCodeInApp),
        r.iOS &&
          (g(r.iOS.bundleId.length > 0, n, "missing-ios-bundle-id"),
          (i.iOSBundleId = r.iOS.bundleId)),
        r.android &&
          (g(r.android.packageName.length > 0, n, "missing-android-pkg-name"),
          (i.androidInstallApp = r.android.installApp),
          (i.androidMinimumVersionCode = r.android.minimumVersion),
          (i.androidPackageName = r.android.packageName))),
        await ek(n, i, "getOobCode", eV, "EMAIL_PASSWORD_PROVIDER"));
    }
    async function to(e, t, n) {
      ...
      let i = ew(e),
        ...
        a = await s.catch((t) => {
          throw (
            "auth/password-does-not-meet-requirements" === t.code && ts(e),
            t
          );
        }),
        o = await e5._fromIdTokenResponse(i, "signIn", a);
    ...
    class th {
      ...
      _isAvailable() {
        try {
          ...
          return (
            this.storage.setItem(tu, "1"),
            this.storage.removeItem(tu),
            Promise.resolve(!0)
          );
        } catch {
    ...
    class tf {
      ...
      async handleEvent(e) {
        let { eventId: t, eventType: r, data: n } = e.data,
    ...
    function t_(e, t) {
      return e.transaction([tb], t ? "readwrite" : "readonly").objectStore(tb);
    }
    function tT() {
      let e = indexedDB.open(tw, 1);
      return new Promise((t, r) => {
        (e.addEventListener("error", () => {
          ...
          e.addEventListener("upgradeneeded", () => {
            let t = e.result;
            try {
              t.createObjectStore(tb, { keyPath: tI });
            } catch (e) {
              r(e);
            }
          }),
          e.addEventListener("success", async () => {
            let r = e.result;
            r.objectStoreNames.contains(tb)
              ? t(r)
              : (r.close(),
                await new tE(indexedDB.deleteDatabase(tw)).toPromise(),
                t(await tT()));
          }));
      });
    }
    async function tS(e, t, r) {
      return new tE(t_(e, !0).put({ [tI]: t, value: r })).toPromise();
    }
    async function tC(e, t) {
      let r = t_(e, !1).get(t),
        n = await new tE(r).toPromise();
      return void 0 === n ? null : n.value;
    }
    function tA(e, t) {
      return new tE(t_(e, !0).delete(t)).toPromise();
    }
    class tk {
      constructor() {
        ((this.type = "LOCAL"),
      ...
      async initializeServiceWorkerMessaging() {
        return ty() ? this.initializeReceiver() : this.initializeSender();
      }
      async initializeReceiver() {
        ((this.receiver = tf._getInstance(ty() ? self : null)),
      ...
      async initializeSender() {
        if (
          ((this.activeServiceWorker = await tv()), !this.activeServiceWorker)
        )
          return;
      ...
      async _isAvailable() {
        try {
          ...
          let e = await tT();
          return (await tS(e, tu, "1"), await tA(e, tu), !0);
        } catch {}
        return !1;
      }
      ...
      async _set(e, t) {
        return this._withPendingWrite(
          async () => (
            await this._withRetries((r) => tS(r, e, t)),
            (this.localCache[e] = t),
      ...
      async _get(e) {
        let t = await this._withRetries((t) => tC(t, e));
        return ((this.localCache[e] = t), t);
      }
      async _remove(e) {
        return this._withPendingWrite(
          async () => (
            await this._withRetries((t) => tA(t, e)),
      ...
      async _poll() {
        let e = await this._withRetries((e) =>
          new tE(t_(e, !1).getAll()).toPromise(),
        );
        if (!e || 0 !== this.pendingWrites) return [];
        let t = [],
          r = new Set();
        if (0 !== e.length)
          for (let { fbase_key: n, value: i } of e)
            (r.add(n),
    ...
    ((tk.type = "LOCAL"), eE("rcb"), new w(3e4, 6e4));
    let tD = "recaptcha";
    async function tN(e, t, r) {
      ...
      try {
        let n;
        if (
          ((n = "string" == typeof t ? { phoneNumber: t } : t), "session" in n)
        ) {
          let t = n.session;
          if ("phoneNumber" in n) {
            ...
            let i = {
              ...
              s = async (e, t) => {
                if (t.phoneEnrollmentInfo.captchaResponse === eS) {
                  g(r?.type === tD, e, "argument-error");
                  let n = await tR(e, t, r);
                  return tl(e, n);
                }
                return tl(e, t);
              },
        ...
        {
          let t = { phoneNumber: n.phoneNumber, clientType: "CLIENT_TYPE_WEB" },
            i = async (e, t) => {
    ...
    class tO {
      constructor(e) {
        ((this.providerId = tO.PROVIDER_ID), (this.auth = ew(e)));
      }
      verifyPhoneNumber(e, t) {
        return tN(this.auth, e, (0, n.getModularInstance)(t));
      }
      static credential(e, t) {
        return eW._fromVerification(e, t);
      }
      static credentialFromResult(e) {
      ...
      static credentialFromTaggedObject({ _tokenResponse: e }) {
        ...
        return t && r ? eW._fromTokenResponse(t, r) : null;
      }
    }
    ...
    function tL(e) {
      return te(e.auth, new tP(e), e.bypassAuthState);
    }
    function tM(e) {
      let { auth: t, user: r } = e;
      return (g(r, t, "internal-error"), e9(r, new tP(e), e.bypassAuthState));
    }
    async function tV(e) {
      let { auth: t, user: r } = e;
      return (g(r, t, "internal-error"), e7(r, new tP(e), e.bypassAuthState));
    }
    class tF {
        ...
        let e = () => {
          if (this.authWindow?.window?.closed) {
            this.pollId = window.setTimeout(() => {
              ((this.pollId = null),
                this.reject(c(this.auth, "popup-closed-by-user")));
            }, 8e3);
            return;
          }
    ...
    class tq extends tF {
      ...
      async execute() {
        let e = tj.get(this.auth._key());
        if (!e) {
          try {
            let t = (await tz(this.resolver, this.auth))
              ? await super.execute()
              : null;
            e = () => Promise.resolve(t);
          } catch (t) {
          ...
          tj.set(this.auth._key(), e);
        }
        return (
          this.bypassAuthState ||
            tj.set(this.auth._key(), () => Promise.resolve(null)),
          e()
        );
      }
      async onAuthEvent(e) {
    ...
    async function tK(e, t, n = !1) {
      if ((0, r._isFirebaseServerApp)(e.app)) return Promise.reject(f(e));
      let i = ew(e),
        s = t
          ? ee(t)
          : (g(i._popupRedirectResolver, i, "argument-error"),
    ...
    class tG {
      ...
      hasEventBeenHandled(e) {
        return (
          ...
          this.cachedEventUids.has(tH(e))
        );
      }
      saveEventToCache(e) {
        (this.cachedEventUids.add(tH(e)),
          (this.lastProcessedEventTime = Date.now()));
      }
    }
    function tH(e) {
    ...
    async function t3(e) {
      let t,
            ...
            function n() {
              (t0(),
                gapi.load("gapi.iframes", {
                  ...
                  ontimeout: () => {
                    (t0(), r(c(e, "network-request-failed")));
                  },
                  timeout: tZ.get(),
                }));
            }
            if (tm().gapi?.iframes?.Iframe) t(gapi.iframes.getContext());
            else if (tm().gapi?.load) n();
            else {
              var i;
              let t = eE("iframefcb");
              return (
                ...
                ((i = `${eI.gapiScript}?onload=${t}`), eI.loadJS(i)).catch(
                  (e) => r(e),
                )
              );
            }
        ...
        u = tm().gapi;
      return (
        g(u, e, "internal-error"),
        l.open(
          {
            where: document.body,
            url:
              (g((t = e.config).authDomain, e, "auth-domain-config-required"),
              (i = t.emulator
                ? b(t, "emulator/auth/iframe")
    ...
    let t7 = encodeURIComponent("fac");
    async function t9(e, t, i, s, a, o) {
      ...
      let u = await e._getAppCheckToken(),
        h = u ? `#${t7}=${encodeURIComponent(u)}` : "";
      return `${(function ({ config: e }) {
        return e.emulator
          ? b(e, "emulator/auth/handler")
          : `https://${e.authDomain}/__/auth/handler`;
      })(e)}?${(0, n.querystring)(l).slice(1)}${h}`;
    }
    let re = "webStorageSupport",
      rt = class {
        constructor() {
          ((this.eventManagers = {}),
            (this.iframes = {}),
            (this.originValidationPromises = {}),
            (this._redirectPersistence = td),
            (this._completeRedirectFn = tK),
            (this._overrideRedirectResult = t$));
        }
        async _openPopup(e, t, r, i) {
          var s, a;
          ((s = this.eventManagers[e._key()]?.manager),
            (a = "_initialize() not called before _openPopup()"),
            s || m(a));
          let o = await t9(e, t, r, y(), i);
          return (function (e, t, r, i = 500, s = 600) {
            ...
            (r && (l = eo(h) ? "_blank" : r),
              es(h) && ((t = t || "http://localhost"), (u.scrollbars = "yes")));
            let c = Object.entries(u).reduce(
              (e, [t, r]) => `${e}${t}=${r},`,
              "",
            );
            if (
              (function (e = (0, n.getUA)()) {
                return ed(e) && !!window.navigator?.standalone;
              })(h) &&
              "_self" !== l
            ) {
              var d, f;
        ...
        async initAndGetManager(e) {
          ...
          return (
            t.register(
              "authEvent",
              (t) => (
                g(t?.authEvent, e, "invalid-auth-event"),
        ...
        _isIframeWebStorageSupported(e, t) {
          this.iframes[e._key()].send(
            ...
            (r) => {
              let n = r?.[0]?.[re];
              (void 0 !== n && t(!!n), h(e, "internal-error"));
            },
            gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER,
          );
        }
        _originValidation(e) {
          ...
          return (
            this.originValidationPromises[t] ||
              (this.originValidationPromises[t] = tX(e)),
            this.originValidationPromises[t]
          );
        }
    ...
    let rs = (0, n.getExperimentalSetting)("authIdTokenMaxAge") || 300,
      ra = null;
    ((eI = {
      loadJS: (e) =>
        new Promise((t, r) => {
      ...
      (0, r._registerComponent)(
        new s.Component(
          ...
          (e, { options: r }) => {
            ...
            g(l && !l.includes(":"), "invalid-api-key", { appName: s.name });
            let h = new ev(s, a, o, {
              apiKey: l,
              authDomain: u,
              clientPlatform: t,
              ...
              apiScheme: "https",
              sdkClientVersion: ep(t),
            });
            return (
              (i = (Array.isArray((n = r?.persistence || [])) ? n : [n]).map(
                ee,
              )),
              r?.errorMap && h._updateErrorMap(r.errorMap),
              h._initializeWithPersistence(i, r?.popupRedirectResolver),
              h
            );
          },
          "PUBLIC",
      ...
      (0, r._registerComponent)(
        new s.Component(
          "auth-internal",
          (e) => new ri(ew(e.getProvider("auth").getImmediate())),
          "PRIVATE",
        ).setInstantiationMode("EXPLICIT"),
      ),
      (0, r.registerVersion)(
      ...
      (0, r.registerVersion)(rr, rn, "esm2020"),
      e.s(
        [
          "D",
          0,
          ...
          function (e, t, i) {
            return (0, r._isFirebaseServerApp)(e.app)
              ? Promise.reject(f(e))
              : tt((0, n.getModularInstance)(e), eJ.credential(t, i)).catch(
                  async (t) => {
                    throw (
          ...
          "p",
          0,
          function (e = (0, r.getApp)()) {
            let t = (0, r._getProvider)(e, "auth");
            if (t.isInitialized()) return t.getImmediate();
            let i = (function (e, t) {
                let i = (0, r._getProvider)(e, "auth");
                if (i.isInitialized()) {
                  let e = i.getImmediate(),
                    r = i.getOptions();
                  if ((0, n.deepEqual)(r, t ?? {})) return e;
                  h(e, "already-initialized");
                }
                return i.initialize({ options: t });
              })(e, { popupRedirectResolver: rt, persistence: [tk, tc, td] }),
                  ...
                  r =
                    ...
                    async (e) => {
                      let r = e && (await e.getIdTokenResult()),
                        n =
                          r &&
                          (new Date().getTime() - Date.parse(r.issuedAtTime)) /
                            1e3;
                      if (n && n > rs) return;
                      let i = r?.token;
                      ra !== i &&
            ...
            let a = (0, n.getDefaultEmulatorHost)("auth");
  ...
  (e, t, r) => {
          ...
          ((o.isBuffer = function (e) {
            ...
            (o.concat = function (e, t) {
              ...
              for (r = 0; r < e.length; ++r) {
                var s = e[r];
                if ((x(s, Uint8Array) && (s = o.from(s)), !o.isBuffer(s)))
                  throw TypeError(
    ...
    ((s.ab = "/ROOT/node_modules/next/dist/compiled/buffer/"),
      (t.exports = s(72)));
  },
  436180,
  727286,
  ...
  (e) => {
    ...
    (function () {
      ...
      ((i.prototype = n.prototype),
        ...
        (e.prototype.v = function (e, t) {
          ...
          let r = t - this.blockSize,
            ...
            a = 0;
          for (; a < t; ) {
            if (0 == i) for (; a <= r; ) (s(this, e, a), (a += this.blockSize));
            if ("string" == typeof e) {
              for (; a < t; )
                if (((n[i++] = e.charCodeAt(a++)), i == this.blockSize)) {
                  (s(this, n), (i = 0));
                  break;
                }
            } else
              for (; a < t; )
                if (((n[i++] = e[a++]), i == this.blockSize)) {
                  (s(this, n), (i = 0));
                  break;
                }
          }
        ...
        (e.prototype.A = function () {
          ...
          t = 8 * this.o;
          for (var r = e.length - 8; r < e.length; ++r)
            ((e[r] = 255 & t), (t /= 256));
          for (this.v(e), e = Array(16), t = 0, r = 0; r < 4; ++r)
            for (let n = 0; n < 32; n += 8) e[t++] = (this.g[r] >>> n) & 255;
          return e;
        }));
      var o,
        l = {};
      function u(e) {
        ...
        return -128 <= e && e < 128
          ? ((t = function (e) {
              return new a([0 | e], e < 0 ? -1 : 0);
            }),
            Object.prototype.hasOwnProperty.call(l, e) ? l[e] : (l[e] = t(e)))
          : new a([0 | e], e < 0 ? -1 : 0);
      }
      function h(e) {
        ...
        let t = [],
          r = 1;
        for (let n = 0; e >= r; n++) ((t[n] = (e / r) | 0), (r *= 0x100000000));
        return new a(t, 0);
      }
      var c = u(0),
        d = u(1),
      ...
      function m(e) {
        let t = e.g.length,
          r = [];
        for (let n = 0; n < t; n++) r[n] = ~e.g[n];
        return new a(r, ~e.h).add(d);
      }
      function y(e, t) {
        return e.add(m(t));
      }
      ...
      function b(e, t) {
        ...
        if (g(e)) return ((t = b(m(e), t)), new w(m(t.g), m(t.h)));
        if (g(t)) return ((t = b(e, m(t))), new w(m(t.g), t.h));
        if (e.g.length > 30) {
          if (g(e) || g(t))
      ...
      function E(e) {
        let t = e.g.length + 1,
          r = [];
        for (let n = 0; n < t; n++) r[n] = (e.i(n) << 1) | (e.i(n - 1) >>> 31);
        return new a(r, e.h);
      }
      function _(e, t) {
        let r = t >> 5;
        ...
        for (let s = 0; s < n; s++)
          i[s] =
            t > 0
              ? (e.i(s + r) >>> t) | (e.i(s + r + 1) << (32 - t))
              : e.i(s + r);
        return new a(i, e.h);
      }
      (((o = a.prototype).m = function () {
        if (g(this)) return -m(this).m();
        let e = 0,
          t = 1;
        for (let r = 0; r < this.g.length; r++) {
          let n = this.i(r);
          ((e += (n >= 0 ? n : 0x100000000 + n) * t), (t *= 0x100000000));
        }
        return e;
      }),
        (o.toString = function (e) {
          ...
          let t = h(Math.pow(e, 6));
          var r = this;
          let n = "";
          for (;;) {
            let i = b(r, t).g,
              s = (
                ((r = y(r, i.j(t))).g.length > 0 ? r.g[0] : r.h) >>> 0
              ).toString(e);
            if (p((r = i))) return s + n;
        ...
        (o.add = function (e) {
          let t = Math.max(this.g.length, e.g.length),
            ...
            n = 0;
          for (let i = 0; i <= t; i++) {
            let t = n + (65535 & this.i(i)) + (65535 & e.i(i)),
              s = (t >>> 16) + (this.i(i) >>> 16) + (e.i(i) >>> 16);
            ((n = s >>> 16),
              (t &= 65535),
              (s &= 65535),
              (r[i] = (s << 16) | t));
        ...
        (o.j = function (e) {
          ...
          for (e = 0; e < t; e++) r[e] = (r[2 * e + 1] << 16) | r[2 * e];
          for (e = t; e < 2 * t; e++) r[e] = 0;
          return new a(r, 0);
        }),
        (o.B = function (e) {
          return b(this, e).h;
        ...
        (o.and = function (e) {
          let t = Math.max(this.g.length, e.g.length),
            r = [];
          for (let n = 0; n < t; n++) r[n] = this.i(n) & e.i(n);
          return new a(r, this.h & e.h);
        }),
        (o.or = function (e) {
          let t = Math.max(this.g.length, e.g.length),
            r = [];
        ...
        (e.prototype.digest = e.prototype.A),
        (e.prototype.reset = e.prototype.u),
        (e.prototype.update = e.prototype.v),
        (r = I.Md5 = e),
        (a.prototype.add = a.prototype.add),
        (a.prototype.multiply = a.prototype.j),
        (a.prototype.modulo = a.prototype.B),
        ...
        (a.fromString = function e(t, r) {
          ...
          let n = h(Math.pow(r, 8)),
            i = c;
          for (let e = 0; e < t.length; e += 8) {
            var s = Math.min(8, t.length - e);
            let a = parseInt(t.substring(e, e + s), r);
            s < 8
              ? ((s = h(Math.pow(r, s))), (i = i.j(s).add(h(a))))
              : (i = (i = i.j(n)).add(h(a)));
          }
          return i;
        }),
    ...
    (function () {
        ...
        if (t)
          e: {
            ...
            (t = t((i = n[(e = e[e.length - 1])]))) != i &&
              null != t &&
              r(n, e, { configurable: !0, writable: !0, value: t });
          }
      }
      (d("Symbol.dispose", function (e) {
      ...
      function y(e, t, r) {
        return (y = m).apply(null, arguments);
      }
      function v(e, t) {
      ...
      var b =
        "u" > typeof AsyncContext && "function" == typeof AsyncContext.Snapshot
                ...
                "object" != r
                  ...
                  : n
                    ? Array.isArray(n)
                      ...
                      : r
                    : "null") ||
            ("object" == r && "number" == typeof n.length)
          ) {
            r = e.length || 0;
            let t = n.length || 0;
            e.length = r + t;
      ...
      function N() {
        ...
        for (
          ...
          (S.j(t), S.h < 100 && (S.h++, (t.next = S.g), (S.g = t)));
        }
        k = !1;
      }
      function R() {
      ...
      (w(M, O),
        (M.prototype.init = function (e, t) {
          ...
          ((this.target = e.target || e.srcElement),
            ...
            (this.state = e.state),
            (this.i = e),
            e.defaultPrevented && M.Z.h.call(this));
        }),
      ...
      function G(e, t) {
        ...
        if (r in e.g) {
          ...
          ((n = s >= 0) && Array.prototype.splice.call(i, s, 1),
            n && (B(t), 0 == e.g[r].length && (delete e.g[r], e.h--)));
        }
      }
      function H(e, t, r, n) {
      ...
      K.prototype.add = function (e, t, r, n, i) {
        let s = e.toString();
        ...
        return (
          a > -1
            ? ((t = e[a]), r || (t.fa = !1))
            : (((t = new U(t, this.src, s, !!n, i)).fa = r), e.push(t)),
          t
        );
      };
      ...
      function J(e, t, r, n, i, s) {
        ...
        let a = g(i) ? !!i.capture : !!i,
          o = ee(e);
        if ((o || (e[W] = o = new K(e)), (r = o.add(t, r, n, a, s)).proxy))
          return r;
        if (
          ((n = function e(t) {
            return Z.call(e.src, e.listener, t);
          }),
          (r.proxy = n),
          (n.src = e),
          (n.listener = r),
        ...
        else if (e.attachEvent) e.attachEvent(X(t.toString()), n);
        ...
        if ("number" != typeof e && e && !e.da) {
          ...
          if (t && t[V]) G(t.i, e);
            ...
            (t.removeEventListener
              ...
              (r = ee(t))
                ? (G(r, e), 0 == r.h && ((r.src = null), (t[W] = null)))
                : B(e));
          }
        }
      }
      ...
      function Z(e, t) {
        if (e.da) e = !0;
          ...
          let r = e.listener,
            n = e.ha || e.src;
          (e.fa && Y(e), (e = r.call(n, t)));
        }
        return e;
      }
      function ee(e) {
        return (e = e[W]) instanceof K ? e : null;
      }
      ...
      function ei(e, t) {
        ...
        if (((e = e.M), (s = t.type || t), "string" == typeof t))
          t = new O(t, e);
        ...
        if (((a = !0), i))
          for (n = i.length - 1; n >= 0; n--)
            a = es((r = t.g = i[n]), s, !0, t) && a;
        if (
          ((a = es((r = t.g = e), s, !0, t) && a),
          (a = es(r, s, !1, t) && a),
          i)
        )
          for (n = 0; n < i.length; n++)
            a = es((r = t.g = i[n]), s, !1, t) && a;
      }
      function es(e, t, r, n) {
      ...
      (w(en, R),
        (en.prototype[V] = !0),
        (en.prototype.removeEventListener = function (e, t, r, n) {
          !(function e(t, r, n, i, s) {
            if (Array.isArray(r))
              for (var a = 0; a < r.length; a++) e(t, r[a], n, i, s);
            else
              ((i = g(i) ? !!i.capture : !!i), (n = er(n)), t && t[V])
                ? ((t = t.i),
                  (a = String(r).toString()) in t.g &&
                    (n = H((r = t.g[a]), n, i, s)) > -1 &&
                    (B(r[n]),
                    Array.prototype.splice.call(r, n, 1),
                    0 == r.length && (delete t.g[a], t.h--)))
                : t &&
                  (t = ee(t)) &&
                  ((r = t.g[r.toString()]),
                  (t = -1),
        ...
        (en.prototype.N = function () {
          if ((en.Z.N.call(this), this.i)) {
            var e = this.i;
            for (let t in e.g) {
              let r = e.g[t];
              for (let e = 0; e < r.length; e++) B(r[e]);
              (delete e.g[t], e.h--);
            }
          }
          this.G = null;
        }),
        (en.prototype.J = function (e, t, r, n) {
          return this.i.add(String(e), t, !1, r, n);
        }),
        (en.prototype.K = function (e, t, r, n) {
      ...
      ((eo.prototype.N = function () {
        (eo.Z.N.call(this), eu(this));
      }),
        (eo.prototype.handleEvent = function () {
          throw Error("EventHandler.handleEvent not implemented");
        }));
      var eh = p.JSON.stringify,
        ec = p.JSON.parse,
        ed = class {
          stringify(e) {
      ...
      function ef() {}
      function ep() {}
      var eg = { OPEN: "a", hb: "b", ERROR: "c", tb: "d" };
      function em() {
        O.call(this, "d");
      }
      function ey() {
      ...
      function e_(e, t) {
        (O.call(this, ev.STAT_EVENT, e), (this.stat = t));
      }
      function eT(e) {
        let t = eb();
        ei(t, new e_(t, e));
      ...
      function eS(e, t) {
        (O.call(this, ev.Ja, e), (this.size = t));
      }
      function eC(e, t) {
        if ("function" != typeof e)
      ...
      ((ev.Ia = "serverreachability"),
        w(eI, O),
        (ev.STAT_EVENT = "statevent"),
        w(e_, O),
        (ev.Ja = "timingevent"),
        w(eS, O),
      ...
      var eL = {},
        eM = {};
      function eV(e, t, r) {
        ((e.M = 1), (e.A = e8(e2(t))), (e.u = r), (e.R = !0), eF(e, null));
      }
      function eF(e, t) {
        ((e.F = Date.now()), eB(e), (e.B = e2(e.A)));
        var r,
          n,
          i,
          s,
        ...
        (Array.isArray(u) || (u = [String(u)]),
          ...
          (l = e.j.L),
          (e.h = new eP()),
          (e.g = tY(e.j, l ? t : null, !e.u)),
          e.P > 0 && (e.O = new ea(y(e.Y, e, e.g), e.P)),
          (t = e.V),
          (l = e.g),
          (u = e.ba));
        var h = "readystatechange";
        Array.isArray(h) || (h && (el[0] = h.toString()), (h = el));
        for (let e = 0; e < h.length; e++) {
          let r = (function e(t, r, n, i, s) {
            if (i && i.once)
              return (function e(t, r, n, i, s) {
                if (Array.isArray(r)) {
                  for (let a = 0; a < r.length; a++) e(t, r[a], n, i, s);
                  return null;
                }
                return (
                  (n = er(n)),
                  t && t[V]
                    ? t.K(r, n, g(i) ? !!i.capture : !!i, s)
                    : J(t, r, n, !0, i, s)
                );
              })(t, r, n, i, s);
            if (Array.isArray(r)) {
            ...
            return (
              (n = er(n)),
              t && t[V]
                ? t.J(r, n, g(i) ? !!i.capture : !!i, s)
                : J(t, r, n, !1, i, s)
            );
          })(l, h[e], u || t.handleEvent, !1, t.h || t);
          if (!r) break;
          t.g[r.key] = r;
        }
        ((t = e.J ? q(e.J) : {}),
      ...
      function eq(e) {
        e.D && (p.clearTimeout(e.D), (e.D = null));
      }
      function ez(e) {
        0 == e.j.I || e.K || tG(e.j, e);
      }
      function e$(e) {
        eq(e);
        var t = e.O;
      ...
      function eK(e, t) {
        try {
          var r = e.j;
          if (0 != r.I && (r.g == e || eJ(r.h, e))) {
            if (!e.L && eJ(r.h, e) && 3 == r.I) {
              try {
                var n = r.Ba.g.parse(t);
              } catch (e) {
                n = null;
              }
                ...
                if (0 == i[0]) {
                  ...
                  ((r.xa = i[1]),
                    0 < r.xa - r.K &&
                      ...
                      !r.C &&
                      (r.C = eC(y(r.Va, r), 6e3)));
                1 >= eQ(r.h) && r.ta && (r.ta = void 0);
              } else tW(r, 11);
            } else if (((e.L || r.g == e) && tK(r), !L(t)))
              for (i = r.Ba.g.parse(t), t = 0; t < i.length; t++) {
                let o = i[t],
                  l = o[0];
                if (!(l <= r.K))
                  if (((r.K = l), (o = o[1]), 2 == r.I))
                    if ("c" == o[0]) {
                      ((r.M = o[1]), (r.ba = o[2]));
                      let t = o[3];
                      null != t && ((r.ka = t), r.j.info("VER=" + r.ka));
                      let i = o[4];
                      null != i && ((r.za = i), r.j.info("SVER=" + r.za));
                      let l = o[5];
                      (null != l &&
                        "number" == typeof l &&
                        l > 0 &&
                      ...
                      if (u) {
                        ...
                        if (e) {
                          ...
                          s.g ||
                            ...
                            ((s.j = s.l),
                            (s.g = new Set()),
                            s.h && (eY(s, s.h), (s.h = null)));
                        }
                        if (n.G) {
                          let e = u.g
                            ? u.g.getResponseHeader("X-HTTP-Session-Id")
                            : null;
                          e && ((n.wa = e), e4(n.J, n.G, e));
                        }
                      }
                      if (
                        ((r.I = 3),
                        ...
                        r.aa &&
                          ((r.T = Date.now() - e.F),
                          r.j.info("Handshake RTT: " + r.T + "ms")),
                        ((n = r).na = tJ(n, n.L ? n.ba : null, n.W)),
                        e.L)
                      ) {
                        eX(n.h, e);
                        var a = n.O;
                        (a && (e.H = a), e.D && (eq(e), eB(e)), (n.g = e));
                      } else tj(n);
                      r.i.length > 0 && tV(r);
                    } else ("stop" != o[0] && "close" != o[0]) || tW(r, 7);
                  else
                    3 == r.I &&
                      ("stop" == o[0] || "close" == o[0]
                        ? "stop" == o[0]
      ...
      ((eO.prototype.ba = function (e) {
        e = e.target;
        let t = this.O;
        t && 3 == tD(e) ? t.j() : this.Y(e);
      }),
        (eO.prototype.Y = function (e) {
          try {
            if (e == this.g)
              e: {
                let d = tD(this.g),
                ...
                if (
                  !(d < 3) &&
                  (3 != d ||
                    (this.g && (this.h.h || this.g.la() || tN(this.g))))
                ) {
                  (this.K ||
                    4 != d ||
                    7 == f ||
                  ...
                  var r = (function (e) {
                    ...
                    let r = "",
                      ...
                      i = 4 == tD(e.g);
                    if (!e.h.i) {
                      if ("u" < typeof TextDecoder) return (e$(e), ez(e), "");
                      e.h.i = new p.TextDecoder();
                    }
                    for (let s = 0; s < n; s++)
                      ((e.h.h = !0),
                        (r += e.h.i.decode(t[s], {
                    ...
                    return ((t.length = 0), (e.h.g += r), (e.C = 0), e.h.g);
                  })(this);
                  if (
                    ((this.o = 200 == t),
                    (n = this.i),
                    ...
                    if (this.R) {
                      let t;
                      for (e = !0; !this.K && this.C < r.length; )
                        if (
                          (t = (function (e, t) {
                            var r = e.C,
                              n = t.indexOf("\n", r);
                          ...
                          (4 == d && ((this.m = 4), eT(14), (e = !1)),
                            ek(this.i, this.l, null, "[Incomplete Response]"));
                          break;
                        } else if (t == eL) {
                          ((this.m = 4),
                            eT(15),
                            ek(this.i, this.l, r, "[Invalid Chunk]"),
                            (e = !1));
                          break;
                        } else (ek(this.i, this.l, t, null), eK(this, t));
                      if (
                        (eU(this) &&
                          0 != this.C &&
                        ...
                        (ek(this.i, this.l, r, "[Invalid Chunked Response]"),
                          e$(this),
                          ez(this));
                    } else (ek(this.i, this.l, r, null), eK(this, r));
                    (4 == d && e$(this),
                      this.o &&
                        !this.K &&
                        (4 == d
                    ...
                    ((function (e) {
                      let t = {};
                      e = (
                        (e.g && tD(e) >= 2 && e.g.getAllResponseHeaders()) ||
                        ""
                      ).split("\r\n");
                      for (let n = 0; n < e.length; n++) {
                        if (L(e[n])) continue;
                      ...
                      for (let e in t) n.call(void 0, t[e], e, t);
                    })(this.g),
                      400 == t && r.indexOf("Unknown SID") > 0
                        ? ((this.m = 3), eT(12))
                        : ((this.m = 0), eT(13)),
                      e$(this),
                      ez(this));
      ...
      function eH(e) {
        ((this.l = e || 10),
          (e = p.PerformanceNavigationTiming
            ? (e = p.performance.getEntriesByType("navigation")).length > 0 &&
      ...
      function eZ(e) {
        ...
        if (null != e.g && 0 !== e.g.size) {
          let t = e.i;
          for (let r of e.g.values()) t = t.concat(r.G);
          return t;
        }
        return I(e.i);
      }
      eH.prototype.cancel = function () {
        if (((this.i = eZ(this)), this.h)) (this.h.cancel(), (this.h = null));
          ...
          e instanceof e1
            ...
            : e && (t = String(e).match(e0))
              ? ((this.l = !1),
                ...
                e3(this, t[6] || "", !0),
                (this.m = e7(t[7] || "")))
              : ((this.l = !1), (this.i = new ta(null, this.l))));
      }
      function e2(e) {
        return new e1(e);
      }
      function e6(e, t, r) {
        ((e.j = r ? e7(t, !0) : t), e.j && (e.j = e.j.replace(/:$/, "")));
      }
      function e5(e, t) {
        if (t) {
          if (isNaN((t = Number(t))) || t < 0)
          ...
          ? ((e.i = t),
            ...
            (i = e.l) &&
              ...
              n.g.forEach(function (e, t) {
                let r = t.toLowerCase();
                t != r && (tl(this, t), tc(this, r, e));
              }, n)),
            (n.j = i))
          : (r || (t = e9(t, ti)), (e.i = new ta(t, e.l)));
      }
      function e4(e, t, r) {
        e.i.set(t, r);
      }
      ...
      ((e1.prototype.toString = function () {
        ...
        return (
          (r || "file" == t) &&
            (e.push("//"),
            (t = this.o) && e.push(e9(t, tt, !0), "@"),
            e.push(eR(r).replace(/%25([0-9a-fA-F]{2})/g, "%$1")),
            null != (r = this.u) && e.push(":", String(r))),
          (r = this.h) &&
            (this.g && "/" != r.charAt(0) && e.push("/"),
            e.push(e9(r, "/" == r.charAt(0) ? tn : tr, !0))),
          (r = this.i.toString()) && e.push("?", r),
          (r = this.m) && e.push("#", e9(r, ts)),
          e.join("")
        );
      }),
        (e1.prototype.resolve = function (e) {
          let t = e2(this),
            r = !!e.j;
          (r ? e6(t, e.j) : (r = !!e.o),
            r ? (t.o = e.o) : (r = !!e.g),
            r ? (t.g = e.g) : (r = null != e.u));
          var n = e.h;
          if (r) e5(t, e.u);
          else if ((r = !!e.h)) {
            if ("/" != n.charAt(0))
              if (this.g && !this.h) n = "/" + n;
              else {
                var i = t.h.lastIndexOf("/");
                -1 != i && (n = t.h.slice(0, i + 1) + n);
              }
            if (".." == (i = n) || "." == i) n = "";
              ...
              if (e) {
                ...
                for (let r = 0; r < e.length; r++) {
                  let n = e[r].indexOf("="),
                    ...
                    s = null;
                  (n >= 0
                    ? ((i = e[r].substring(0, n)), (s = e[r].substring(n + 1)))
                    : (i = e[r]),
      ...
      function tu(e, t) {
        return (to(e), (t = tf(e, t)), e.g.has(t));
      }
      function th(e, t) {
        to(e);
        let r = [];
        if ("string" == typeof t) tu(e, t) && (r = r.concat(e.g.get(tf(e, t))));
        else
      ...
      function tc(e, t, r) {
        (tl(e, t),
          r.length > 0 &&
            ((e.i = null), e.g.set(tf(e, t), I(r)), (e.h += r.length)));
      }
      function td(e) {
        let t = new ta();
      ...
      function tw(e) {
        ((e.readyState = 4), (e.l = null), (e.j = null), (e.B = null), tb(e));
      }
      function tb(e) {
      ...
      function tE(e, t, r) {
        ...
        n ||
          ((r = tI(r)),
          "string" == typeof e ? null != r && eR(r) : e4(e, t, r));
      }
      function t_(e) {
        (en.call(this),
      ...
      (((t = ta.prototype).add = function (e, t) {
        (to(this), (this.i = null), (e = tf(this, e)));
        let r = this.g.get(e);
        ...
        (t.set = function (e, t) {
          return (
            to(this),
            (this.i = null),
            tu(this, (e = tf(this, e))) && (this.h -= this.g.get(e).length),
            this.g.set(e, [t]),
            (this.h += 1),
            this
          );
        ...
        (t.get = function (e, t) {
          return e && (e = th(this, e)).length > 0 ? String(e[0]) : t;
        }),
        (t.toString = function () {
        ...
        (tm.prototype.g = function () {
          return new ty(this.i, this.h);
        }),
        w(ty, en),
        ((t = ty.prototype).open = function (e, t) {
          if (0 != this.readyState)
            throw (this.abort(), Error("Error reopening a connection"));
          ((this.F = e), (this.D = t), (this.readyState = 1), tb(this));
        }),
        (t.send = function (e) {
        ...
        (t.Pa = function (e) {
          if (
            ...
            this.h ||
              ...
              (this.readyState = 2),
              tb(this)),
            this.g && ((this.readyState = 3), tb(this), this.g))
          )
        ...
        (t.Ma = function (e) {
          if (this.g) {
            ...
            (e.done ? tw(this) : tb(this), 3 == this.readyState && tv(this));
          }
        }),
        (t.Oa = function (e) {
          this.g && ((this.response = this.responseText = e), tw(this));
        }),
        (t.Na = function (e) {
          this.g && ((this.response = e), tw(this));
        }),
        (t.ga = function () {
          this.g && tw(this);
        }),
        ...
        Object.defineProperty(ty.prototype, "withCredentials", {
          get: function () {
      ...
      function tA(e) {
        e.A || ((e.A = !0), ei(e, "complete"), ei(e, "error"));
      }
      function tk(e) {
        if (e.h && void 0 !== f) {
          if (e.v && 4 == tD(e)) setTimeout(e.Ca.bind(e), 0);
          else if ((ei(e, "readystatechange"), 4 == tD(e))) {
            e.h = !1;
            try {
              let s = e.ca();
              switch (s) {
              ...
              if (!(t = n)) {
                if ((r = 0 === s)) {
                  let t = String(e.D).match(e0)[1] || null;
                  (!t &&
                    p.self &&
                    p.self.location &&
                    (t = p.self.location.protocol.slice(0, -1)),
                    (r = !tT.test(t ? t.toLowerCase() : "")));
                }
                t = r;
              }
              if (t) (ei(e, "complete"), ei(e, "success"));
              else {
                e.o = 6;
                try {
                  var i = tD(e) > 2 ? e.g.statusText : "";
                } catch (e) {
                  i = "";
                }
                ((e.l = i + " [" + e.ca() + "]"), tA(e));
        ...
        ((this.za = 0),
          ...
          (this.ba =
            ...
            this.o =
              null),
          (this.Ya = this.V = 0),
          (this.Sa = tR("failFast", !1, e)),
          (this.F = this.C = this.v = this.m = this.l = null),
          (this.X = !0),
          (this.xa = this.K = -1),
          (this.Y = this.A = this.D = 0),
          (this.Qa = tR("baseRetryDelayMs", 5e3, e)),
          (this.Za = tR("retryDelaySeedMs", 1e4, e)),
          (this.Ta = tR("forwardChannelMaxRetries", 2, e)),
          (this.va = tR("forwardChannelRequestTimeoutMs", 2e4, e)),
          ...
          (this.M = ""),
          (this.h = new eH(e && e.concurrentRequestLimit)),
          (this.Ba = new tg()),
      ...
      function tP(e) {
        if ((tM(e), 3 == e.I)) {
          ...
          if (
            ...
            e4(r, "TYPE", "terminate"),
            tU(e, r),
            ((t = new eO(e, e.j, t)).M = 2),
            (t.A = e8(e2(r))),
            (r = !1),
            p.navigator && p.navigator.sendBeacon)
          )
            try {
              r = p.navigator.sendBeacon(t.A.toString(), "");
            } catch (e) {}
          (!r && p.Image && ((new Image().src = t.A), (r = !0)),
            r || ((t.g = tY(t.j, null)), t.g.ea(t.A)),
            (t.F = Date.now()),
            eB(t));
        }
        tQ(e);
      ...
      function tL(e) {
        e.g && (tz(e), e.g.cancel(), (e.g = null));
      }
      function tM(e) {
        (tL(e),
          e.v && (p.clearTimeout(e.v), (e.v = null)),
          tK(e),
          e.h.cancel(),
          e.m && ("number" == typeof e.m && p.clearTimeout(e.m), (e.m = null)));
      }
      function tV(e) {
        if (!eW(e.h) && !e.m) {
          e.m = !0;
          var t = e.Ea;
          (A || D(), k || (A(), (k = !0)), x.add(t, e), (e.D = 0));
        }
      }
      function tF(e, t) {
        var r;
        ...
        (e4(n, "SID", e.M),
          ...
          e4(n, "AID", e.K),
          tU(e, n),
          e.u && e.o && tE(n, e.u, e.o),
          (r = new eO(e, e.j, r, e.D + 1)),
          null === e.u && (r.J = e.o),
          t && (e.i = t.G.concat(e.i)),
          (t = tB(e, r, 1e3)),
          (r.H =
            Math.round(0.5 * e.va) + Math.round(0.5 * e.va * Math.random())),
          eY(e.h, r),
          eV(r, n, t));
      }
      function tU(e, t) {
      ...
      function tB(e, t, r) {
        ...
        e: {
          ...
          for (;;) {
            ...
            for (let l = 0; l < r; l++) {
              var s = i[l].g;
              let r = i[l].map;
              if ((s -= t) < 0) ((t = Math.max(0, i[l].g - 100)), (o = !1));
              else
                try {
                  s = "req" + s + "_";
                  try {
                    var a = r instanceof Map ? r : Object.entries(r);
                    for (let [t, r] of a) {
                      let n = r;
                      (g(r) && (n = eh(r)),
                        e.push(s + t + "=" + encodeURIComponent(n)));
                    }
                  } catch (t) {
                    throw (
                      e.push(s + "type=" + encodeURIComponent("_badmap")),
                      t
                    );
                  }
                } catch (e) {
        ...
        return ((t.G = e = e.i.splice(0, r)), a);
      }
      function tj(e) {
        if (!e.g && !e.v) {
          e.Y = 1;
          var t = e.Da;
          (A || D(), k || (A(), (k = !0)), x.add(t, e), (e.A = 0));
        }
      }
      function tq(e) {
        return (
          ...
          !e.v &&
          !(e.A >= 3) &&
          (e.Y++, (e.v = eC(y(e.Da, e), tH(e, e.A))), e.A++, !0)
        );
      }
      function tz(e) {
        null != e.B && (p.clearTimeout(e.B), (e.B = null));
      }
      function t$(e) {
        ((e.g = new eO(e, e.j, "rpc", e.Y)),
          null === e.u && (e.g.J = e.o),
          (e.g.P = 0));
        var t = e2(e.na);
        (e4(t, "RID", "rpc"),
          ...
          e4(t, "AID", e.K),
          e4(t, "CI", e.F ? "0" : "1"),
          !e.F && e.ia && e4(t, "TO", e.ia),
          e4(t, "TYPE", "xmlhttp"),
          tU(e, t),
          e.u && e.o && tE(t, e.u, e.o),
          e.O && (e.g.H = e.O));
        var r = e.g;
        ((e = e.ba),
          (r.M = 1),
                ...
                !(eQ(e.h) >= e.h.j - !!e.m) &&
                  (e.m
                    ...
                    : 1 != e.I &&
                      2 != e.I &&
                      !(e.D >= (e.Sa ? 0 : e.Ta)) &&
                      ((e.m = eC(y(e.Ea, e, r), tH(e, e.D))), e.D++, !0)))) ||
              (2 == i && tq(e))
            )
          )
            switch ((n && n.length > 0 && ((t = e.h).i = t.i.concat(n)), s)) {
              case 1:
                tW(e, 5);
                break;
              case 4:
      ...
      function tH(e, t) {
        let r = e.Qa + Math.floor(Math.random() * e.Za);
      ...
      function tW(e, t) {
        if ((e.j.info("Error code " + t), 2 == t)) {
          ...
          var r,
            ...
            i = e.Ua;
          let o = !i;
          ((i = new e1(i || "//www.google.com/images/cleardot.gif")),
            (p.location && "http" == p.location.protocol) || e6(i, "https"),
            e8(i),
            o
              ? (function (e, t) {
                  let r = new eA();
                  if (p.Image) {
                    let n = new Image();
                    ((n.onload = v(tp, r, "TestLoadImage: loaded", !0, t, n)),
                      (n.onerror = v(tp, r, "TestLoadImage: error", !1, t, n)),
                      (n.onabort = v(tp, r, "TestLoadImage: abort", !1, t, n)),
                      (n.ontimeout = v(
                        tp,
                        r,
              ...
              : ((r = i.toString()),
                ...
                (a = setTimeout(() => {
                  (s.abort(), tp(t, "TestPingServer: timeout", !1, n));
                }, 1e4)),
                fetch(r, { signal: s.signal })
                  .then((e) => {
                    (clearTimeout(a),
                      e.ok
                        ? tp(t, "TestPingServer: ok", !0, n)
                        : tp(t, "TestPingServer: server error", !1, n));
                  })
                  .catch(() => {
                    (clearTimeout(a), tp(t, "TestPingServer: error", !1, n));
                  })));
        } else eT(2);
        ((e.I = 0), e.l && e.l.pa(t), tQ(e), tM(e));
      }
      function tQ(e) {
        if (((e.I = 0), (e.ja = []), e.l)) {
          let t = eZ(e.h);
      ...
      function tJ(e, t, r) {
        var n = r instanceof e1 ? e2(r) : new e1(r);
        if ("" != n.g) (t && (n.g = t + "." + n.g), e5(n, n.u));
        else {
          var i = p.location;
          ((n = i.protocol),
      ...
      function tY(e, t, r) {
        ...
        return (
          (t = new t_(e.Aa && !e.ma ? new tm({ ab: r }) : e.ma)).Fa(e.L),
          t
        );
      }
      function tX() {}
      ...
      function t2() {
        (ey.call(this), (this.status = 1));
      }
      function t6(e) {
        this.g = e;
      }
      (((t = t_.prototype).Fa = function (e) {
        this.H = e;
      }),
        (t.ea = function (t, r, n, i) {
          if (this.g)
            throw Error(
          ...
          ((r = r ? r.toUpperCase() : "GET"),
            ...
            (this.A = !1),
            (this.h = !0),
            (this.g = this.L ? this.L.g() : e.g()),
            (this.g.onreadystatechange = b(y(this.Ca, this))));
          try {
          ...
          for (let [e, a] of ((i = Array.from(n.keys()).find(
            (e) => "content-type" == e.toLowerCase(),
          )),
          (s = p.FormData && t instanceof p.FormData),
          !(Array.prototype.indexOf.call(tS, r, void 0) >= 0) ||
            i ||
            s ||
            n.set(
              "Content-Type",
        ...
        (t.Ca = function () {
          this.u || (this.B || this.v || this.j ? tk(this) : this.Xa());
        }),
        (t.Xa = function () {
          tk(this);
        }),
        ...
        (t.ca = function () {
          try {
            return tD(this) > 2 ? this.g.status : -1;
          } catch (e) {
            return -1;
          }
        }),
        ...
        ((t = tO.prototype).ka = 8),
        (t.I = 1),
        (t.connect = function (e, t, r, n) {
          (eT(0),
            (this.W = e),
            (this.H = t || {}),
            r && void 0 !== n && ((this.H.OSID = r), (this.H.OAID = n)),
            (this.F = this.X),
            (this.J = tJ(this, null, this.W)),
            tV(this));
        }),
        (t.Ea = function (e) {
          if (this.m)
            if (((this.m = null), 1 == this.I)) {
              if (!e) {
                ...
                let i = new eO(this, this.j, e),
                  s = this.o;
                if (
                  (this.U && (s ? $((s = q(s)), this.U) : (s = this.U)),
                  null !== this.u || this.R || ((i.J = s), (s = null)),
                  this.S)
                )
                  e: {
                ...
                ((t = tB(this, i, t)),
                  e4((r = e2(this.J)), "RID", e),
                  e4(r, "CVER", 22),
                  this.G && e4(r, "X-HTTP-Session-Id", this.G),
                  tU(this, r),
                  s &&
                    (this.R
                      ? (t = "headers=" + eR(tI(s)) + "&" + t)
                      : this.u && tE(r, this.u, s)),
                  eY(this.h, i),
                  this.Ra && e4(r, "TYPE", "init"),
                  this.S
                    ? (e4(r, "$req", t),
                      e4(r, "SID", "null"),
                      (i.U = !0),
              ...
              3 == this.I &&
                (e
                  ? tF(this, e)
                  : 0 == this.i.length || eW(this.h) || tF(this));
        }),
        (t.Da = function () {
          if (
            ((this.v = null),
        ...
        (t.Va = function () {
          null != this.C && ((this.C = null), tL(this), tq(this), eT(19));
        }),
        (t.bb = function (e) {
          e
        ...
        (t.Ka = function () {}),
        (tZ.prototype.g = function (e, t) {
          return new t0(e, t);
        }),
        w(t0, en),
        (t0.prototype.m = function () {
          ((this.g.l = this.j),
            this.A && (this.g.L = !0),
            this.g.connect(this.l, this.h || void 0));
        }),
        (t0.prototype.close = function () {
          tP(this.g);
        }),
        (t0.prototype.o = function (e) {
          var t = this.g;
          if ("string" == typeof e) {
            var r = {};
            ((r.__data__ = e), (e = r));
          } else this.v && (((r = {}).__data__ = eh(e)), (e = r));
          (t.i.push(new eG(t.Ya++, e)), 3 == t.I && tV(t));
        }),
        ...
        w(t2, ey),
        w(t6, tX),
        (t6.prototype.ra = function () {
          ei(this.g, "a");
        }),
        (t6.prototype.qa = function (e) {
          ei(this.g, new t1(e));
        }),
        (t6.prototype.pa = function (e) {
          ei(this.g, new t2());
        }),
        (t6.prototype.oa = function () {
          ei(this.g, "b");
        }),
        (tZ.prototype.createWebChannel = tZ.prototype.g),
        (t0.prototype.send = t0.prototype.o),
        (t0.prototype.open = t0.prototype.m),
        (t0.prototype.close = t0.prototype.close),
        (h = T.createWebChannelTransport =
          function () {
            return new tZ();
          }),
        (u = T.getStatEventTarget =
          function () {
            return eb();
          }),
        (l = T.Event = ev),
        ...
        (eg.ERROR = "c"),
        (eg.MESSAGE = "d"),
        (en.prototype.listen = en.prototype.J),
        (i = T.WebChannel = ep),
        (T.FetchXmlHttpFactory = tm),
        (t_.prototype.listenOnce = t_.prototype.K),
        (t_.prototype.getLastError = t_.prototype.Ha),
        (t_.prototype.getLastErrorCode = t_.prototype.ya),
        (t_.prototype.getStatus = t_.prototype.ca),
        (t_.prototype.getResponseJson = t_.prototype.La),
        (t_.prototype.getResponseText = t_.prototype.la),
        (t_.prototype.send = t_.prototype.ea),
        (t_.prototype.setWithCredentials = t_.prototype.Fa),
        (n = T.XhrIo = t_));
    }).apply(
      void 0 !== _
        ? _
    ...
    ((S.UNAUTHENTICATED = new S(null)),
      (S.GOOGLE_CREDENTIALS = new S("google-credentials-uid")),
      (S.FIRST_PARTY = new S("first-party-uid")),
      (S.MOCK_USER = new S("mock-user")));
    let C = "12.13.0";
    function A(e) {
      C = e;
    }
    let k = new E.Logger("@firebase/firestore");
    function x() {
      return k.logLevel;
    }
    function D(e, ...t) {
      if (k.logLevel <= E.LogLevel.DEBUG) {
        let r = t.map(O);
        k.debug(`Firestore (${C}): ${e}`, ...r);
      }
    }
    function N(e, ...t) {
      if (k.logLevel <= E.LogLevel.ERROR) {
        let r = t.map(O);
        k.error(`Firestore (${C}): ${e}`, ...r);
      }
    }
    function R(e, ...t) {
      if (k.logLevel <= E.LogLevel.WARN) {
        let r = t.map(O);
        k.warn(`Firestore (${C}): ${e}`, ...r);
      }
    }
    function O(e) {
      if ("string" == typeof e) return e;
    ...
    function P(e, t, r) {
      ...
      ("string" == typeof t ? (n = t) : (r = t), L(e, n, r));
    }
    function L(e, t, r) {
      let n = `FIRESTORE (${C}) INTERNAL ASSERTION FAILED: ${t} (ID: ${e.toString(16)})`;
      if (void 0 !== r)
        try {
    ...
    function M(e, t, r, n) {
      ...
      ("string" == typeof r ? (i = r) : (n = r), e || L(t, i, n));
    }
    let V = {
      OK: "ok",
      CANCELLED: "cancelled",
    ...
    class F extends w.FirebaseError {
      constructor(e, t) {
        (super(e, t),
          (this.code = e),
          (this.message = t),
    ...
    class j {
      ...
      invalidateToken() {}
      start(e, t) {
        e.enqueueRetryable(() => t(S.UNAUTHENTICATED));
      }
      shutdown() {}
    }
    class q {
    ...
    class z {
                ...
                .then((t) =>
                  this.i !== e
                    ? (D(
                      ...
                      this.getToken())
                    : t
                      ? (M("string" == typeof t.accessToken, 31837, { l: t }),
                        new B(t.accessToken, this.currentUser))
                      : null,
                )
      ...
      u() {
        ...
        return (
          M(null === e || "string" == typeof e, 2055, { h: e }),
          new S(e)
        );
      }
    }
    ...
    class K {
      ...
      getToken() {
        return Promise.resolve(new $(this.P, this.T, this.I));
      }
      start(e, t) {
        e.enqueueRetryable(() => t(S.FIRST_PARTY));
      }
      shutdown() {}
      invalidateToken() {}
    }
    ...
    class H {
      ...
      getToken() {
        if (this.p) return Promise.resolve(new G(this.p));
        ...
        return (
          ...
          this.appCheck
            ? this.appCheck
                ...
                .then((e) =>
                  e
                    ? (M("string" == typeof e.token, 44558, { tokenResult: e }),
                      (this.m = e.token),
                      new G(e.token))
                    : null,
                )
    ...
    class W {
      static newId() {
        ...
        for (; t.length < 20; ) {
          let r = (function () {
            let e = "u" > typeof self && (self.crypto || self.msCrypto),
              t = new Uint8Array(40);
    ...
    function J(e, t) {
      ...
      for (let n = 0; n < r; n++) {
        let r = e.charAt(n),
          i = t.charAt(n);
        if (r !== i) return Y(r) === Y(i) ? Q(r, i) : Y(r) ? 1 : -1;
      }
      return Q(e.length, t.length);
    }
    function Y(e) {
    ...
    class ee {
      constructor(e, t, r) {
        (void 0 === t
          ? (t = 0)
          : t > e.length && P(637, { offset: t, range: e.length }),
          void 0 === r
            ? (r = e.length - t)
            : r > e.length - t && P(1746, { length: r, range: e.length - t }),
          (this.segments = e),
          (this.offset = t),
          (this.len = r));
      }
      ...
      static comparator(e, t) {
        let r = Math.min(e.length, t.length);
        for (let n = 0; n < r; n++) {
          let r = ee.compareSegments(e.get(n), t.get(n));
          if (0 !== r) return r;
        }
        return Q(e.length, t.length);
      }
      static compareSegments(e, t) {
        let r = ee.isNumericId(e),
          n = ee.isNumericId(t);
        return r && !n
          ? -1
          : !r && n
            ? 1
            : r && n
              ? ee.extractNumericId(e).compare(ee.extractNumericId(t))
              : J(e, t);
      }
    ...
    class en extends ee {
      ...
      isKeyField() {
        return 1 === this.length && this.get(0) === Z;
      }
      static keyField() {
        return new en([Z]);
      }
      static fromServerFormat(e) {
        ...
        if ((i(), s))
          throw new F(V.INVALID_ARGUMENT, "Unterminated ` in path: " + e);
        return new en(t);
      }
      static emptyPath() {
        return new en([]);
    ...
    class ei {
      ...
      static fromPath(e) {
        return new ei(et.fromString(e));
      }
      static fromName(e) {
        return new ei(et.fromString(e).popFirst(5));
      }
      static empty() {
        return new ei(et.emptyPath());
      }
      get collectionGroup() {
      ...
      isEqual(e) {
        return null !== e && 0 === et.comparator(this.path, e.path);
      }
      toString() {
    ...
    function ef(e, t) {
      let r;
      if (!el(e)) throw new F(V.INVALID_ARGUMENT, "JSON must be an object");
      for (let n in t)
        if (t[n]) {
          let i = t[n].typeString,
      ...
      if (r) throw new F(V.INVALID_ARGUMENT, r);
      return !0;
    }
    class ep {
      static now() {
        return ep.fromMillis(Date.now());
      }
      static fromDate(e) {
        return ep.fromMillis(e.getTime());
      }
      static fromMillis(e) {
      ...
      toJSON() {
        return {
          type: ep._jsonSchemaVersion,
          seconds: this.seconds,
          nanoseconds: this.nanoseconds,
        };
      }
      static fromJSON(e) {
        if (ef(e, ep._jsonSchema)) return new ep(e.seconds, e.nanoseconds);
      }
      valueOf() {
        return (
    ...
    ((ep._jsonSchemaVersion = "firestore/timestamp/1.0"),
      (ep._jsonSchema = {
        type: ed("string", ep._jsonSchemaVersion),
        seconds: ed("number"),
        nanoseconds: ed("number"),
      }));
    class eg {
      ...
      static min() {
        return new eg(new ep(0, 0));
      }
      static max() {
        return new eg(new ep(0x3afff4417f, 0x3b9ac9ff));
      }
      constructor(e) {
        this.timestamp = e;
      }
    ...
    function ew(e, t) {
      let r = Q(e.collectionGroup, t.collectionGroup);
      if (0 !== r) return r;
      for (let n = 0; n < Math.min(e.fields.length, t.fields.length); ++n)
        if (
          0 !==
          (r = (function (e, t) {
            let r = en.comparator(e.fieldPath, t.fieldPath);
            return 0 !== r ? r : Q(e.kind, t.kind);
          })(e.fields[n], t.fields[n]))
        )
          return r;
      return Q(e.fields.length, t.fields.length);
    }
    em.UNKNOWN_ID = -1;
    class eb {
      constructor(e, t) {
    ...
    function eE(e, t) {
      ...
      return new eT(
        eg.fromTimestamp(1e9 === n ? new ep(r + 1, 0) : new ep(r, n)),
        ei.empty(),
        t,
      );
    }
    ...
    class eT {
      ...
      static min() {
        return new eT(eg.min(), ei.empty(), -1);
      }
      static max() {
        return new eT(eg.max(), ei.empty(), -1);
      }
    }
    function eS(e, t) {
      let r = e.readTime.compareTo(t.readTime);
      return 0 !== r || 0 !== (r = ei.comparator(e.documentKey, t.documentKey))
        ? r
        : Q(e.largestBatchId, t.largestBatchId);
    }
    let eC =
    ...
    async function ek(e) {
      if (e.code !== V.FAILED_PRECONDITION || e.message !== eC) throw e;
    ...
    class ex {
      ...
      wrapUserFunction(e) {
        try {
          let t = e();
          return t instanceof ex ? t : ex.resolve(t);
        } catch (e) {
          return ex.reject(e);
        }
      }
      wrapSuccess(e, t) {
        return e ? this.wrapUserFunction(() => e(t)) : ex.resolve(t);
      }
      wrapFailure(e, t) {
        return e ? this.wrapUserFunction(() => e(t)) : ex.reject(t);
      }
      static resolve(e) {
        return new ex((t, r) => {
          t(e);
      ...
      static or(e) {
        let t = ex.resolve(!1);
        for (let r of e) t = t.next((e) => (e ? ex.resolve(e) : r()));
        return t;
      }
      static forEach(e, t) {
        let r = [];
    ...
    class eN {
      static open(e, t, r, n) {
        try {
          return new eN(t, e.transaction(n, r));
        } catch (e) {
          throw new eL(t, e);
        }
      }
      constructor(e, t) {
        ((this.action = e),
          ...
          (this.transaction.onabort = () => {
            t.error ? this.S.reject(new eL(e, t.error)) : this.S.resolve();
          }),
          (this.transaction.onerror = (t) => {
            let r = eB(t.target.error);
            this.S.reject(new eL(e, r));
          }));
      }
      get D() {
    ...
    class eR {
      static delete(e) {
        return (
          D(eD, "Removing database:", e),
          eF((0, w.getGlobal)().indexedDB.deleteDatabase(e)).toPromise()
        );
      }
      static v() {
        if (!(0, w.isIndexedDBAvailable)()) return !1;
        if (eR.F()) return !0;
        let e = (0, w.getUA)(),
          t = eR.M(e),
          r = eO(e);
      ...
      static F() {
        return (
          void 0 !== y.default &&
          "YES" === y.default.__PRIVATE_env?.__PRIVATE_USE_MOCK_PERSISTENCE
        );
      }
      static O(e, t) {
        return e.store(t);
      ...
      async L(e) {
        return (
          this.db ||
            (D(eD, "Opening database:", this.name),
            (this.db = await new Promise((t, r) => {
              ...
              ((n.onsuccess = (e) => {
                ...
                (n.onupgradeneeded = (e) => {
                  ...
                  this.N.k(t, n.transaction, e.oldVersion, this.version).next(
                    () => {
                      D(
                        eD,
          ...
          this.K && (this.db.onversionchange = (e) => this.K(e)),
          this.db
        );
      }
      q(e) {
      ...
      async runTransaction(e, t, r, n) {
        ...
        for (;;) {
          ...
          try {
            ...
            let t = eN.open(this.db, e, i ? "readonly" : "readwrite", r),
              s = n(t)
                .next((e) => (t.C(), e))
                .catch((e) => (t.abort(e), ex.reject(e)))
                .toPromise();
    ...
    class eV {
      ...
      put(e, t) {
        ...
        return (
          void 0 !== t
            ? (D(eD, "PUT", this.store.name, e, t), (r = this.store.put(t, e)))
            : (D(eD, "PUT", this.store.name, "<auto-key>", e),
              (r = this.store.put(e))),
          eF(r)
        );
      }
      add(e) {
        return (D(eD, "ADD", this.store.name, e, e), eF(this.store.add(e)));
      }
      get(e) {
        return eF(this.store.get(e)).next(
          (t) => (
            void 0 === t && (t = null),
            D(eD, "GET", this.store.name, e, t),
            t
          ),
        );
      }
      delete(e) {
        return (D(eD, "DELETE", this.store.name, e), eF(this.store.delete(e)));
      }
      count() {
        return (D(eD, "COUNT", this.store.name), eF(this.store.count()));
      }
      J(e, t) {
      ...
      X(e, t) {
        D(eD, "DELETE ALL", this.store.name);
        let r = this.options(e, t);
        r.Y = !1;
        let n = this.cursor(r);
        return this.H(n, (e, t, r) => r.delete());
      }
      ee(e, t) {
        let r;
        t ? (r = e) : ((r = {}), (t = e));
        ...
        return new ex((n, i) => {
          ((e.onerror = (e) => {
            ...
            (e.onsuccess = (e) => {
              ...
              if (a instanceof ex) {
                let e = a.catch((e) => (s.done(), ex.reject(e)));
                r.push(e);
              }
              s.isDone ? n() : null === s.G ? i.continue() : i.continue(s.G);
            }));
        }).next(() => ex.waitFor(r));
      }
      options(e, t) {
      ...
      cursor(e) {
        ...
        if ((e.reverse && (t = "prev"), e.index)) {
          ...
          return e.Y ? r.openKeyCursor(e.range, t) : r.openCursor(e.range, t);
        }
        ...
        (D(ej, `Scheduled in ${e}ms`),
          (this.task = this.asyncQueue.enqueueAfterDelay(
            ...
            async () => {
              this.task = null;
              try {
                let e = await this.ne.ie();
                D(ej, `Documents written: ${e}`);
              } catch (e) {
                eM(e)
                  ? D(ej, "Ignoring IndexedDB error during index backfill: ", e)
                  : await ek(e);
              }
              await this.re(6e4);
            },
            ...
            () =>
              this.localStore.indexManager
                ...
                .next((t) => {
                  if (null !== t && !r.has(t))
                    return (
                      D(ej, `Processing collection: ${t}`),
                      this.oe(e, t, n).next((e) => {
                        ((n -= e), r.add(t));
                      })
                    );
                  i = !1;
    ...
    function eQ(e) {
      let t = e.length;
      if ((M(t >= 2, 64408, { path: e }), 2 === t))
        return (
          M("\x01" === e.charAt(0) && "\x01" === e.charAt(1), 56145, {
            path: e,
          }),
          et.emptyPath()
        );
      ...
      for (let s = 0; s < t; ) {
        ...
        switch (((t < 0 || t > r) && P(50515, { path: e }), e.charAt(t + 1))) {
          case "\x01":
            let a,
              o = e.substring(s, t);
    ...
    let eJ = "remoteDocuments",
      eY = "owner",
      eX = "owner",
      eZ = "mutationQueues",
      e0 = "mutations",
      e1 = "batchId",
      e2 = "userMutationsIndex",
      e6 = ["userId", "batchId"],
      e5 = {},
      e3 = "documentMutations",
      e4 = "remoteDocumentsV14",
      e8 = ["prefixPath", "collectionGroup", "readTime", "documentId"],
      e7 = "documentKeyIndex",
      e9 = ["prefixPath", "collectionGroup", "documentId"],
      te = "collectionGroupIndex",
      tt = ["collectionGroup", "readTime", "prefixPath", "documentId"],
      tr = "remoteDocumentGlobal",
      tn = "remoteDocumentGlobalKey",
      ti = "targets",
      ts = "queryTargetsIndex",
      ta = ["canonicalId", "targetId"],
      to = "targetDocuments",
      tl = ["targetId", "path"],
      tu = "documentTargetsIndex",
      th = ["path", "targetId"],
      tc = "targetGlobalKey",
      td = "targetGlobal",
      tf = "collectionParents",
      tp = ["collectionId", "parent"],
      tg = "clientMetadata",
      tm = "bundles",
      ty = "namedQueries",
      tv = "indexConfiguration",
      tw = "collectionGroupIndex",
      tb = "indexState",
      tI = ["indexId", "uid"],
      tE = "sequenceNumberIndex",
      t_ = ["uid", "sequenceNumber"],
      tT = "indexEntries",
      tS = [
        "indexId",
        "uid",
      ...
      tC = "documentKeyIndex",
      tA = ["indexId", "uid", "orderedDocumentKey"],
      tk = "documentOverlays",
      tx = ["userId", "collectionPath", "documentId"],
      tD = "collectionPathOverlayIndex",
      tN = ["userId", "collectionPath", "largestBatchId"],
      tR = "collectionGroupOverlayIndex",
      tO = ["userId", "collectionGroup", "largestBatchId"],
      tP = "globals",
      tL = [eZ, e0, e3, eJ, ti, eY, td, to, tg, tr, tf, tm, ty],
      tM = [...tL, tk],
      tV = [eZ, e0, e3, e4, ti, eY, td, to, tg, tr, tf, tm, ty, tk],
      tF = [...tV, tv, tb, tT],
      tU = [...tF, tP];
    class tB extends eA {
      constructor(e, t) {
    ...
    class tK {
      constructor(e, t) {
        ((this.comparator = e), (this.root = t || tH.EMPTY));
      }
      insert(e, t) {
        return new tK(
          this.comparator,
          this.root
            ...
            .copy(null, null, tH.BLACK, null, null),
        );
      }
      remove(e) {
        return new tK(
      ...
      getIterator() {
        return new tG(this.root, null, this.comparator, !1);
      }
      getIteratorFrom(e) {
        return new tG(this.root, e, this.comparator, !1);
      }
      getReverseIterator() {
        return new tG(this.root, null, this.comparator, !0);
      }
      getReverseIteratorFrom(e) {
        return new tG(this.root, e, this.comparator, !0);
      }
    }
    class tG {
      constructor(e, t, r, n) {
    ...
    class tH {
      constructor(e, t, r, n, i) {
        ((this.key = e),
          (this.value = t),
          (this.color = null != r ? r : tH.RED),
          (this.left = null != n ? n : tH.EMPTY),
          (this.right = null != i ? i : tH.EMPTY),
      ...
      removeMin() {
        if (this.left.isEmpty()) return tH.EMPTY;
        let e = this;
        return (
      ...
      remove(e, t) {
        ...
        if (0 > t(e, n.key))
          ...
          if (
            ...
            if (n.right.isEmpty()) return tH.EMPTY;
            ((r = n.right.min()),
      ...
      rotateLeft() {
        let e = this.copy(null, null, tH.RED, null, this.right.left);
        return this.right.copy(null, null, this.color, e, null);
      }
      rotateRight() {
        let e = this.copy(null, null, tH.RED, this.left.right, null);
      ...
      check() {
        if (this.isRed() && this.left.isRed())
          throw P(43730, { key: this.key, value: this.value });
        if (this.right.isRed())
          throw P(14113, { key: this.key, value: this.value });
        let e = this.left.check();
        if (e !== this.right.check()) throw P(27949);
        return e + +!this.isRed();
      }
    }
    ((tH.EMPTY = null),
    ...
    class tW {
      constructor(e) {
        ((this.comparator = e), (this.data = new tK(this.comparator)));
      }
      has(e) {
      ...
      getIterator() {
        return new tQ(this.data.getIterator());
      }
      getIteratorFrom(e) {
        return new tQ(this.data.getIteratorFrom(e));
      }
      add(e) {
      ...
      isEqual(e) {
        if (!(e instanceof tW) || this.size !== e.size) return !1;
          ...
          (function (e) {
            try {
              ...
              throw "u" > typeof DOMException && e instanceof DOMException
                ? new tX("Invalid base64 string: " + e)
                : e;
            }
          })(e),
        );
    ...
    tZ.EMPTY_BYTE_STRING = new tZ("");
    let t0 = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
    function t1(e) {
      if ((M(!!e, 39018), "string" == typeof e)) {
        let t = 0,
          r = t0.exec(e);
        if ((M(!!r, 46558, { timestamp: e }), r[1])) {
          let e = r[1];
          t = Number((e = (e + "000000000").substr(0, 9)));
        }
        return { seconds: Math.floor(new Date(e).getTime() / 1e3), nanos: t };
      }
      return { seconds: t2(e.seconds), nanos: t2(e.nanos) };
    }
    function t2(e) {
    ...
    function t6(e) {
      return "string" == typeof e
        ? tZ.fromBase64String(e)
        : tZ.fromUint8Array(e);
    }
    let t5 = "server_timestamp",
      t3 = "__type__",
      t4 = "__previous_value__",
      t8 = "__local_write_time__";
    function t7(e) {
      return (e?.mapValue?.fields || {})[t3]?.stringValue === t5;
    }
    function t9(e) {
      let t = e.mapValue.fields[t4];
      return t7(t) ? t9(t) : t;
    }
    function re(e) {
      let t = t1(e.mapValue.fields[t8].timestampValue);
      return new ep(t.seconds, t.nanos);
    }
    class rt {
      constructor(e, t, r, n, i, s, a, o, l, u, h) {
        ((this.databaseId = e),
          (this.appId = t),
    ...
    class rn {
      constructor(e, t) {
        ((this.projectId = e), (this.database = t || rr));
      }
      static empty() {
        return new rn("", "");
      }
      get isDefaultDatabase() {
        return this.database === rr;
      }
      isEqual(e) {
        return (
          e instanceof rn &&
    ...
    function ri(e, t) {
      ...
      return new rn(e.options.projectId, t);
    }
    let rs = "__type__",
      ra = "__max__",
      ro = { mapValue: { fields: { __type__: { stringValue: ra } } } },
      rl = "__vector__",
      ru = "value",
      rh = { nullValue: "NULL_VALUE" };
    function rc(e) {
    ...
    function rd(e, t) {
      ...
      switch (r) {
        ...
        case 3:
          ...
          let n = t1(e.timestampValue),
            i = t1(t.timestampValue);
          return n.seconds === i.seconds && n.nanos === i.nanos;
        case 5:
          return e.stringValue === t.stringValue;
        case 6:
          return t6(e.bytesValue).isEqual(t6(t.bytesValue));
        case 7:
          return e.referenceValue === t.referenceValue;
        case 8:
          return (
            t2(e.geoPointValue.latitude) === t2(t.geoPointValue.latitude) &&
            t2(e.geoPointValue.longitude) === t2(t.geoPointValue.longitude)
          );
        case 2:
          if ("integerValue" in e && "integerValue" in t)
            return t2(e.integerValue) === t2(t.integerValue);
          if ("doubleValue" in e && "doubleValue" in t) {
            let r = t2(e.doubleValue),
              n = t2(t.doubleValue);
            return r === n ? eG(r) === eG(n) : isNaN(r) && isNaN(n);
          }
          return !1;
        case 9:
          return X(e.arrayValue.values || [], t.arrayValue.values || [], rd);
        case 10:
        case 11:
          let s = e.mapValue.fields || {},
            a = t.mapValue.fields || {};
          if (tq(s) !== tq(a)) return !1;
          for (let e in s)
            if (s.hasOwnProperty(e) && (void 0 === a[e] || !rd(s[e], a[e])))
              return !1;
          return !0;
        default:
          return P(52216, { left: e });
      }
    }
    function rf(e, t) {
      return void 0 !== (e.values || []).find((e) => rd(e, t));
    }
    function rp(e, t) {
      var r, n, i, s, a, o;
      if (e === t) return 0;
      ...
      switch (l) {
        ...
        case 0x1fffffffffffff:
          return 0;
        case 1:
          return Q(e.booleanValue, t.booleanValue);
        case 2:
          let h, c;
          return (
            (h = t2(e.integerValue || e.doubleValue)),
            h < (c = t2(t.integerValue || t.doubleValue))
              ? -1
              : h > c
                ? 1
                : h === c
        ...
        case 3:
          return rg(e.timestampValue, t.timestampValue);
        case 4:
          return rg(re(e), re(t));
        case 5:
        ...
        case 8:
          ...
          return (
            (i = e.geoPointValue),
            (s = t.geoPointValue),
            0 !== (p = Q(t2(i.latitude), t2(s.latitude)))
              ? p
              : Q(t2(i.longitude), t2(s.longitude))
          );
        case 9:
          return rm(e.arrayValue, t.arrayValue);
        case 10:
          let g, m, y, v, w;
          return (
            (a = e.mapValue),
            ...
            (y = g[ru]?.arrayValue),
            (v = m[ru]?.arrayValue),
            0 !== (w = Q(y?.values?.length || 0, v?.values?.length || 0))
              ? w
              : rm(y, v)
          );
        case 11:
          return (function (e, t) {
            if (e === ro.mapValue && t === ro.mapValue) return 0;
            if (e === ro.mapValue) return 1;
            if (t === ro.mapValue) return -1;
            let r = e.fields || {},
              n = Object.keys(r),
              i = t.fields || {},
              s = Object.keys(i);
    ...
    function rg(e, t) {
      ...
      let r = t1(e),
        n = t1(t),
        i = Q(r.seconds, n.seconds);
      return 0 !== i ? i : Q(r.nanos, n.nanos);
    }
    function rm(e, t) {
      let r = e.values || [],
        n = t.values || [];
        ...
        : "booleanValue" in e
          ...
          : "integerValue" in e
            ...
            : "doubleValue" in e
              ? "" + e.doubleValue
              : "timestampValue" in e
                ? ((n = t1(e.timestampValue)), `time(${n.seconds},${n.nanos})`)
                : "stringValue" in e
                  ? e.stringValue
                  : "bytesValue" in e
                    ? t6(e.bytesValue).toBase64()
                    : "referenceValue" in e
                      ? ((t = e.referenceValue), ei.fromName(t).toString())
                      : "geoPointValue" in e
                        ? ((r = e.geoPointValue),
    ...
    function rT(e) {
      return (e?.mapValue?.fields || {})[rs]?.stringValue === rl;
    }
    function rS(e) {
      ...
      if (e.mapValue) {
        ...
        return (
          tz(e.mapValue.fields, (e, r) => (t.mapValue.fields[e] = rS(r))),
          t
        );
      }
      if (e.arrayValue) {
        ...
        for (let r = 0; r < (e.arrayValue.values || []).length; ++r)
          t.arrayValue.values[r] = rS(e.arrayValue.values[r]);
        return t;
      }
      return { ...e };
    }
    function rC(e) {
      return (
        (((e.mapValue || {}).fields || {}).__type__ || {}).stringValue === ra
      );
    }
    let rA = {
      mapValue: {
        fields: { [rs]: { stringValue: rl }, [ru]: { arrayValue: {} } },
      },
    };
    function rk(e, t) {
      let r = rp(e.value, t.value);
      return 0 !== r
        ? r
    ...
    class rD {
      ...
      field(e) {
        if (e.isEmpty()) return this.value;
        {
          ...
          for (let r = 0; r < e.length - 1; ++r)
            if (!r_((t = (t.mapValue.fields || {})[e.get(r)]))) return null;
          return (t = (t.mapValue.fields || {})[e.lastSegment()]) || null;
        }
      }
      set(e, t) {
        this.getFieldsMap(e.popLast())[e.lastSegment()] = rS(t);
      }
      setAll(e) {
        let t = en.emptyPath(),
          r = {},
        ...
        e.forEach((e, i) => {
          ...
          e ? (r[i.lastSegment()] = rS(e)) : n.push(i.lastSegment());
        });
      ...
      delete(e) {
        ...
        r_(t) && t.mapValue.fields && delete t.mapValue.fields[e.lastSegment()];
      }
      isEqual(e) {
      ...
      applyChanges(e, t, r) {
        for (let n of (tz(t, (t, r) => (e[t] = r)), r)) delete e[n];
      }
      clone() {
        return new rD(rS(this.value));
      }
    }
    class rN {
      ...
      static newInvalidDocument(e) {
        return new rN(e, 0, eg.min(), eg.min(), eg.min(), rD.empty(), 0);
      }
      static newFoundDocument(e, t, r, n) {
        return new rN(e, 1, t, eg.min(), r, n, 0);
      }
      static newNoDocument(e, t) {
        return new rN(e, 2, t, eg.min(), eg.min(), rD.empty(), 0);
      }
      static newUnknownDocument(e, t) {
        return new rN(e, 3, t, eg.min(), eg.min(), rD.empty(), 2);
      }
      convertToFoundDocument(e, t) {
        return (
          this.createTime.isEqual(eg.min()) &&
      ...
      setHasLocalMutations() {
        return ((this.documentState = 1), (this.version = eg.min()), this);
      }
      setReadTime(e) {
      ...
      for (let i = 0; i < e.position.length; i++) {
        ...
        if (
          ((n = s.field.isKeyField()
            ? ei.comparator(ei.fromName(a.referenceValue), r.key)
            : rp(a, r.data.field(s.field))),
          "desc" === s.dir && (n *= -1),
          0 !== n)
        )
          break;
    ...
    function rP(e, t) {
      ...
      for (let r = 0; r < e.position.length; r++)
        if (!rd(e.position[r], t.position[r])) return !1;
      return !0;
    }
    class rL {
      constructor(e, t = "asc") {
    ...
    class rV extends rM {
      ...
      static createKeyFieldInFilter(e, t, r) {
        return "in" === t ? new rK(e, r) : new rG(e, r);
      }
      matches(e) {
        ...
        return "!=" === this.op
          ? null !== t &&
              void 0 === t.nullValue &&
              this.matchesComparison(rp(t, this.value))
          : null !== t &&
              rc(this.value) === rc(t) &&
              this.matchesComparison(rp(t, this.value));
      }
      matchesComparison(e) {
        switch (this.op) {
          ...
          case ">=":
            return e >= 0;
          default:
            return P(47266, { operator: this.op });
        }
      }
      isInequality() {
    ...
    function rq(e) {
      for (let t of e.filters) if (t instanceof rF) return !1;
      return !0;
    }
    function rz(e, t) {
      let r = e.filters.concat(t);
      return rF.create(r, e.op);
    }
    class r$ extends rV {
      constructor(e, t, r) {
        (super(e, t, r), (this.key = ei.fromName(r.referenceValue)));
      }
      matches(e) {
        let t = ei.comparator(e.key, this.key);
        return this.matchesComparison(t);
      }
    }
    class rK extends rV {
      constructor(e, t) {
        (super(e, "in", t), (this.keys = rH("in", t)));
      }
      matches(e) {
    ...
    class rG extends rV {
      constructor(e, t) {
        (super(e, "not-in", t), (this.keys = rH("not-in", t)));
      }
      matches(e) {
        return !this.keys.some((t) => t.isEqual(e.key));
      }
    ...
    function rH(e, t) {
      return (t.arrayValue?.values || []).map((e) =>
        ei.fromName(e.referenceValue),
      );
    }
    class rW extends rV {
      constructor(e, t) {
      ...
      matches(e) {
        let t = e.data.field(this.field);
        return rb(t) && rf(t.arrayValue, this.value);
      }
    }
    class rQ extends rV {
      constructor(e, t) {
      ...
      matches(e) {
        let t = e.data.field(this.field);
        return null !== t && rf(this.value.arrayValue, t);
      }
    }
    class rJ extends rV {
      constructor(e, t) {
      ...
      matches(e) {
        if (rf(this.value.arrayValue, { nullValue: "NULL_VALUE" })) return !1;
        let t = e.data.field(this.field);
        return (
          null !== t && void 0 === t.nullValue && !rf(this.value.arrayValue, t)
        );
      }
    }
    class rY extends rV {
      ...
      matches(e) {
        let t = e.data.field(this.field);
        return (
          !(!rb(t) || !t.arrayValue.values) &&
          t.arrayValue.values.some((e) => rf(this.value.arrayValue, e))
        );
      }
    }
    class rX {
    ...
    function rZ(e, t = null, r = [], n = [], i = null, s = null, a = null) {
      return new rX(e, t, r, n, i, s, a);
    }
    function r0(e) {
      if (null === e.Te) {
        ...
        (null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup),
          ...
          (t += e.filters
            .map((e) =>
              (function e(t) {
                if (t instanceof rV)
                  return (
                    t.field.canonicalString() + t.op.toString() + ry(t.value)
                  );
                if (rj(t)) return t.filters.map((t) => e(t)).join(",");
                {
          ...
          (t += e.orderBy
            ...
            .join(",")),
          eK(e.limit) || ((t += "|l:"), (t += e.limit)),
          e.startAt &&
            ((t += "|lb:"),
            (t += e.startAt.inclusive ? "b:" : "a:"),
            (t += e.startAt.position.map((e) => ry(e)).join(","))),
          e.endAt &&
            ((t += "|ub:"),
            (t += e.endAt.inclusive ? "a:" : "b:"),
            (t += e.endAt.position.map((e) => ry(e)).join(","))),
          (e.Te = t));
      }
      return e.Te;
    }
    function r1(e, t) {
      ...
      return (
        ...
        !!rP(e.startAt, t.startAt) &&
        rP(e.endAt, t.endAt)
      );
    }
    function r2(e) {
      return (
        ei.isDocumentKey(e.path) &&
        null === e.collectionGroup &&
        0 === e.filters.length
      );
    }
    function r6(e, t) {
      return e.filters.filter((e) => e instanceof rV && e.field.isEqual(t));
    }
    function r5(e, t, r) {
      let n = rh,
        i = !0;
      for (let r of r6(e, t)) {
        ...
        0 > rk({ value: n, inclusive: i }, { value: e, inclusive: t }) &&
          ((n = e), (i = t));
      }
      if (null !== r) {
    ...
    function r3(e, t, r) {
      ...
      for (let r of r6(e, t)) {
        ...
        rx({ value: n, inclusive: i }, { value: e, inclusive: t }) > 0 &&
          ((n = e), (i = t));
      }
      if (null !== r) {
        for (let s = 0; s < e.orderBy.length; ++s)
      ...
      if (null === e.Ie) {
        ...
        t).forEach((t) => {
          r.has(t.canonicalString()) ||
            t.isKeyField() ||
            e.Ie.push(new rL(t, n));
        }),
          r.has(en.keyField().canonicalString()) ||
            e.Ie.push(new rL(en.keyField(), n)));
      }
      return e.Ie;
    }
    function nt(e) {
      return (e.Ee || (e.Ee = nr(e, ne(e))), e.Ee);
    }
    function nr(e, t) {
      if ("F" === e.limitType)
        return rZ(
        ...
        );
      {
        t = t.map((e) => {
          ...
          return new rL(e.field, t);
        });
        let r = e.endAt ? new rR(e.endAt.position, e.endAt.inclusive) : null,
          n = e.startAt
            ? new rR(e.startAt.position, e.startAt.inclusive)
            : null;
        return rZ(e.path, e.collectionGroup, t, e.filters, e.limit, r, n);
      }
    }
    function nn(e, t) {
      let r = e.filters.concat([t]);
    ...
    function na(e, t) {
      return r1(nt(e), nt(t)) && e.limitType === t.limitType;
    }
    function no(e) {
      return `${r0(nt(e))}|lt:${e.limitType}`;
    }
    function nl(e) {
      var t;
      let r;
      return `Query(target=${
        ((r = (t = nt(e)).path.canonicalString()),
        ...
        t.filters.length > 0 &&
          (r += `, filters: [${t.filters
            .map((e) =>
              (function e(t) {
                return t instanceof rV
                  ? `${t.field.canonicalString()} ${t.op} ${ry(t.value)}`
                  : t instanceof rF
                    ? t.op.toString() +
                      " {" +
          ...
          let e = (function (e, t, r) {
            ...
            let i,
              ...
              a = e.field.isKeyField()
                ? ei.comparator(t.key, r.key)
                : ((n = e.field),
                  (i = t.data.field(n)),
                  (s = r.data.field(n)),
                  null !== i && null !== s ? rp(i, s) : P(42886));
            switch (e.dir) {
              case "asc":
                return a;
              case "desc":
                return -1 * a;
              default:
                return P(19790, { direction: e.dir });
            }
          })(i, t, r);
          if (0 !== e) return e;
    ...
    let nf = new tK(ei.comparator),
      np = new tK(ei.comparator);
    function ng(...e) {
      let t = np;
    ...
    let nv = new tK(ei.comparator),
      nw = new tW(ei.comparator);
    function nb(...e) {
      let t = nw;
      for (let r of e) t = t.add(r);
      return t;
    ...
    function nk(e, t) {
      let r = nO(t);
      for (let t of e.elements) r.some((e) => rd(e, t)) || r.push(t);
    ...
    function nD(e, t) {
      let r = nO(t);
      for (let t of e.elements) r = r.filter((e) => !rd(e, t));
      return { arrayValue: { values: r } };
    }
    class nN extends nT {
      constructor(e, t) {
    ...
    function nR(e) {
      return t2(e.integerValue || e.doubleValue);
    }
    function nO(e) {
      return rb(e) && e.arrayValue.values ? e.arrayValue.values.slice() : [];
    }
    class nP {
      constructor(e, t) {
    ...
    function nU(e, t) {
      ...
      if (null === t)
        return e.isNoDocument()
          ? new nH(e.key, nM.none())
          : new nq(e.key, e.data, nM.none());
      {
        let r = e.data,
          n = rD.empty(),
          i = new tW(en.comparator);
        ...
        return new nz(e.key, n, new tY(i.toArray()), nM.none());
      }
    }
    function nB(e, t, r, n) {
      return e instanceof nq
        ? (function (e, t, r, n) {
            if (!nV(e.precondition, t)) return r;
            let i = e.value.clone(),
              s = nG(e.fieldTransforms, n, t);
            return (
              i.setAll(s),
        ...
        : e instanceof nz
          ? (function (e, t, r, n) {
              if (!nV(e.precondition, t)) return r;
              let i = nG(e.fieldTransforms, n, t),
                s = t.data;
              return (s.setAll(n$(e)),
              s.setAll(i),
          ...
          (!(!r || !n) &&
            X(r, n, (e, t) => {
              ...
              return (
                ...
                ((r = e.transform),
                (n = t.transform),
                (r instanceof nA && n instanceof nA) ||
                (r instanceof nx && n instanceof nx)
                  ? X(r.elements, n.elements, rd)
                  : r instanceof nN && n instanceof nN
                    ? rd(r.Ae, n.Ae)
                    : r instanceof nC && n instanceof nC)
              );
            }))
        )) &&
        (0 === e.type
    ...
    function nK(e, t, r) {
      let n = new Map();
      M(e.length === r.length, 32656, { Ve: r.length, de: e.length });
      for (let s = 0; s < r.length; s++) {
        ...
        n.set(
          a.field,
          ((i = r[s]),
          o instanceof nA ? nk(o, l) : o instanceof nx ? nD(o, l) : i),
        );
      }
      return n;
    }
          ...
          (function (e, t, r) {
            ...
            return e instanceof nC
              ...
              : e instanceof nA
                ...
                : e instanceof nx
                  ? nD(e, t)
                  : ((a = nR((s = nS(e, t))) + nR(e.Ae)),
                    rw(s) && rw(e.Ae) ? n_(a) : nE(e.serializer, a));
          })(e, s, t),
        );
      }
      return n;
        ...
        for (let t = 0; t < this.mutations.length; t++) {
          ...
          n.key.isEqual(e.key) &&
            (function (e, t, r) {
              ...
              e instanceof nq
                ? ((n = e.value.clone()),
                  (i = nK(e.fieldTransforms, t, r.transformResults)),
                  n.setAll(i),
                  t
                ...
                : e instanceof nz
                  ? (function (e, t, r) {
                      if (!nV(e.precondition, t))
                        return t.convertToUnknownDocument(r.version);
                      let n = nK(e.fieldTransforms, t, r.transformResults),
                        i = t.data;
                      (i.setAll(n$(e)),
                        i.setAll(n),
                        t
        ...
        return (
          this.mutations.forEach((n) => {
            let i = e.get(n.key),
              ...
              o = nU(s, (a = t.has(n.key) ? null : a));
            (null !== o && r.set(n.key, o),
              s.isValidDocument() || s.convertToNoDocument(eg.min()));
          }),
          r
        );
      }
      keys() {
        return this.mutations.reduce((e, t) => e.add(t.key), nb());
      }
      isEqual(e) {
        return (
          this.batchId === e.batchId &&
          X(this.mutations, e.mutations, (e, t) => nj(e, t)) &&
          X(this.baseMutations, e.baseMutations, (e, t) => nj(e, t))
        );
      }
    }
    class nJ {
      ...
      static from(e, t, r) {
        M(e.mutations.length === r.length, 58842, {
    ...
    function nZ(e) {
      switch (e) {
        ...
        case V.DATA_LOSS:
          return !0;
        default:
          return P(15467, { code: e });
      }
    }
    function n0(e) {
      if (void 0 === e) return (N("GRPC error has no .code"), V.UNKNOWN);
      switch (e) {
        case c.OK:
          return V.OK;
        case c.CANCELLED:
    ...
    let n6 = new t([0xffffffff, 0xffffffff], 0);
    function n5(e) {
      let t = n2().encode(e),
        n = new r();
    ...
    function n3(e) {
      let r = new DataView(e.buffer),
        ...
        s = r.getUint32(8, !0),
        a = r.getUint32(12, !0);
      return [new t([n, i], 0), new t([s, a], 0)];
    }
    class n4 {
      constructor(e, r, n) {
        if (
          ...
          throw new n8(`Invalid padding: ${r}`);
        if (n < 0 || (e.length > 0 && 0 === this.hashCount))
          throw new n8(`Invalid hash count: ${n}`);
        if (0 === e.length && 0 !== r)
          throw new n8(`Invalid padding when bitmap length is 0: ${r}`);
        ((this.ge = 8 * e.length - r), (this.pe = t.fromNumber(this.ge)));
      }
      ye(e, r, n) {
        let i = e.add(r.multiply(t.fromNumber(n)));
        return (
          1 === i.compare(n6) && (i = new t([i.getBits(0), i.getBits(1)], 0)),
    ...
    class n7 {
      ...
      static createSynthesizedRemoteEventForCurrentChange(e, t, r) {
        let n = new Map();
        return (
          n.set(e, n9.createSynthesizedTargetChangeForCurrentChange(e, t, r)),
          new n7(eg.min(), n, new tK(Q), nf, nb())
        );
      }
    }
    class n9 {
    ...
    class ir {
      constructor(e, t, r = tZ.EMPTY_BYTE_STRING, n = null) {
        ((this.state = e),
          (this.targetIds = t),
          (this.resumeToken = r),
          (this.cause = n));
    ...
    class ii {
          ...
          this.Fe.forEach((n, i) => {
            switch (i) {
              ...
              case 1:
                ...
                break;
              default:
                P(38017, { changeType: i });
            }
          }),
          new n9(this.Me, this.xe, e, t, r)
        );
      }
      Ke() {
        ((this.Oe = !1), (this.Fe = io()));
      }
      qe(e, t) {
      ...
      We() {
        ((this.ve -= 1), M(this.ve >= 0, 3241, { ve: this.ve }));
      }
      Qe() {
        ((this.Oe = !0), (this.xe = !0));
      }
    ...
    class is {
        ...
        this.forEachTarget(e, (t) => {
          ...
          switch (e.state) {
            ...
            case 1:
              ...
              break;
            case 2:
              (r.We(), r.Ne || this.removeTarget(t));
              break;
            case 3:
              this.rt(t) && (r.Qe(), r.Le(e.resumeToken));
              break;
            case 4:
              this.rt(t) && (this.it(t), r.Le(e.resumeToken));
              break;
            default:
              P(56790, { state: e.state });
          }
        });
      }
      forEachTarget(e, t) {
      ...
      st(e) {
        ...
        if (n) {
          ...
          if (r2(a))
            if (0 === r) {
              let e = new ei(a.path);
              this.et(t, e, rN.newNoDocument(e, eg.min()));
            } else M(1 === r, 20013, { expectedCount: r });
          else {
            let n = this._t(t);
            if (n !== r) {
              var i, s;
              ...
              (0 !== l &&
                ...
                n1?.o(
                  ...
                  (a = i.unchangedNames) &&
                    (r.bloomFilter = {
                      applied: 0 === l,
                      hashCount: a?.hashCount ?? 0,
                      bitmapLength: a?.bits?.bitmap?.length ?? 0,
                      padding: a?.bits?.padding ?? 0,
                      mightContain: (e) => o?.mightContain(e) ?? !1,
                    }),
                  r),
                ));
            }
      ...
      ut(e) {
        ...
        return 0 === r.ge ? null : r;
      }
      ct(e, t, r) {
        return 2 * (t.Ce.count !== r - this.Pt(e, t.targetId));
      }
      Pt(e, t) {
        let r = this.Ge.getRemoteKeysForTarget(t),
          n = 0;
        return (
          r.forEach((r) => {
            let i = this.Ge.ht(),
              s = `projects/${i.projectId}/databases/${i.database}/documents/${r.path.canonicalString()}`;
            e.mightContain(s) || (this.et(t, r, null), n++);
          }),
          n
        );
      }
      Tt(e) {
        ...
        this.ze.forEach((r, n) => {
          let i = this.ot(n);
          if (i) {
            if (r.current && r2(i.target)) {
              let t = new ei(i.target.path);
              this.It(t).has(n) ||
                this.Et(n, t) ||
                this.et(n, t, rN.newNoDocument(t, e));
            }
            r.Be && (t.set(n, r.ke()), r.Ke());
          }
        });
        let r = nb();
        (this.He.forEach((e, t) => {
          ...
          this.je.forEach((t, r) => r.setReadTime(e)));
        let n = new n7(e, t, this.Ze, this.je, r);
        return (
          (this.je = nf),
          (this.Je = ia()),
          (this.He = ia()),
      ...
      nt(e) {
        let t = this.ze.get(e);
        return (t || ((t = new ii()), this.ze.set(e, t)), t);
      }
      Rt(e) {
        let t = this.He.get(e);
        return (t || ((t = new tW(Q)), (this.He = this.He.insert(e, t))), t);
      }
      It(e) {
        let t = this.Je.get(e);
        return (t || ((t = new tW(Q)), (this.Je = this.Je.insert(e, t))), t);
      }
      rt(e) {
        let t = null !== this.ot(e);
        return (
          t || D("WatchChangeAggregator", "Detected inactive target", e),
          t
        );
      }
      ot(e) {
    ...
    function ia() {
      return new tK(ei.comparator);
    }
    function io() {
      return new tK(ei.comparator);
    }
    let il = { asc: "ASCENDING", desc: "DESCENDING" },
      iu = {
        "<": "LESS_THAN",
        "<=": "LESS_THAN_OR_EQUAL",
        ">": "GREATER_THAN",
    ...
    function id(e, t) {
      return e.useProto3Json || eK(t) ? t : { value: t };
    }
    function ip(e, t) {
    ...
    function im(e) {
      ...
      return (
        M(!!e, 49232),
        eg.fromTimestamp(new ep((t = t1(e)).seconds, t.nanos))
      );
    }
    function iy(e, t) {
      return iv(e, t).canonicalString();
    }
    function iv(e, t) {
      let r = new et(["projects", e.projectId, "databases", e.database]).child(
        "documents",
      );
      return void 0 === t ? r : r.child(t);
    }
    function iw(e) {
      let t = et.fromString(e);
      return (M(iL(t), 10190, { key: t.toString() }), t);
    }
    function ib(e, t) {
      return iy(e.databaseId, t.path);
    }
    function iI(e, t) {
      let r = iw(t);
    ...
    function iE(e, t) {
      return iy(e.databaseId, t);
    }
    function i_(e) {
      let t = iw(e);
      return 4 === t.length ? et.emptyPath() : iS(t);
    }
    function iT(e) {
      return new et([
        "projects",
    ...
    function iS(e) {
      return (
        M(e.length > 4 && "documents" === e.get(4), 29091, {
          key: e.toString(),
        }),
        e.popFirst(5)
      );
    ...
    function iC(e, t, r) {
      return { name: ib(e, t), fields: r.value.mapValue.fields };
    }
    function iA(e, t, r) {
      let n = iI(e, t.name),
        i = im(t.updateTime),
        s = t.createTime ? im(t.createTime) : eg.min(),
        a = new rD({ mapValue: { fields: t.fields } }),
        o = rN.newFoundDocument(n, i, s, a);
      return (
        r && o.setHasCommittedMutations(),
    ...
    function ik(e, t) {
      var r, n;
      let i;
      if (t instanceof nq) i = { update: iC(e, t.key, t.value) };
      else if (t instanceof nH) i = { delete: ib(e, t.key) };
        ...
        if (!(t instanceof nW)) return P(16599, { dt: t.type });
        i = { verify: ib(e, t.key) };
      }
      return (
        t.fieldTransforms.length > 0 &&
          (i.updateTransforms = t.fieldTransforms.map((e) =>
            (function (e) {
              ...
              throw P(20930, { transform: e.transform });
            })(e),
          )),
        t.precondition.isNone ||
          (i.currentDocument =
            void 0 !== (r = t.precondition).updateTime
              ? { updateTime: ip(e, r.updateTime.toTimestamp()) }
              : void 0 !== r.exists
                ? { exists: r.exists }
                : P(27497)),
        i
    ...
    function ix(e, t) {
      var r;
      let n = t.currentDocument
          ? void 0 !== (r = t.currentDocument).updateTime
            ? nM.updateTime(im(r.updateTime))
            : void 0 !== r.exists
              ? nM.exists(r.exists)
              : nM.none()
          : nM.none(),
          ...
          ? t.updateTransforms.map((t) => {
              ...
              return (
                ...
                "setToServerValue" in t
                  ? (M("REQUEST_TIME" === t.setToServerValue, 16630, {
                      proto: t,
                    }),
                    (r = new nC()))
                  : "appendMissingElements" in t
                    ? (r = new nA(t.appendMissingElements.values || []))
                    : "removeAllFromArray" in t
                      ? (r = new nx(t.removeAllFromArray.values || []))
                      : "increment" in t
                        ? (r = new nN(e, t.increment))
                        : P(16584, { proto: t }),
                new nP(en.fromServerFormat(t.fieldPath), r)
              );
            })
          : [];
      if (t.update) {
        t.update.name;
        let r = iI(e, t.update.name),
          s = new rD({ mapValue: { fields: t.update.fields } });
        return t.updateMask
          ? new nz(
              r,
              s,
      ...
      return t.delete
        ? new nH(iI(e, t.delete), n)
        : t.verify
          ? new nW(iI(e, t.verify), n)
          : P(1463, { proto: t });
    }
    function iD(e, t) {
      return { documents: [iE(e, t.path)] };
    }
    function iN(e, t) {
      var r, n;
      let i,
            ...
            return t instanceof rV
              ? (function (e) {
                  if ("==" === e.op) {
                    if (rE(e.value))
                      return {
                        unaryFilter: { field: iO(e.field), op: "IS_NAN" },
                      };
                    if (rI(e.value))
                      return {
                        unaryFilter: { field: iO(e.field), op: "IS_NULL" },
                      };
                  } else if ("!=" === e.op) {
                    if (rE(e.value))
                      return {
                        unaryFilter: { field: iO(e.field), op: "IS_NOT_NAN" },
                      };
                    if (rI(e.value))
                      return {
                        unaryFilter: { field: iO(e.field), op: "IS_NOT_NULL" },
                      };
                  }
                  return {
                    fieldFilter: {
              ...
              : t instanceof rF
                ? 1 === (n = (r = t).getFilters().map((t) => e(t))).length
                  ? n[0]
                  : { compositeFilter: { op: ih[r.op], filters: n } }
                : P(54877, { filter: t });
          })(rF.create(e, "and"));
      })(t.filters);
      ...
      let l = (function (e) {
        if (0 !== e.length)
          return e.map((e) => ({ field: iO(e.field), direction: il[e.dir] }));
      })(t.orderBy);
    ...
    function iR(e) {
      ...
      let i,
        ...
        l = i_(e.parent),
        u = e.structuredQuery,
        h = u.from ? u.from.length : 0,
        c = null;
      if (h > 0) {
        M(1 === h, 65062);
        let e = u.from[0];
        e.allDescendants ? (c = e.collectionId) : (l = l.child(e.collectionId));
      }
      let d = [];
      u.where &&
        (d =
              ...
              ? (function (e) {
                  switch (e.unaryFilter.op) {
                    case "IS_NAN":
                      ...
                      return rV.create(t, "==", { doubleValue: NaN });
                    case "IS_NULL":
                      let r = iP(e.unaryFilter.field);
                      return rV.create(r, "==", { nullValue: "NULL_VALUE" });
                    case "IS_NOT_NAN":
                      let n = iP(e.unaryFilter.field);
                      return rV.create(n, "!=", { doubleValue: NaN });
                    case "IS_NOT_NULL":
                      let i = iP(e.unaryFilter.field);
                      return rV.create(i, "!=", { nullValue: "NULL_VALUE" });
      ...
      let p = null;
      u.limit &&
        (p = eK((s = "object" == typeof (t = u.limit) ? t.value : t))
          ? null
          : s);
      let g = null;
      u.startAt &&
        ((a = !!(r = u.startAt).before), (g = new rR(r.values || [], a)));
      let m = null;
      return (
        u.endAt &&
          ((o = !(n = u.endAt).before), (m = new rR(n.values || [], o))),
        new r4(l, c, f, d, p, "F", g, m)
      );
    }
    function iO(e) {
    ...
    function iM(e) {
      return (
        !!e &&
        "function" == typeof e._toProto &&
        "ProtoValue" === e._protoValueType
      );
    }
    class iV {
      constructor(
    ...
    function iU(e, t) {
      let r = t.key,
        n = {
          ...
          readTime: iB(t.readTime),
          hasCommittedMutations: t.hasCommittedMutations,
        };
      if (t.isFoundDocument()) {
        var i;
        n.document = {
          name: ib((i = e.yt), t.key),
          fields: t.data.value.mapValue.fields,
          updateTime: ip(i, t.version.toTimestamp()),
          createTime: ip(i, t.createTime.toTimestamp()),
        };
      } else if (t.isNoDocument())
        n.noDocument = { path: r.path.toArray(), readTime: ij(t.version) };
      else {
        if (!t.isUnknownDocument()) return P(57904, { document: t });
        n.unknownDocument = { path: r.path.toArray(), version: ij(t.version) };
      }
      return n;
    }
    function iB(e) {
    ...
    function iq(e) {
      let t = new ep(e.seconds, e.nanoseconds);
      return eg.fromTimestamp(t);
    }
    function iz(e, t) {
      let r = (t.baseMutations || []).map((t) => ix(e.yt, t));
      for (let e = 0; e < t.mutations.length - 1; ++e) {
        let r = t.mutations[e];
        e + 1 < t.mutations.length &&
          void 0 !== t.mutations[e + 1].transform &&
          ((r.updateTransforms = t.mutations[e + 1].transform.fieldTransforms),
          t.mutations.splice(e + 1, 1),
          ++e);
      }
      let n = t.mutations.map((t) => ix(e.yt, t)),
        i = ep.fromMillis(t.localWriteTimeMs);
      return new nQ(t.batchId, i, r, n);
    }
    function i$(e) {
      var t;
      let r,
        ...
        i =
          void 0 !== e.lastLimboFreeSnapshotVersion
            ? iq(e.lastLimboFreeSnapshotVersion)
            : eg.min();
      return new iV(
        void 0 !== e.query.documents
          ? (M(1 === (r = (t = e.query).documents.length), 1966, { count: r }),
            nt(r8(i_(t.documents[0]))))
          : nt(iR(e.query)),
        e.targetId,
        "TargetPurposeListen",
        ...
        n,
        i,
        tZ.fromBase64String(e.resumeToken),
      );
    }
    function iK(e, t) {
      let r,
        n = ij(t.snapshotVersion),
        i = ij(t.lastLimboFreeSnapshotVersion);
      r = r2(t.target) ? iD(e.yt, t.target) : iN(e.yt, t.target).ft;
      let s = t.resumeToken.toBase64();
      return {
        targetId: t.targetId,
        canonicalId: r0(t.target),
        readTime: n,
        resumeToken: s,
    ...
    function iG(e) {
      let t = iR({ parent: e.parent, structuredQuery: e.structuredQuery });
      return "LAST" === e.limitType ? ns(t, t.limit, "L") : t;
    }
    function iH(e, t) {
      return new nY(t.largestBatchId, ix(e.yt, t.overlayMutation));
    }
    function iW(e, t) {
      let r = t.path.lastSegment();
      return [e, eW(t.path.popLast()), r];
    }
    function iQ(e, t, r, n) {
      return {
        indexId: e,
        uid: t,
        sequenceNumber: r,
        readTime: ij(n.readTime),
        documentKey: eW(n.documentKey.path),
        ...
        return tj(e, ty)
          ...
          .next((e) => {
            if (e)
              return {
                name: e.name,
                query: iG(e.bundledQuery),
                readTime: iq(e.readTime),
              };
          });
      }
      saveNamedQuery(e, t) {
    ...
    class iY {
      ...
      static wt(e, t) {
        return new iY(e, t.uid || "");
      }
      getOverlay(e, t) {
        return tj(e, tk)
          .get(iW(this.userId, t))
          .next((e) => (e ? iH(this.serializer, e) : null));
      }
      getOverlays(e, t) {
        let r = ny();
        return ex
      ...
      removeOverlaysForBatchId(e, t, r) {
        let n = new Set();
        t.forEach((e) => n.add(eW(e.getCollectionPath())));
        let i = [];
        return (
          n.forEach((t) => {
            let n = IDBKeyRange.bound(
              [this.userId, t, r],
              [this.userId, t, r + 1],
              !1,
              !0,
            );
            i.push(tj(e, tk).X(tD, n));
          }),
          ex.waitFor(i)
        );
      }
      ...
      getOverlaysForCollectionGroup(e, t, r, n) {
        ...
        return tj(e, tk)
          .ee({ index: tR, range: a }, (e, t, r) => {
            let a = iH(this.serializer, t);
            s.size() < n || a.largestBatchId === i
        ...
        return tj(e, tk).put(
          (function (e, t, r) {
            ...
            return {
              ...
              overlayMutation: ik(e.yt, r.mutation),
            };
    ...
    class iX {
      ...
      getSessionToken(e) {
        return this.bt(e)
          ...
          .next((e) => {
            let t = e?.value;
            return t ? tZ.fromUint8Array(t) : tZ.EMPTY_BYTE_STRING;
          });
      }
      setSessionToken(e, t) {
    ...
    class iZ {
      ...
      Kt(e, t) {
        ...
        for (let e of (this.Ft(t, 55), Object.keys(r)))
          (this.Ot(e, t), this.Ct(r[e], t));
      }
      kt(e, t) {
        let r = e.fields || {};
        this.Ft(t, 53);
        let n = r[ru].arrayValue?.values?.length || 0;
        (this.Ft(t, 15), t.Mt(t2(n)), this.Ot(ru, t), this.Ct(r[ru], t));
      }
      qt(e, t) {
        let r = e.values || [];
        for (let e of (this.Ft(t, 50), r)) this.Ct(e, t);
      }
      Lt(e, t) {
        (this.Ft(t, 37),
          ei.fromName(e).path.forEach((e) => {
    ...
    class i1 {
      ...
      Qt(e) {
        let t = e[Symbol.iterator](),
          r = t.next();
        for (; !r.done; ) (this.Gt(r.value), (r = t.next()));
        this.zt();
      }
      jt(e) {
        let t = e[Symbol.iterator](),
          r = t.next();
        for (; !r.done; ) (this.Jt(r.value), (r = t.next()));
        this.Ht();
      }
      Zt(e) {
        for (let t of e) {
          ...
          if (e < 128) this.Gt(e);
            ...
            (this.Gt(960 | (e >>> 6)), this.Gt(128 | (63 & e)));
          else if (t < "\uD800" || "\uDBFF" < t)
            (this.Gt(480 | (e >>> 12)),
              this.Gt(128 | (63 & (e >>> 6))),
              this.Gt(128 | (63 & e)));
      ...
      Yt(e) {
        let t = this.en(e),
          r = i0(t);
        (this.tn(1 + r), (this.buffer[this.position++] = 255 & r));
      ...
      rn() {
        (this.sn(255), this.sn(255));
      }
      _n() {
        (this.an(255), this.an(255));
      }
      reset() {
        this.position = 0;
      }
      ...
      en(e) {
        let t,
          r =
            ((t = new DataView(new ArrayBuffer(8))).setFloat64(0, e, !1),
            new Uint8Array(t.buffer)),
          n = !!(128 & r[0]);
        r[0] ^= n ? 255 : 128;
        for (let e = 1; e < r.length; ++e) r[e] ^= 255 * !!n;
        return r;
      }
      Gt(e) {
        let t = 255 & e;
    ...
    class i5 {
      constructor() {
        ((this.cn = new i1()),
          (this.ascending = new i2(this.cn)),
          (this.descending = new i6(this.cn)));
      }
      seed(e) {
        this.cn.seed(e);
      }
    ...
    class i3 {
      constructor(e, t, r, n) {
        ((this.hn = e), (this.Pn = t), (this.Tn = r), (this.In = n));
      }
      En() {
        let e = this.In.length,
          t = 0 === e || 255 === this.In[e - 1] ? e + 1 : e,
          r = new Uint8Array(t);
        return (
          r.set(this.In, 0),
          t !== e ? r.set([0], this.In.length) : ++r[r.length - 1],
          new i3(this.hn, this.Pn, this.Tn, r)
        );
      }
      Rn(e, t, r) {
        return {
          indexId: this.hn,
          uid: e,
          arrayValue: i7(this.Tn),
          directionalValue: i7(this.In),
          orderedDocumentKey: i7(t),
          documentKey: r.path.toArray(),
        };
      }
      An(e, t, r) {
        let n = this.Rn(e, t, r);
    ...
    function i4(e, t) {
      let r = e.hn - t.hn;
      return 0 !== r || 0 !== (r = i8(e.Tn, t.Tn)) || 0 !== (r = i8(e.In, t.In))
        ? r
        : ei.comparator(e.Pn, t.Pn);
    }
    function i8(e, t) {
    ...
    class se {
      constructor(e) {
        for (const t of ((this.Vn = new tW((e, t) =>
          en.comparator(e.field, t.field),
        )),
        (this.collectionId =
        ...
        (this.mn = []),
        e.filters))
          t.isInequality() ? (this.Vn = this.Vn.add(t)) : this.mn.push(t);
      }
      get fn() {
        return this.Vn.size > 1;
      }
      gn(e) {
        if ((M(e.collectionGroup === this.collectionId, 49279), this.fn))
          return !1;
        let t = ey(e);
        ...
        let r = ev(e),
          ...
          i = 0,
          s = 0;
        for (; i < r.length && this.pn(r[i]); ++i)
          n = n.add(r[i].fieldPath.canonicalString());
        if (i === r.length) return !0;
        if (this.Vn.size > 0) {
          let e = this.Vn.getIterator().getNext();
      ...
      Sn() {
        ...
        let e = new tW(en.comparator),
          t = [];
        for (let r of this.mn)
          if (!r.field.isKeyField())
            if ("array-contains" === r.op || "array-contains-any" === r.op)
              t.push(new eb(r.field, 2));
            else {
              if (e.has(r.field)) continue;
              ((e = e.add(r.field)), t.push(new eb(r.field, 0)));
            }
        for (let r of this.dn)
          r.field.isKeyField() ||
            e.has(r.field) ||
            ((e = e.add(r.field)), t.push(new eb(r.field, +("asc" !== r.dir))));
        return new em(em.UNKNOWN_ID, this.collectionId, t, eI.empty());
      }
      pn(e) {
        for (let t of this.mn) if (this.yn(t, e)) return !0;
        return !1;
      }
      yn(e, t) {
    ...
    function sn(e) {
      return (
        ...
        sr(e) ||
        (function (e) {
          if (e instanceof rF && rB(e)) {
            for (let t of e.getFilters()) if (!st(t) && !sr(t)) return !1;
            return !0;
          }
          return !1;
        })(e)
    ...
    function si(e, t) {
      return (
        M(e instanceof rV || e instanceof rF, 38388),
        M(t instanceof rV || t instanceof rF, 25473),
        sa(
          e instanceof rV
            ? t instanceof rV
              ? rF.create([e, t], "and")
            ...
            : t instanceof rV
              ...
              : (function (e, t) {
                  if (
                    (M(e.filters.length > 0 && t.filters.length > 0, 48005),
                    rU(e) && rU(t))
                  )
                    return rz(e, t.getFilters());
                  let r = rB(e) ? e : t,
                    n = rB(e) ? t : e,
                    i = r.filters.map((e) => si(e, n));
                  return rF.create(i, "or");
                })(e, t),
        )
      );
    }
    function ss(e, t) {
      if (rU(t)) return rz(t, e.getFilters());
      {
        let r = t.filters.map((t) => si(e, t));
        return rF.create(r, "or");
      }
    }
    function sa(e) {
      if ((M(e instanceof rV || e instanceof rF, 11850), e instanceof rV))
        return e;
      let t = e.getFilters();
      if (1 === t.length) return sa(t[0]);
      if (rq(e)) return e;
      let r = t.map((e) => sa(e)),
        n = [];
      return (
        r.forEach((t) => {
          t instanceof rV
            ? n.push(t)
            : t instanceof rF &&
              (t.op === e.op ? n.push(...t.filters) : n.push(t));
        }),
        1 === n.length ? n[0] : rF.create(n, e.op)
      );
    }
    class so {
      constructor() {
      ...
      addToCollectionParentIndex(e, t) {
        return (this.bn.add(t), ex.resolve());
      }
      getCollectionParents(e, t) {
        return ex.resolve(this.bn.getEntries(t));
      }
      addFieldIndex(e, t) {
        return ex.resolve();
      }
    ...
    class sl {
      ...
      add(e) {
        let t = e.lastSegment(),
          r = e.popLast(),
          n = this.index[t] || new tW(et.comparator),
          i = !n.has(r);
      ...
      getEntries(e) {
        return (this.index[e] || new tW(et.comparator)).toArray();
      }
    }
    let su = "IndexedDbIndexManager",
      sh = new Uint8Array(0);
    class sc {
      constructor(e, t) {
        ((this.databaseId = t),
      ...
      addToCollectionParentIndex(e, t) {
        if (!this.Dn.has(t)) {
          ...
          let i = { collectionId: r, parent: eW(n) };
          return tj(e, tf).put(i);
        }
        return ex.resolve();
      }
      getCollectionParents(e, t) {
      ...
      addFieldIndex(e, t) {
        ...
        if (t.indexState) {
          ...
          return i.next((e) => {
            r.put(
              iQ(e, this.uid, t.indexState.sequenceNumber, t.indexState.offset),
            );
          });
        }
        return i.next();
      ...
      deleteFieldIndex(e, t) {
        ...
        return r
          .delete(t.indexId)
          .next(() =>
            n.delete(IDBKeyRange.bound([t.indexId], [t.indexId + 1], !1, !0)),
          )
          .next(() =>
      ...
      createTargetIndexes(e, t) {
        return ex.forEach(this.vn(t), (t) =>
          this.getIndexType(e, t).next((r) => {
            if (0 === r || 1 === r) {
              let r = new se(t).Sn();
              if (null != r) return this.addFieldIndex(e, r);
            }
          }),
        );
      }
            ...
            if (n) {
              ...
              return ex
                .forEach(i, (i, s) => {
                  D(
                    su,
                    `Using index id=${i.indexId}|cg=${i.collectionGroup}|f=${i.fields.map((e) => `${e.fieldPath}:${e.kind}`).join(",")} to execute ${r0(t)}`,
                  );
                  let a = (function (e, t) {
                      let r = ey(t);
                      if (void 0 === r) return null;
                      for (let t of r6(e, r.fieldPath))
                        switch (t.op) {
                    ...
                    l = (function (e, t) {
                      ...
                      for (let i of ev(t)) {
                        let t =
                          0 === i.kind
                            ? r5(e, i.fieldPath, e.startAt)
                            : r3(e, i.fieldPath, e.startAt);
                        (r.push(t.value), n && (n = t.inclusive));
                      }
                      return new rR(r, n);
                    })(s, i),
                    u = (function (e, t) {
                      ...
                      for (let i of ev(t)) {
                        let t =
                          0 === i.kind
                            ? r3(e, i.fieldPath, e.endAt)
                            : r5(e, i.fieldPath, e.endAt);
                        (r.push(t.value), n && (n = t.inclusive));
                      }
                      return new rR(r, n);
                    })(s, i),
                  ...
                  return ex.forEach(f, (i) =>
                    r.Z(i, t.limit).next((t) => {
                      t.forEach((t) => {
                        let r = ei.fromSegments(t.documentKey);
                        e.has(r) || ((e = e.add(r)), n.push(r));
                      });
                    }),
                  );
                })
            ...
            ((t =
              0 === e.filters.length
                ...
                : (function (e) {
                    ...
                    let t = (function e(t) {
                      if (
                        (M(t instanceof rV || t instanceof rF, 34018),
                        t instanceof rV)
                      )
                        return t;
                      ...
                      return sn((n = sa(n)))
                        ? n
                        : (M(n instanceof rF, 64498),
                          M(rU(n), 40251),
                          M(n.filters.length > 1, 57927),
                          n.filters.reduce((e, t) => si(e, t)));
                    })(
                      (function e(t) {
                        if (
                          (M(t instanceof rV || t instanceof rF, 20012),
                          t instanceof rV)
                        ) {
                          if (t instanceof rQ) {
                            let e =
                              t.value.arrayValue?.values?.map((e) =>
                                rV.create(t.field, "==", e),
                              ) || [];
                            return rF.create(e, "or");
                          }
                          return t;
                        }
                        let r = t.filters.map((t) => e(t));
                        return rF.create(r, t.op);
                      })(e),
                    );
                    return (
                      M(sn(t), 7391),
                      st(t) || sr(t) ? [t] : t.getFilters()
                    );
                  })(rF.create(e.filters, "and")).map((t) =>
                    rZ(
                      e.path,
                      e.collectionGroup,
                      e.orderBy,
      ...
      On(e, t, r, n, i, s, a) {
        let o = (null != t ? t.length : 1) * Math.max(r.length, i.length),
          ...
          u = [];
        for (let h = 0; h < o; ++h) {
          let o = t ? this.Nn(t[h / l]) : sh,
            c = this.Bn(e, o, r[h % l], n),
            d = this.Ln(e, o, i[h % l], s),
            f = a.map((t) => this.Bn(e, o, t, !0));
          u.push(...this.createRange(c, d, f));
        }
        return u;
      }
      Bn(e, t, r, n) {
        let i = new i3(e, ei.empty(), t, r);
        return n ? i : i.En();
      }
      Ln(e, t, r, n) {
        let i = new i3(e, ei.empty(), t, r);
      ...
      Fn(e, t) {
        ...
        return this.getFieldIndexes(e, n).next((e) => {
          let t = null;
          for (let n of e)
            r.gn(n) && (!t || n.fields.length > t.fields.length) && (t = n);
          return t;
        });
      }
      getIndexType(e, t) {
      ...
      Kn(e, t) {
        ...
        return (
          iZ.Wt.Dt(
            rv(this.databaseId, t),
            n.ln(0 === (r = ev(e)).length ? 0 : r[r.length - 1].kind),
          ),
          n.un()
        );
      }
      xn(e, t, r) {
        ...
        for (let s of ev(e)) {
          let e = r[i++];
          for (let r of n)
            if (this.qn(t, s.fieldPath) && rb(e)) n = this.Un(n, s, e);
            else {
              let t = r.ln(s.kind);
              iZ.Wt.Dt(e, t);
            }
      ...
      Mn(e, t, r) {
        return this.xn(e, t, r.position);
      }
      $n(e) {
        let t = [];
        for (let r = 0; r < e.length; ++r) t[r] = e[r].un();
        return t;
      }
      Un(e, t, r) {
        let n = [...e],
        ...
        for (let e of r.arrayValue.values || [])
          for (let r of n) {
            let n = new i5();
            (n.seed(r.un()), iZ.Wt.Dt(e, n.ln(t.kind)), i.push(n));
          }
        return i;
      }
      qn(e, t) {
      ...
      getFieldIndexes(e, t) {
        let r = tj(e, tv),
          n = tj(e, tb);
        return (t ? r.J(tw, IDBKeyRange.bound(t, t)) : r.J()).next((e) => {
          let t = [];
          return ex
            .forEach(e, (e) =>
              n.get([e.indexId, this.uid]).next((r) => {
                let n, i;
                t.push(
                  ((n = r
                    ? new eI(
                        ...
                        new eT(
                          iq(r.readTime),
                          new ei(eQ(r.documentKey)),
                          r.largestBatchId,
                        ),
                      )
                    : eI.empty()),
                  (i = e.fields.map(
                    ([e, t]) => new eb(en.fromServerFormat(e), t),
                  )),
                  new em(e.indexId, e.collectionGroup, i, n)),
                );
              }),
            )
            .next(() => t);
        ...
        return this.getFieldIndexes(e).next((e) =>
          0 === e.length
            ...
            : (e.sort((e, t) => {
                ...
                return 0 !== r ? r : Q(e.collectionGroup, t.collectionGroup);
              }),
              e[0].collectionGroup),
        );
      }
      updateCollectionGroup(e, t, r) {
        let n = tj(e, tv),
          i = tj(e, tb);
        return this.Wn(e).next((e) =>
          n
            .J(tw, IDBKeyRange.bound(t, t))
            .next((t) =>
              ex.forEach(t, (t) => i.put(iQ(t.indexId, this.uid, e, r))),
            ),
        );
      }
      updateIndexEntries(e, t) {
        let r = new Map();
        return ex.forEach(t, (t, n) => {
          let i = r.get(t.collectionGroup);
          return (
            i ? ex.resolve(i) : this.getFieldIndexes(e, t.collectionGroup)
          ).next(
            (i) => (
              r.set(t.collectionGroup, i),
              ex.forEach(i, (r) =>
                this.Qn(e, t, r).next((t) => {
                  let i = this.Gn(n, r);
                  return t.isEqual(i) ? ex.resolve() : this.zn(e, n, r, t, i);
                }),
              )
            ),
          );
      ...
      jn(e, t, r, n) {
        return tj(e, tT).put(n.Rn(this.uid, this.Kn(r, t.key), t.key));
      }
      Jn(e, t, r, n) {
        return tj(e, tT).delete(n.An(this.uid, this.Kn(r, t.key), t.key));
      }
      Qn(e, t, r) {
        let n = tj(e, tT),
          i = new tW(i4);
        return n
          .ee(
            {
              index: tC,
              range: IDBKeyRange.only([r.indexId, this.uid, i7(this.Kn(r, t))]),
            },
            (e, n) => {
              i = i.add(
                new i3(r.indexId, t, i9(n.arrayValue), i9(n.directionalValue)),
              );
            },
          )
          .next(() => i);
        ...
        if (null != i) {
          ...
          if (rb(s))
            for (let i of s.arrayValue.values || [])
              r = r.add(new i3(t.indexId, e.key, this.Nn(i), n));
        } else r = r.add(new i3(t.indexId, e.key, sh, n));
        return r;
      }
      zn(e, t, r, n, i) {
        D(su, "Updating index entries for document '%s'", t.key);
        let s = [];
        return (
          (function (e, t, r, n, i) {
            let s = e.getIterator(),
      ...
      createRange(e, t, r) {
        r = r
          .sort((e, t) => i4(e, t))
          .filter((e, t, r) => !t || 0 !== i4(e, r[t - 1]));
        let n = [];
        for (let i of (n.push(e), r)) {
          let r = i4(i, e),
            s = i4(i, t);
          if (0 === r) n[0] = e.En();
          else if (r > 0 && s < 0) (n.push(i), n.push(i.En()));
          else if (s > 0) break;
        }
        n.push(t);
        let i = [];
        for (let e = 0; e < n.length; e += 2) {
          if (this.Hn(n[e], n[e + 1])) return [];
          let t = n[e].An(this.uid, sh, ei.empty()),
            r = n[e + 1].An(this.uid, sh, ei.empty());
      ...
      getMinOffsetFromCollectionGroup(e, t) {
        return this.getFieldIndexes(e, t).next(sd);
      }
      getMinOffset(e, t) {
        return ex
          .mapArray(this.vn(t), (t) => this.Fn(e, t).next((e) => e || P(44426)))
          .next(sd);
      }
    }
    function sd(e) {
      ...
      return new eT(t.readTime, t.documentKey, r);
    }
    let sf = {
      didRun: !1,
    ...
    class sp {
      static withCacheSize(e) {
        return new sp(
          e,
          sp.DEFAULT_COLLECTION_PERCENTILE,
          sp.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT,
        );
      }
      constructor(e, t, r) {
    ...
    function sg(e, t, r) {
      let n = e.store(e0),
        ...
        o = 0,
        l = n.ee({ range: a }, (e, t, r) => (o++, r.delete()));
      s.push(
        l.next(() => {
          M(1 === o, 47070, { batchId: r.batchId });
        }),
      );
      let u = [];
      for (let e of r.mutations) {
        var h, c;
        let n = ((h = e.key.path), (c = r.batchId), [t, eW(h), c]);
        (s.push(i.delete(n)), u.push(e.key));
      }
      return ex.waitFor(s).next(() => u);
    }
    function sm(e) {
      let t;
      if (!e) return 0;
      if (e.document) t = e.document;
        ...
        if (!e.noDocument) throw P(14731);
        t = e.noDocument;
      }
      return JSON.stringify(t).length;
    }
    ((sp.DEFAULT_COLLECTION_PERCENTILE = 10),
      (sp.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3),
      (sp.DEFAULT = new sp(
        0x2800000,
        sp.DEFAULT_COLLECTION_PERCENTILE,
        sp.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT,
      )),
      (sp.DISABLED = new sp(-1, 0, 0)));
    class sy {
      constructor(e, t, r, n) {
        ((this.userId = e),
          (this.serializer = t),
      ...
      static wt(e, t, r, n) {
        return (
          M("" !== e.uid, 64387),
          new sy(e.isAuthenticated() ? e.uid : "", t, r, n)
        );
      }
      checkEmpty(e) {
        let t = !0,
          r = IDBKeyRange.bound([this.userId, -1 / 0], [this.userId, 1 / 0]);
        return sw(e)
          .ee({ index: e2, range: r }, (e, r, n) => {
            ((t = !1), n.done());
          })
          .next(() => t);
      }
      addMutationBatch(e, t, r, n) {
        ...
        return s.add({}).next((a) => {
          var o, l, u, h;
          let c, d;
          M("number" == typeof a, 49019);
          let f = new nQ(a, t, r, n),
            p =
              ((o = this.serializer),
              (l = this.userId),
              (c = f.baseMutations.map((e) => ik(o.yt, e))),
              (d = f.mutations.map((e) => ik(o.yt, e))),
              {
                userId: l,
                batchId: f.batchId,
                localWriteTimeMs: f.localWriteTime.toMillis(),
                baseMutations: c,
                mutations: d,
              }),
            g = [],
            m = new tW((e, t) => Q(e.canonicalString(), t.canonicalString()));
          for (let e of n) {
            let t = ((u = this.userId), (h = e.key.path), [u, eW(h), a]);
            ((m = m.add(e.key.path.popLast())),
              g.push(s.put(p)),
              g.push(i.put(t, e5)));
          }
          return (
            m.forEach((t) => {
              g.push(this.indexManager.addToCollectionParentIndex(e, t));
            }),
            e.addOnCommittedListener(() => {
              this.Zn[a] = f.keys();
            }),
          ...
          .next((e) =>
            e
              ? (M(
                ...
                iz(this.serializer, e))
              : null,
          );
      }
      Xn(e, t) {
        return this.Zn[t]
          ? ex.resolve(this.Zn[t])
          : this.lookupMutationBatch(e, t).next((e) => {
              if (e) {
                let r = e.keys();
                return ((this.Zn[t] = r), r);
              }
              return null;
            });
      }
      getNextMutationBatchAfterBatchId(e, t) {
        let r = t + 1,
          ...
          i = null;
        return sw(e)
          .ee({ index: e2, range: n }, (e, t, n) => {
            (t.userId === this.userId &&
              (M(t.batchId >= r, 47524, { Yn: r }),
              (i = iz(this.serializer, t))),
              n.done());
          })
          .next(() => i);
      }
      getHighestUnacknowledgedBatchId(e) {
        let t = IDBKeyRange.upperBound([this.userId, 1 / 0]),
          r = -1;
        return sw(e)
          .ee({ index: e2, range: t, reverse: !0 }, (e, t, n) => {
            ((r = t.batchId), n.done());
          })
          .next(() => r);
      }
      getAllMutationBatches(e) {
        let t = IDBKeyRange.bound([this.userId, -1], [this.userId, 1 / 0]);
        return sw(e)
          .J(e2, t)
          .next((e) => e.map((e) => iz(this.serializer, e)));
      }
      getAllMutationBatchesAffectingDocumentKey(e, t) {
        let r = [this.userId, eW(t.path)],
          ...
          .ee({ range: n }, (r, n, s) => {
            ...
            if (a === this.userId && t.path.isEqual(u))
              return sw(e)
                .get(l)
                .next((e) => {
                  if (!e) throw P(61480, { er: r, batchId: l });
                  (M(
                    e.userId === this.userId,
                    10503,
                    "Unexpected user for mutation batch",
      ...
      getAllMutationBatchesAffectingDocumentKeys(e, t) {
        ...
        return (
          t.forEach((t) => {
            let i = [this.userId, eW(t.path)],
              s = IDBKeyRange.lowerBound(i),
              a = tj(e, e3).ee({ range: s }, (e, n, i) => {
                let [s, a, o] = e,
                  l = eQ(a);
      ...
      getAllMutationBatchesAffectingQuery(e, t) {
        ...
        return tj(e, e3)
          .ee({ range: s }, (e, t, i) => {
            let [s, o, l] = e,
              u = eQ(o);
            s === this.userId && r.isPrefixOf(u)
              ? u.length === n && (a = a.add(l))
              : i.done();
          })
          .next(() => this.tr(e, a));
      }
          ...
          t.forEach((t) => {
            n.push(
              sw(e)
                .get(t)
                .next((e) => {
                  if (null === e) throw P(35274, { batchId: t });
                  (M(
                    e.userId === this.userId,
                    9748,
                    "Unexpected user for mutation batch",
      ...
      removeMutationBatch(e, t) {
        return sg(e.le, this.userId, t).next(
          (r) => (
            e.addOnCommittedListener(() => {
              this.nr(t.batchId);
            }),
      ...
      performConsistencyCheck(e) {
        return this.checkEmpty(e).next((t) => {
          ...
          return tj(e, e3)
            ...
            .next(() => {
              M(0 === n.length, 56720, {
                rr: n.map((e) => e.canonicalString()),
              });
            });
        });
      }
      containsKey(e, t) {
        return sv(e, this.userId, t);
      }
      ir(e) {
        return tj(e, eZ)
          .get(this.userId)
    ...
    class sI {
      ...
      allocateTargetId(e) {
        return this.ur(e).next((t) => {
          let r = new sb(t.highestTargetId);
          return (
            (t.highestTargetId = r.next()),
            this.cr(e, t).next(() => t.highestTargetId)
          );
        });
      }
      getLastRemoteSnapshotVersion(e) {
        return this.ur(e).next((e) =>
          eg.fromTimestamp(
            new ep(
      ...
      setTargetsMetadata(e, t, r) {
        return this.ur(e).next(
          (n) => (
            (n.highestListenSequenceNumber = t),
            r && (n.lastRemoteSnapshotVersion = r.toTimestamp()),
            t > n.highestListenSequenceNumber &&
              (n.highestListenSequenceNumber = t),
            this.cr(e, n)
          ),
        );
      ...
      addTargetData(e, t) {
        return this.lr(e, t).next(() =>
          this.ur(e).next(
            (r) => ((r.targetCount += 1), this.hr(t, r), this.cr(e, r)),
          ),
        );
      }
      ...
      removeTargetData(e, t) {
        return this.removeMatchingKeysForTargetId(e, t.targetId)
          .next(() => tj(e, ti).delete(t.targetId))
          .next(() => this.ur(e))
          .next(
            (t) => (
              M(t.targetCount > 0, 8065),
              (t.targetCount -= 1),
              this.cr(e, t)
            ),
          );
        ...
        return tj(e, ti)
          .ee((s, a) => {
            ...
            o.sequenceNumber <= t &&
              ...
              (n++, i.push(this.removeTargetData(e, o)));
          })
          .next(() => ex.waitFor(i))
          .next(() => n);
      }
      forEachTarget(e, t) {
        return tj(e, ti).ee((e, r) => {
          t(i$(r));
        });
      }
      ur(e) {
        return tj(e, td)
          .get(tc)
          .next((e) => (M(null !== e, 2888), e));
      }
      cr(e, t) {
        return tj(e, td).put(tc, t);
      }
      lr(e, t) {
        return tj(e, ti).put(iK(this.serializer, t));
      }
      hr(e, t) {
        let r = !1;
        return (
      ...
      getTargetData(e, t) {
        let r = r0(t),
          n = IDBKeyRange.bound([r, -1 / 0], [r, 1 / 0]),
          i = null;
        return tj(e, ti)
          .ee({ range: n, index: ts }, (e, r, n) => {
            let s = i$(r);
            r1(t, s.target) && ((i = s), n.done());
          })
          .next(() => i);
      }
      ...
      removeMatchingKeys(e, t, r) {
        let n = sE(e);
        return ex.forEach(t, (t) => {
          let i = eW(t.path);
          return ex.waitFor([
            n.delete([r, i]),
            this.referenceDelegate.removeReference(e, r, t),
          ]);
        });
      }
      ...
      containsKey(e, t) {
        let r = eW(t.path),
          ...
          i = 0;
        return sE(e)
          .ee({ index: tu, Y: !0, range: n }, ([e, t], r, n) => {
            0 !== e && (i++, n.done());
          })
          .next(() => i > 0);
      }
    ...
    class sS {
      constructor(e) {
        ((this.Pr = e), (this.buffer = new tW(sT)), (this.Tr = 0));
      }
      Ir() {
        return ++this.Tr;
      }
      Er(e) {
        ...
        if (this.buffer.size < this.Pr) this.buffer = this.buffer.add(t);
          ...
          0 > sT(t, e) && (this.buffer = this.buffer.delete(e).add(t));
        }
      }
      get maxValue() {
    ...
    class sC {
      ...
      Ar(e) {
        (D(s_, `Garbage collection scheduled in ${e}ms`),
    ...
    class sA {
      ...
      nthSequenceNumber(e, t) {
        if (0 === t) return ex.resolve(e$.ce);
        let r = new sS(t);
        return this.Vr.forEachTarget(e, (e) => r.Er(e.sequenceNumber))
          .next(() => this.Vr.mr(e, (e) => r.Er(e)))
          .next(() => r.maxValue);
      }
      removeTargets(e, t, r) {
      ...
      collect(e, t) {
        return -1 === this.params.cacheSizeCollectionThreshold
          ? (D("LruGarbageCollector", "Garbage collection skipped; disabled"),
            ex.resolve(sf))
    ...
    class sk {
      ...
      wr(e, t) {
        ...
        return (
          (r = !1),
          tj(e, eZ)
            .te((n) => sv(e, n, t).next((e) => (e && (r = !0), ex.resolve(!e))))
            .next(() => r)
        );
      }
      removeOrphanedDocuments(e, t) {
        let r = this.db.getRemoteDocumentCache().newChangeBuffer(),
          n = [],
          i = 0;
        return this.yr(e, (s, a) => {
          if (a <= t) {
            let t = this.wr(e, s).next((t) => {
              if (!t)
                return (
                  i++,
                  r
                    ...
                    .next(
                      () => (
                        r.removeEntry(s, eg.min()),
                        sE(e).delete([0, eW(s.path)])
                      ),
                    )
                );
            });
      ...
      yr(e, t) {
        let r = sE(e),
          ...
          i = e$.ce;
        return r
          .ee({ index: tu }, ([e, r], { path: s, sequenceNumber: a }) => {
            0 === e
              ? (i !== e$.ce && t(new ei(eQ(n)), i), (i = a), (n = s))
              : (i = e$.ce);
          })
          .next(() => {
            i !== e$.ce && t(new ei(eQ(n)), i);
          });
      }
      getCacheSize(e) {
    ...
    function sx(e, t) {
      ...
      return sE(e).put(
        ...
        { targetId: 0, path: eW(t.path), sequenceNumber: r }),
      );
    }
    class sD {
      constructor() {
      ...
      removeEntry(e, t) {
        (this.assertNotApplied(),
          this.changes.set(e, rN.newInvalidDocument(e).setReadTime(t)));
      }
      getEntry(e, t) {
        this.assertNotApplied();
        let r = this.changes.get(t);
        return void 0 !== r ? ex.resolve(r) : this.getFromCache(e, t);
      }
      getEntries(e, t) {
    ...
    class sN {
      ...
      addEntry(e, t, r) {
        return tj(e, e4).put(r);
      }
      removeEntry(e, t, r) {
        let n;
        return tj(e, e4).delete([
          (n = t.path.toArray()).slice(0, n.length - 2),
          n[n.length - 2],
          iB(r),
          n[n.length - 1],
        ]);
      ...
      updateMetadata(e, t) {
        return this.getMetadata(e).next(
          (r) => ((r.byteSize += t), this.Sr(e, r)),
        );
      }
      getEntry(e, t) {
        let r = rN.newInvalidDocument(t);
        return tj(e, e4)
          .ee({ index: e7, range: IDBKeyRange.only(sO(t)) }, (e, n) => {
            r = this.br(t, n);
          })
          .next(() => r);
      }
      Dr(e, t) {
        let r = { size: 0, document: rN.newInvalidDocument(t) };
        return tj(e, e4)
          .ee({ index: e7, range: IDBKeyRange.only(sO(t)) }, (e, n) => {
            r = { document: this.br(t, n), size: sm(n) };
          })
          .next(() => r);
      }
      getEntries(e, t) {
      ...
      vr(e, t) {
        let r = nf,
          n = new tK(ei.comparator);
        return this.Cr(e, t, (e, t) => {
          let i = this.br(e, t);
          ((r = r.insert(e, i)), (n = n.insert(e, sm(t))));
        }).next(() => ({ documents: r, Fr: n }));
      }
      Cr(e, t, r) {
        if (t.isEmpty()) return ex.resolve();
        let n = new tW(sL);
        t.forEach((e) => (n = n.add(e)));
        let i = IDBKeyRange.bound(sO(n.first()), sO(n.last())),
          s = n.getIterator(),
          a = s.getNext();
        return tj(e, e4)
          .ee({ index: e7, range: i }, (e, t, n) => {
            let i = ei.fromSegments([
              ...t.prefixPath,
              t.collectionGroup,
              t.documentId,
            ]);
            for (; a && 0 > sL(a, i); ) (r(a, null), (a = s.getNext()));
            (a &&
              a.isEqual(i) &&
              (r(a, t), (a = s.hasNext() ? s.getNext() : null)),
              a ? n.j(sO(a)) : n.done());
          })
          .next(() => {
            for (; a; ) (r(a, null), (a = s.hasNext() ? s.getNext() : null));
          });
      }
      ...
      getAllFromCollectionGroup(e, t, r, n) {
        let i = nf,
          ...
          a = sP(t, eT.max());
        return tj(e, e4)
          .ee({ index: te, range: IDBKeyRange.bound(s, a, !0) }, (e, t, r) => {
            let s = this.br(
              ei.fromSegments(
      ...
      newChangeBuffer(e) {
        return new sR(this, !!e && e.trackRemovals);
      }
      getSize(e) {
      ...
      br(e, t) {
        if (t) {
          let e = (function (e, t) {
            var r;
            let n, i;
            if (t.document) n = iA(e.yt, t.document, !!t.hasCommittedMutations);
            else if (t.noDocument) {
              let e = ei.fromSegments(t.noDocument.path),
                r = iq(t.noDocument.readTime);
              ((n = rN.newNoDocument(e, r)),
                t.hasCommittedMutations && n.setHasCommittedMutations());
            } else {
              if (!t.unknownDocument) return P(56709);
              {
                let e = ei.fromSegments(t.unknownDocument.path),
                  r = iq(t.unknownDocument.version);
                n = rN.newUnknownDocument(e, r);
              }
            }
            return (
              t.readTime &&
                n.setReadTime(
                  ((i = new ep((r = t.readTime)[0], r[1])),
                  eg.fromTimestamp(i)),
                ),
              n
            );
          })(this.serializer, t);
          if (!(e.isNoDocument() && e.version.isEqual(eg.min()))) return e;
        }
        return rN.newInvalidDocument(e);
      }
    }
    class sR extends sD {
      constructor(e, t) {
      ...
      applyChanges(e) {
        let t = [],
          r = 0,
          n = new tW((e, t) => Q(e.canonicalString(), t.canonicalString()));
        return (
          this.changes.forEach((i, s) => {
            let a = this.Or.get(i);
            if (
              (t.push(this.Mr.removeEntry(e, i, a.readTime)),
              s.isValidDocument())
            ) {
              let o = iU(this.Mr.serializer, s);
              n = n.add(i.path.popLast());
              let l = sm(o);
              ((r += l - a.size), t.push(this.Mr.addEntry(e, i, o)));
            } else if (((r -= a.size), this.trackRemovals)) {
              let r = iU(this.Mr.serializer, s.convertToNoDocument(eg.min()));
              t.push(this.Mr.addEntry(e, i, r));
            }
          }),
          n.forEach((r) => {
            t.push(this.Mr.indexManager.addToCollectionParentIndex(e, r));
          }),
          t.push(this.Mr.updateMetadata(e, r)),
          ex.waitFor(t)
        );
      }
      getFromCache(e, t) {
        return this.Mr.Dr(e, t).next(
          (e) => (
            this.Or.set(t, { size: e.size, readTime: e.document.readTime }),
            e.document
          ),
        );
      }
      getAllFromCache(e, t) {
        return this.Mr.vr(e, t).next(
          ({ documents: e, Fr: t }) => (
            t.forEach((t, r) => {
              this.Or.set(t, { size: r, readTime: e.get(t).readTime });
            }),
            e
          ),
        );
    ...
    function sL(e, t) {
      ...
      for (let e = 0; e < r.length - 2 && e < n.length - 2; ++e)
        if ((i = Q(r[e], n[e]))) return i;
      return (
        (i = Q(r.length, n.length)) ||
        (i = Q(r[r.length - 2], n[n.length - 2])) ||
        Q(r[r.length - 1], n[n.length - 1])
      );
    }
    class sM {
      constructor(e, t) {
    ...
    class sV {
      ...
      getDocument(e, t) {
        ...
        return this.documentOverlayCache
          ...
          .next(
            (e) => (null !== r && nB(r.mutation, e, tY.empty(), ep.now()), e),
          );
      }
      getDocuments(e, t) {
        return this.remoteDocumentCache
          .getEntries(e, t)
          .next((t) => this.getLocalViewOfDocuments(e, t, nb()).next(() => t));
      }
      getLocalViewOfDocuments(e, t, r = nb()) {
        let n = ny();
      ...
      computeViews(e, t, r, n) {
        ...
        return (
          t.forEach((e, t) => {
            let a = r.get(t.key);
            n.has(t.key) && (void 0 === a || a.mutation instanceof nz)
              ? (i = i.insert(t.key, t))
              : void 0 !== a
                ? (s.set(t.key, a.mutation.getFieldMask()),
                  nB(a.mutation, t, a.mutation.getFieldMask(), ep.now()))
                : s.set(t.key, tY.empty());
          }),
          this.recalculateAndSaveOverlays(e, i).next(
            (e) => (
              e.forEach((e, t) => s.set(e, t)),
              t.forEach((e, t) => a.set(e, new sM(t, s.get(e) ?? null))),
              a
            ),
          )
        );
          ...
          .next((e) => {
            for (let i of e)
              i.keys().forEach((e) => {
                let s = t.get(e);
                if (null === s) return;
                let a = r.get(e) || tY.empty();
                ((a = i.applyToLocalView(s, a)), r.set(e, a));
                let o = (n.get(i.batchId) || nb()).add(e);
      ...
      getDocumentsMatchingQuery(e, t, r, n) {
        return ei.isDocumentKey(t.path) &&
          null === t.collectionGroup &&
          0 === t.filters.length
          ...
          .next((i) => {
            ...
            return s.next((t) =>
              ex
                ...
                .next(() => this.computeViews(e, o, t, nb()))
                .next((e) => ({ batchId: a, changes: nm(e) })),
            );
          });
      }
      getDocumentsMatchingDocumentQuery(e, t) {
        return this.getDocument(e, new ei(t)).next((e) => {
          let t = ng();
      ...
      getDocumentsMatchingCollectionQuery(e, t, r, n) {
        ...
        return this.documentOverlayCache
          ...
          .next((e) => {
            i.forEach((t, r) => {
              let n = r.getKey();
              null === e.get(n) && (e = e.insert(n, rN.newInvalidDocument(n)));
            });
            let r = ng();
            return (
              e.forEach((e, n) => {
                let s = i.get(e);
                (void 0 !== s && nB(s.mutation, n, tY.empty(), ep.now()),
                  nu(t, n) && (r = r.insert(e, n)));
              }),
              r
            );
          });
    ...
    class sF {
      ...
      getBundleMetadata(e, t) {
        return ex.resolve(this.Nr.get(t));
      }
      saveBundleMetadata(e, t) {
        return (
          this.Nr.set(t.id, {
            id: t.id,
            version: t.version,
            createTime: im(t.createTime),
          }),
          ex.resolve()
        );
      }
      getNamedQuery(e, t) {
        return ex.resolve(this.Br.get(t));
      }
      saveNamedQuery(e, t) {
        return (
          this.Br.set(t.name, {
            name: t.name,
            query: iG(t.bundledQuery),
            readTime: im(t.readTime),
          }),
          ex.resolve()
        );
      }
    ...
    class sU {
      constructor() {
        ((this.overlays = new tK(ei.comparator)), (this.Lr = new Map()));
      }
      getOverlay(e, t) {
        return ex.resolve(this.overlays.get(t));
      }
      getOverlays(e, t) {
        let r = ny();
        return ex
      ...
      getOverlaysForCollectionGroup(e, t, r, n) {
        ...
        for (; s.hasNext(); ) {
          ...
          if (e.getKey().getCollectionGroup() === t && e.largestBatchId > r) {
            ...
            (null === t && ((t = ny()), (i = i.insert(e.largestBatchId, t))),
              t.set(e.getKey(), e));
          }
        }
        let a = ny(),
      ...
      St(e, t, r) {
        ...
        if (null !== n) {
          let e = this.Lr.get(n.largestBatchId).delete(r.key);
          this.Lr.set(n.largestBatchId, e);
        }
        this.overlays = this.overlays.insert(r.key, new nY(t, r));
        let i = this.Lr.get(t);
        (void 0 === i && ((i = nb()), this.Lr.set(t, i)),
          this.Lr.set(t, i.add(r.key)));
      }
    }
    class sB {
      constructor() {
        this.sessionToken = tZ.EMPTY_BYTE_STRING;
      }
      getSessionToken(e) {
        return ex.resolve(this.sessionToken);
      }
      setSessionToken(e, t) {
        return ((this.sessionToken = t), ex.resolve());
      }
    }
    class sj {
      constructor() {
        ((this.kr = new tW(sq.Kr)), (this.qr = new tW(sq.Ur)));
      }
      isEmpty() {
    ...
    class sq {
      ...
      static Kr(e, t) {
        return ei.comparator(e.key, t.key) || Q(e.Jr, t.Jr);
      }
      static Ur(e, t) {
        return Q(e.Jr, t.Jr) || ei.comparator(e.key, t.key);
      }
    }
    class sz {
      constructor(e, t) {
        ((this.indexManager = e),
          ...
          (this.mutationQueue = []),
          (this.Yn = 1),
          (this.Hr = new tW(sq.Kr)));
      }
      checkEmpty(e) {
        return ex.resolve(0 === this.mutationQueue.length);
      }
      addMutationBatch(e, t, r, n) {
        let i = this.Yn;
        (this.Yn++,
        ...
        let s = new nQ(i, t, r, n);
        for (let t of (this.mutationQueue.push(s), n))
          ((this.Hr = this.Hr.add(new sq(t.key, i))),
      ...
      getHighestUnacknowledgedBatchId() {
        return ex.resolve(0 === this.mutationQueue.length ? -1 : this.Yn - 1);
      }
      getAllMutationBatches(e) {
        return ex.resolve(this.mutationQueue.slice());
      }
      getAllMutationBatchesAffectingDocumentKey(e, t) {
        let r = new sq(t, 0),
          n = new sq(t, 1 / 0),
      ...
      getAllMutationBatchesAffectingDocumentKeys(e, t) {
        ...
        return (
          t.forEach((e) => {
            let t = new sq(e, 0),
              n = new sq(e, 1 / 0);
            this.Hr.forEachInRange([t, n], (e) => {
              r = r.add(e.Jr);
            });
          }),
          ex.resolve(this.Yr(r))
        );
      }
      getAllMutationBatchesAffectingQuery(e, t) {
        let r = t.path,
          n = r.length + 1,
          i = r;
        ei.isDocumentKey(i) || (i = i.child(""));
        let s = new sq(new ei(i), 0),
          a = new tW(Q);
        return (
          this.Hr.forEachWhile((e) => {
            let t = e.key.path;
            return (
              !!r.isPrefixOf(t) && (t.length === n && (a = a.add(e.Jr)), !0)
            );
          }, s),
          ex.resolve(this.Yr(a))
        );
      }
      Yr(e) {
        let t = [];
      ...
      removeMutationBatch(e, t) {
        (M(0 === this.ei(t.batchId, "removed"), 55003),
          this.mutationQueue.shift());
        let r = this.Hr;
        return ex
          .forEach(t.mutations, (n) => {
            let i = new sq(n.key, t.batchId);
            return (
              (r = r.delete(i)),
      ...
      containsKey(e, t) {
        let r = new sq(t, 0),
          n = this.Hr.firstAfterOrEqual(r);
        return ex.resolve(t.isEqual(n && n.key));
      }
      performConsistencyCheck(e) {
        return (this.mutationQueue.length, ex.resolve());
      }
      ei(e, t) {
        return this.Xr(e);
      }
    ...
    class s$ {
      constructor(e) {
        ((this.ti = e), (this.docs = new tK(ei.comparator)), (this.size = 0));
      }
      setIndexManager(e) {
        this.indexManager = e;
      }
      ...
      getEntry(e, t) {
        ...
        return ex.resolve(
          r ? r.document.mutableCopy() : rN.newInvalidDocument(t),
        );
      }
      getEntries(e, t) {
        let r = nf;
        return (
          t.forEach((e) => {
            ...
            r = r.insert(
              e,
              t ? t.document.mutableCopy() : rN.newInvalidDocument(e),
            );
          }),
          ex.resolve(r)
        );
      ...
      getDocumentsMatchingQuery(e, t, r, n) {
        let i = nf,
          s = t.path,
          a = new ei(s.child("__id-9223372036854775808__")),
      ...
      ni(e, t) {
        return ex.forEach(this.docs, (e) => t(e));
      }
      newChangeBuffer(e) {
        return new sK(this);
      }
      getSize(e) {
        return ex.resolve(this.size);
      }
    }
    class sK extends sD {
      constructor(e) {
    ...
    class sG {
      constructor(e) {
        ((this.persistence = e),
          (this.ri = new nd((e) => r0(e), r1)),
          (this.lastRemoteSnapshotVersion = eg.min()),
      ...
      forEachTarget(e, t) {
        return (this.ri.forEach((e, r) => t(r)), ex.resolve());
      }
      getLastRemoteSnapshotVersion(e) {
        return ex.resolve(this.lastRemoteSnapshotVersion);
      }
      getHighestSequenceNumber(e) {
        return ex.resolve(this.ii);
      }
      allocateTargetId(e) {
        return (
          (this.highestTargetId = this.oi.next()),
          ex.resolve(this.highestTargetId)
        );
      }
      setTargetsMetadata(e, t, r) {
        return (
      ...
      lr(e) {
        ...
        (t > this.highestTargetId &&
          ((this.oi = new sb(t)), (this.highestTargetId = t)),
          e.sequenceNumber > this.ii && (this.ii = e.sequenceNumber));
      }
      addTargetData(e, t) {
        return (this.lr(t), (this.targetCount += 1), ex.resolve());
      }
      updateTargetData(e, t) {
        return (this.lr(t), ex.resolve());
      }
      removeTargetData(e, t) {
        return (
      ...
      getTargetCount(e) {
        return ex.resolve(this.targetCount);
      }
      getTargetData(e, t) {
        let r = this.ri.get(t) || null;
        return ex.resolve(r);
      }
      addMatchingKeys(e, t, r) {
        return (this.si.$r(t, r), ex.resolve());
      }
      removeMatchingKeys(e, t, r) {
        this.si.Qr(t, r);
      ...
      removeMatchingKeysForTargetId(e, t) {
        return (this.si.Gr(t), ex.resolve());
      }
      getMatchingKeysForTargetId(e, t) {
        let r = this.si.jr(t);
        return ex.resolve(r);
      ...
      containsKey(e, t) {
        return ex.resolve(this.si.containsKey(t));
      }
    }
    class sH {
      constructor(e, t) {
        ((this._i = {}),
          ...
          (this.li = new sG(this)),
          (this.indexManager = new so()),
          (this.remoteDocumentCache = (function (e) {
            return new s$(e);
          })((e) => this.referenceDelegate.hi(e))),
          (this.serializer = new iF(t)),
          (this.Pi = new sF(this.serializer)));
      }
      start() {
      ...
      getDocumentOverlayCache(e) {
        ...
        return (t || ((t = new sU()), (this.overlays[e.toKey()] = t)), t);
      }
      getMutationQueue(e, t) {
        let r = this._i[e.toKey()];
        return (
          r ||
            ((r = new sz(t, this.referenceDelegate)), (this._i[e.toKey()] = r)),
          r
        );
      }
      getGlobalsCache() {
      ...
      runTransaction(e, t, r) {
        ...
        let n = new sW(this.ai.next());
        return (
          this.referenceDelegate.Ti(),
          r(n)
            .next((e) => this.referenceDelegate.Ii(n).next(() => e))
            .toPromise()
      ...
      Ei(e, t) {
        return ex.or(
          Object.values(this._i).map((r) => () => r.containsKey(e, t)),
        );
      }
    }
    class sW extends eA {
    ...
    class sQ {
      constructor(e) {
        ((this.persistence = e), (this.Ri = new sj()), (this.Ai = null));
      }
      static Vi(e) {
        return new sQ(e);
      }
      ...
      markPotentiallyOrphaned(e, t) {
        return (this.di.add(t.toString()), ex.resolve());
      }
      removeTarget(e, t) {
      ...
      Ii(e) {
        ...
        return ex
          .forEach(this.di, (r) => {
            let n = ei.fromPath(r);
            return this.mi(e, n).next((e) => {
              e || t.removeEntry(n, eg.min());
            });
          })
      ...
      mi(e, t) {
        return ex.or([
          () => ex.resolve(this.Ri.containsKey(t)),
    ...
    class sJ {
      ...
      mr(e, t) {
        return ex.forEach(this.fi, (r, n) =>
          this.wr(e, r, n).next((e) => (e ? ex.resolve() : t(n))),
        );
      }
      removeTargets(e, t, r) {
      ...
      removeOrphanedDocuments(e, t) {
        ...
        return n
          .ni(e, (n) =>
            this.wr(e, n, t).next((e) => {
              e || (r++, i.removeEntry(n, eg.min()));
            }),
          )
          .next(() => i.apply(e))
          .next(() => r);
      ...
      markPotentiallyOrphaned(e, t) {
        return (this.fi.set(t, e.currentSequenceNumber), ex.resolve());
      }
      removeTarget(e, t) {
        let r = t.withSequenceNumber(e.currentSequenceNumber);
      ...
      addReference(e, t, r) {
        return (this.fi.set(r, e.currentSequenceNumber), ex.resolve());
      }
      removeReference(e, t, r) {
        return (this.fi.set(r, e.currentSequenceNumber), ex.resolve());
      }
          ...
          e.isFoundDocument() &&
            (t += (function e(t) {
              switch (rc(t)) {
                ...
                case 6:
                  return t6(t.bytesValue).approximateByteSize();
                case 7:
      ...
      wr(e, t, r) {
        return ex.or([
          ...
          () => {
            let e = this.fi.get(t);
            return ex.resolve(void 0 !== e && e > r);
          },
        ]);
      }
      getCacheSize(e) {
    ...
    class sY {
      ...
      k(e, t, r, n) {
        let i = new eN("createOrUpgrade", t);
        r < 1 &&
          n >= 1 &&
          (e.createObjectStore(eY),
          e.createObjectStore(eZ, { keyPath: "userId" }),
          e
            .createObjectStore(e0, { keyPath: e1, autoIncrement: !0 })
            .createIndex(e2, e6, { unique: !0 }),
          e.createObjectStore(e3),
          sX(e),
          e.createObjectStore(eJ));
        let s = ex.resolve();
        return (
          r < 3 &&
            n >= 3 &&
            (0 !== r &&
              (e.deleteObjectStore(to),
              e.deleteObjectStore(ti),
              e.deleteObjectStore(td),
              sX(e)),
            (s = s.next(() => {
              let e, t;
              return (
                ...
                (t = {
                  ...
                  lastRemoteSnapshotVersion: eg.min().toTimestamp(),
                  targetCount: 0,
                }),
                e.put(tc, t)
              );
          ...
          r < 4 &&
            ...
            (0 !== r &&
              (s = s.next(() =>
                i
                  ...
                  .J()
                  .next((t) => {
                    (e.deleteObjectStore(e0),
                      e
                        .createObjectStore(e0, {
                          keyPath: e1,
                          autoIncrement: !0,
                        })
                        .createIndex(e2, e6, { unique: !0 }));
            ...
            (s = s.next(() => {
              e.createObjectStore(tg, { keyPath: "clientId" });
            }))),
          r < 5 && n >= 5 && (s = s.next(() => this.gi(i))),
          r < 6 &&
            n >= 6 &&
            (s = s.next(() => (e.createObjectStore(tr), this.pi(i)))),
          r < 7 && n >= 7 && (s = s.next(() => this.yi(i))),
          r < 8 && n >= 8 && (s = s.next(() => this.wi(e, i))),
          r < 9 &&
            n >= 9 &&
            (s = s.next(() => {
          ...
          r < 10 && n >= 10 && (s = s.next(() => this.Si(i))),
          r < 11 &&
            n >= 11 &&
            (s = s.next(() => {
              (e.createObjectStore(tm, { keyPath: "bundleId" }),
                e.createObjectStore(ty, { keyPath: "name" }));
            })),
          r < 12 &&
            n >= 12 &&
            (s = s.next(() => {
              let t;
              ((t = e.createObjectStore(tk, { keyPath: tx })).createIndex(
                tD,
                tN,
                { unique: !1 },
              ),
                t.createIndex(tR, tO, { unique: !1 }));
            })),
          r < 13 &&
            n >= 13 &&
            (s = s
              .next(() => {
                let t;
                ((t = e.createObjectStore(e4, { keyPath: e8 })).createIndex(
                  e7,
                  e9,
                ),
                  t.createIndex(te, tt));
              ...
              .next(() => this.bi(e, i))
              .next(() => e.deleteObjectStore(eJ))),
          r < 14 && n >= 14 && (s = s.next(() => this.Di(e, i))),
          r < 15 &&
            n >= 15 &&
            (s = s.next(() => {
              (e
                .createObjectStore(tv, {
                  keyPath: "indexId",
                  autoIncrement: !0,
                })
                .createIndex(tw, "collectionGroup", { unique: !1 }),
                e
                  .createObjectStore(tb, { keyPath: tI })
                  .createIndex(tE, t_, { unique: !1 }),
                e
                  .createObjectStore(tT, { keyPath: tS })
                  .createIndex(tC, tA, { unique: !1 }));
            })),
          r < 16 &&
            n >= 16 &&
            (s = s
              .next(() => {
                t.objectStore(tb).clear();
              })
              .next(() => {
                t.objectStore(tT).clear();
              })),
          r < 17 &&
            n >= 17 &&
            (s = s.next(() => {
          ...
          ex.forEach(t, (t) => {
            ...
            return r.J(e2, n).next((r) =>
              ex.forEach(r, (r) => {
                ...
                let n = iz(this.serializer, r);
                return sg(e, t.userId, n).next(() => {});
              }),
            );
          }),
        );
      ...
      wi(e, t) {
        e.createObjectStore(tf, { keyPath: tp });
        let r = t.store(tf),
          n = new sl(),
          i = (e) => {
            if (n.add(e)) {
              let t = e.lastSegment(),
                n = e.popLast();
              return r.put({ collectionId: t, parent: eW(n) });
            }
          };
        return t
          .store(eJ)
          .ee({ Y: !0 }, (e, t) => i(new et(e).popLast()))
          .next(() =>
            t.store(e3).ee({ Y: !0 }, ([e, t, r], n) => i(eQ(t).popLast())),
          );
      }
      Si(e) {
        let t = e.store(ti);
        ...
        return r
          .ee((e, r) => {
            let i = t.store(e4),
              s = (
                r.document
                  ? new ei(et.fromString(r.document.name).popFirst(5))
                  : r.noDocument
                    ? ei.fromSegments(r.noDocument.path)
                    : r.unknownDocument
                      ? ei.fromSegments(r.unknownDocument.path)
                      : P(36783)
              ).path.toArray(),
              a = {
      ...
      Di(e, t) {
        let r = t.store(e0),
          n = new sN(this.serializer),
          i = new sH(sQ.Vi, this.serializer.yt);
        return r.J().next((e) => {
          let r = new Map();
          return (
            e.forEach((e) => {
              let t = r.get(e.userId) ?? nb();
              (iz(this.serializer, e)
                .keys()
                .forEach((e) => (t = t.add(e))),
                r.set(e.userId, t));
            ...
            ex.forEach(r, (e, r) => {
              let s = new S(r),
                a = iY.wt(this.serializer, s),
                o = i.getIndexManager(s);
              return new sV(
                n,
                sy.wt(s, this.serializer, o, i.referenceDelegate),
                a,
                o,
              )
                .recalculateAndSaveOverlaysForDocumentKeys(new tB(t, e$.ce), e)
                .next();
            })
          );
        });
    ...
    function sX(e) {
      (e
        .createObjectStore(to, { keyPath: tl })
        .createIndex(tu, th, { unique: !0 }),
        e
          .createObjectStore(ti, { keyPath: "targetId" })
          .createIndex(ts, ta, { unique: !0 }),
        e.createObjectStore(td));
    }
    let sZ = "IndexedDbPersistence",
      s0 =
    ...
    class s1 {
      constructor(e, t, r, n, i, s, a, o, l, u, h = 18) {
        ...
        ((this.referenceDelegate = new sk(this, n)),
          (this.Ki = t + "main"),
          (this.serializer = new iF(o)),
          (this.qi = new eR(this.Ki, this.xi, new sY(this.serializer))),
          (this.ci = new iX()),
          (this.li = new sI(this.referenceDelegate, this.serializer)),
          (this.remoteDocumentCache = (function (e) {
            return new sN(e);
          })(this.serializer)),
          (this.Pi = new iJ()),
          this.window && this.window.localStorage
            ? (this.Ui = this.window.localStorage)
            : ((this.Ui = null),
              !1 === u &&
                N(
                  sZ,
        ...
        return this.$i()
          .then(() => {
            if (!this.isPrimary && !this.allowTabSynchronization)
              throw new F(V.FAILED_PRECONDITION, s0);
            return (
              this.Wi(),
              this.Qi(),
              this.Gi(),
              this.runTransaction(
                ...
                "readonly",
                (e) => this.li.getHighestSequenceNumber(e),
              )
            );
          })
          .then((e) => {
            this.ai = new e$(e, this.Fi);
          })
          .then(() => {
            this.ui = !0;
          })
        ...
        return this.runTransaction(
          ...
          (e) =>
            tj(e, tg)
              ...
              .next(() => {
                if (this.isPrimary)
                  return this.ji(e).next((e) => {
                    e ||
                      ((this.isPrimary = !1),
                      this.Ci.enqueueRetryable(() => this.ki(!1)));
                  });
              })
              .next(() => this.Ji(e))
              .next((t) =>
          ...
          .catch((e) => {
            if (eM(e))
              return (
                D(sZ, "Failed to extend owner lease: ", e),
                this.isPrimary
              );
          ...
          .then((e) => {
            (this.isPrimary !== e && this.Ci.enqueueRetryable(() => this.ki(e)),
              (this.isPrimary = e));
          });
      }
      ji(e) {
        return tj(e, eY)
          .get(eX)
          .next((e) => ex.resolve(this.Xi(e)));
      }
      Yi(e) {
        return tj(e, tg).delete(this.clientId);
      }
      async es() {
        if (this.isPrimary && !this.ts(this.Li, 18e5)) {
          this.Li = Date.now();
          let e = await this.runTransaction(
            ...
            (e) => {
              let t = tj(e, tg);
              return t.J().next((e) => {
                let r = this.ns(e, 18e5),
                  n = e.filter((e) => -1 === r.indexOf(e));
                return ex.forEach(n, (e) => t.delete(e.clientId)).next(() => n);
              });
            },
          ).catch(() => []);
          if (this.Ui) for (let t of e) this.Ui.removeItem(this.rs(t.clientId));
        }
      }
      Gi() {
        this.Bi = this.Ci.enqueueAfterDelay(
        ...
        return this.Mi
          ...
          : tj(e, eY)
              ...
              .next((t) => {
                if (
                  null !== t &&
                  this.ts(t.leaseTimestampMs, 5e3) &&
                  !this.ss(t.ownerId)
                ) {
      ...
      async shutdown() {
        ((this.ui = !1),
          this._s(),
          this.Bi && (this.Bi.cancel(), (this.Bi = null)),
          this.us(),
          this.cs(),
          await this.qi.runTransaction(
            "shutdown",
            "readwrite",
            [eY, tg],
            (e) => {
      ...
      ns(e, t) {
        return e.filter(
          (e) => this.ts(e.updateTimeMs, t) && !this.ss(e.clientId),
        );
      }
      hs() {
        return this.runTransaction("getActiveClients", "readonly", (e) =>
          tj(e, tg)
            .J()
            .next((e) => this.ns(e, 18e5).map((e) => e.clientId)),
        );
      }
      get started() {
        return this.ui;
      ...
      getMutationQueue(e, t) {
        return sy.wt(e, this.serializer, t, this.referenceDelegate);
      }
      getTargetCache() {
        return this.li;
      }
      ...
      getIndexManager(e) {
        return new sc(e, this.serializer.yt.databaseId);
      }
      getDocumentOverlayCache(e) {
        return iY.wt(this.serializer, e);
      }
      getBundleCache() {
        return this.Pi;
      }
      runTransaction(e, t, r) {
        ...
        return this.qi
          .runTransaction(
            ...
            s,
            (n) => (
              (i = new tB(n, this.ai ? this.ai.next() : e$.ce)),
              "readwrite-primary" === t
                ? this.ji(i)
                    .next((e) => !!e || this.Ji(i))
                    .next((t) => {
                      if (!t)
                        throw (
                          ...
                          (this.isPrimary = !1),
                          this.Ci.enqueueRetryable(() => this.ki(!1)),
                          new F(V.FAILED_PRECONDITION, eC)
                        );
                      return r(i);
                    })
                    .next((e) => this.Zi(i).next(() => e))
                : this.Ps(i).next(() => r(i))
            ),
          )
      ...
      Ps(e) {
        return tj(e, eY)
          ...
          .next((e) => {
            if (
              null !== e &&
              this.ts(e.leaseTimestampMs, 5e3) &&
              !this.ss(e.ownerId) &&
              !this.Xi(e) &&
              !(
                this.Mi ||
      ...
      Hi(e) {
        ...
        return t
          ...
          .next((e) =>
            this.Xi(e)
              ? (D(sZ, "Releasing primary lease."), t.delete(eX))
              : ex.resolve(),
          );
      }
      ts(e, t) {
        ...
        return (
          !(e < r - t) &&
          (!(e > r) ||
            (N(`Detected an update time that is in the future: ${e} > ${r}`),
            !1))
        );
      }
      Wi() {
        null !== this.document &&
          ...
          this.document.addEventListener("visibilitychange", this.Ni),
          (this.inForeground = "visible" === this.document.visibilityState));
      }
      us() {
        this.Ni &&
          (this.document.removeEventListener("visibilitychange", this.Ni),
          (this.Ni = null));
      }
      Qi() {
      ...
      cs() {
        this.Oi &&
          (this.window.removeEventListener("pagehide", this.Oi),
          (this.Oi = null));
      }
      ss(e) {
        try {
          let t = null !== this.Ui?.getItem(this.rs(e));
          return (
            D(
              sZ,
          ...
          return (N(sZ, "Failed to get zombied client id.", e), !1);
        }
      }
      _s() {
        if (this.Ui)
          try {
            ...
            N("Failed to set zombie client id.", e);
          }
      }
      ls() {
        if (this.Ui)
    ...
    function s2(e, t) {
      let r = e.projectId;
      return (
        e.isDefaultDatabase || (r += "." + e.database),
        "firestore/" + t + "/" + r + "/"
      );
    }
    class s6 {
      ...
      static Es(e, t) {
        ...
        return new s6(e, t.fromCache, r, n);
      }
    }
    class s5 {
      constructor() {
    ...
    class s3 {
      constructor() {
        ((this.Rs = !1),
          (this.As = !1),
          (this.Vs = 100),
          (this.ds = (0, w.isSafari)() ? 8 : eO((0, w.getUA)()) > 0 ? 6 : 4));
      }
      initialize(e, t) {
      ...
      getDocumentsMatchingQuery(e, t, r, n) {
        ...
        return this.gs(e, t)
          ...
          .next(() => {
            if (i.result) return;
            let r = new s5();
            return this.ys(e, t, r).next((n) => {
              if (((i.result = n), this.As)) return this.ws(e, t, r, n.size);
            });
          })
          .next(() => i.result);
      }
          ...
          : (x() <= E.LogLevel.DEBUG &&
            ...
            r.documentReadCount > this.ds * n
              ? (x() <= E.LogLevel.DEBUG &&
                ...
                this.indexManager.createTargetIndexes(e, nt(t)))
              : ex.resolve());
      }
      gs(e, t) {
        if (r7(t)) return ex.resolve(null);
        let r = nt(t);
        return this.indexManager.getIndexType(e, r).next((n) =>
          0 === n
            ? null
            : (null !== t.limit && 1 === n && (r = nt((t = ns(t, null, "F")))),
              this.indexManager.getDocumentsMatchingTarget(e, r).next((n) => {
                let i = nb(...n);
                return this.fs.getDocuments(e, i).next((n) =>
                  this.indexManager.getMinOffset(e, r).next((r) => {
                    let s = this.Ss(t, n);
                    return this.bs(t, s, i, r.readTime)
                      ? this.gs(e, ns(t, null, "F"))
                      : this.Ds(e, s, t, r);
                  }),
                );
              })),
      ...
      ps(e, t, r, n) {
        return r7(t) || n.isEqual(eg.min())
          ? ex.resolve(null)
          : this.fs.getDocuments(e, r).next((i) => {
              let s = this.Ss(t, i);
              return this.bs(t, s, r, n)
                ? ex.resolve(null)
                : (x() <= E.LogLevel.DEBUG &&
                    D(
                      "QueryEngine",
      ...
      ys(e, t, r) {
        return (
          ...
          this.fs.getDocumentsMatchingQuery(e, t, eT.min(), r)
        );
      }
      Ds(e, t, r, n) {
        return this.fs.getDocumentsMatchingQuery(e, r, n).next(
          (e) => (
            t.forEach((t) => {
              e = e.insert(t.key, t);
            }),
          ...
          return e.mutationQueue
            ...
            .next(
              (i) => (
                (n = i),
                e.Os(t),
                e.mutationQueue.getAllMutationBatches(r)
              ),
            )
            .next((t) => {
              let i = [],
              ...
              return e.localDocuments
                .getDocuments(r, a)
                .next((e) => ({ Ns: e, removedBatchIds: i, addedBatchIds: s }));
            });
        },
      );
    }
    function s9(e) {
      return e.persistence.runTransaction(
        ...
        "readonly",
        (t) => e.li.getLastRemoteSnapshotVersion(t),
      );
    }
    function ae(e, t, r) {
      let n = nb(),
          ...
          return (
            r.forEach((r, s) => {
              ...
              (s.isFoundDocument() !== a.isFoundDocument() && (i = i.add(r)),
                s.isNoDocument() && s.version.isEqual(eg.min())
                  ? (t.removeEntry(r, s.readTime), (n = n.insert(r, s)))
                  : !a.isValidDocument() ||
                      s.version.compareTo(a.version) > 0 ||
                      (0 === s.version.compareTo(a.version) &&
                        a.hasPendingWrites)
                    ? (t.addEntry(s), (n = n.insert(r, s)))
                    : D(
                        s4,
                ...
                : e.li
                    ...
                    .next(
                      (i) => (
                        ...
                        e.li.addTargetData(r, n).next(() => n)
                      ),
                    ),
            );
        })
        .then((r) => {
          let n = e.vs.get(r.targetId);
          return (
            (null === n ||
              r.snapshotVersion.compareTo(n.snapshotVersion) > 0) &&
              ((e.vs = e.vs.insert(r.targetId, r)), e.Fs.set(t, r.targetId)),
            r
          );
        });
    }
    async function ar(e, t, r) {
      ...
      try {
        ...
        if (!eM(e)) throw e;
        D(s4, `Failed to update sequence numbers for target ${t}: ${e}`);
      }
      ((e.vs = e.vs.remove(t)), e.Fs.delete(n.target));
    }
    function an(e, t, r) {
      let n = eg.min(),
        i = nb();
      return e.persistence.runTransaction("Execute query", "readwrite", (s) => {
        ...
        return ((a = nt(t)),
        void 0 !== (o = e.Fs.get(a))
          ? ex.resolve(e.vs.get(o))
          : e.li.getTargetData(s, a))
          .next((t) => {
            if (t)
              return (
                (n = t.lastLimboFreeSnapshotVersion),
                e.li.getMatchingKeysForTargetId(s, t.targetId).next((e) => {
                  i = e;
                })
              );
          })
          ...
          .next((r) => (aa(e, nh(t), r), { documents: r, ks: i }));
      });
    }
    function ai(e, t) {
      let r = e.li,
      ...
      return n
        ...
        : e.persistence.runTransaction("Get target data", "readonly", (e) =>
            r.At(e, t).next((e) => (e ? e.target : null)),
          );
    }
    function as(e, t) {
      let r = e.Ms.get(t) || eg.min();
      return e.persistence
        .runTransaction("Get new document changes", "readonly", (n) =>
          e.xs.getAllFromCollectionGroup(
            n,
            t,
            eE(r, -1),
            Number.MAX_SAFE_INTEGER,
    ...
    async function ao(e, t, r, n) {
      let i = nb(),
        s = nf;
      for (let e of r) {
        let r = t.Ks(e.metadata.name);
        e.document && (i = i.add(r));
        let n = t.qs(e);
        (n.setReadTime(t.Us(e.metadata.readTime)), (s = s.insert(r, n)));
      }
      let a = e.xs.newChangeBuffer({ trackRemovals: !0 }),
        o = await at(e, nt(r8(et.fromString(`__bundle__/docs/${n}`))));
      return e.persistence.runTransaction(
        ...
        (t) =>
          ae(t, a, s)
            ...
            .next((r) =>
              e.li
                .removeMatchingKeysForTargetId(t, o.targetId)
                .next(() => e.li.addMatchingKeys(t, i, o.targetId))
                .next(() =>
                  e.localDocuments.getLocalViewOfDocuments(t, r.Bs, r.Ls),
                )
                .next(() => r.Bs),
            ),
      );
    }
    async function al(e, t, r = nb()) {
      let n = await at(e, nt(iG(t.bundledQuery)));
      return e.persistence.runTransaction(
        "Save named query",
        "readwrite",
        (i) => {
          ...
          if (n.snapshotVersion.compareTo(s) >= 0)
            return e.Pi.saveNamedQuery(i, t);
          let a = n.withResumeToken(tZ.EMPTY_BYTE_STRING, s);
          return (
            (e.vs = e.vs.insert(a.targetId, a)),
            e.li
              .updateTargetData(i, a)
              .next(() => e.li.removeMatchingKeysForTargetId(i, n.targetId))
              .next(() => e.li.addMatchingKeys(i, r, n.targetId))
              .next(() => e.Pi.saveNamedQuery(i, t))
          );
        },
      );
    }
    let au = "firestore_clients";
    function ah(e, t) {
      return `${au}_${e}_${t}`;
    }
    let ac = "firestore_mutations";
    function ad(e, t, r) {
      let n = `${ac}_${e}_${r}`;
      return (t.isAuthenticated() && (n += `_${t.uid}`), n);
    }
    let af = "firestore_targets";
    function ap(e, t) {
      return `${af}_${e}_${t}`;
    }
    let ag = "SharedClientState";
    class am {
      constructor(e, t, r, n) {
        ((this.user = e),
          (this.batchId = t),
      ...
      static $s(e, t, r) {
        let n = JSON.parse(r),
          ...
          s =
            "object" == typeof n &&
            -1 !== ["pending", "acknowledged", "rejected"].indexOf(n.state) &&
        ...
        return (
          s &&
            ...
            (i = new F(n.error.code, n.error.message)),
          s
            ? new am(e, t, n.state, i)
            : (N(ag, `Failed to parse mutation state for ID '${t}': ${r}`),
              null)
        );
      }
      Ws() {
      ...
      static $s(e, t) {
        ...
        return (
          i &&
            ...
            (n = new F(r.error.code, r.error.message)),
          i
            ? new ay(e, r.state, n)
            : (N(ag, `Failed to parse target state for ID '${e}': ${t}`), null)
        );
      }
      Ws() {
        let e = { state: this.state, updateTimeMs: Date.now() };
    ...
    class av {
      ...
      static $s(e, t) {
        ...
        for (let e = 0; n && e < r.activeTargetIds.length; ++e)
          ((n = eH(r.activeTargetIds[e])), (i = i.add(r.activeTargetIds[e])));
        return n
          ? new av(e, i)
          : (N(ag, `Failed to parse client data for instance '${e}': ${t}`),
            null);
      }
    }
    class aw {
      ...
      static $s(e) {
        ...
        return "object" == typeof t &&
          ...
          ? new aw(t.clientId, t.onlineState)
          : (N(ag, `Failed to parse online state: ${e}`), null);
      }
    }
    class ab {
      constructor() {
    ...
    class aI {
      constructor(e, t, r, n, i) {
        ...
        ((this.storage = this.window.localStorage),
          (this.currentUser = i),
          (this.Xs = ah(this.persistenceKey, this.zs)),
          (this.Ys = (function (e) {
            return `firestore_sequence_number_${e}`;
          })(this.persistenceKey)),
          (this.Hs = this.Hs.insert(this.zs, new ab())),
          (this.eo = RegExp(`^${au}_${s}_([^_]*)$`)),
          (this.no = RegExp(`^${ac}_${s}_(\\d+)(?:_(.*))?$`)),
          (this.ro = RegExp(`^${af}_${s}_(\\d+)$`)),
          (this.io = (function (e) {
      ...
      async start() {
        for (let e of await this.syncEngine.hs()) {
          if (e === this.zs) continue;
          let t = this.getItem(ah(this.persistenceKey, e));
          if (t) {
            let r = av.$s(e, t);
            r && (this.Hs = this.Hs.insert(r.clientId, r));
          }
        }
        this.oo();
        let e = this.storage.getItem(this.io);
        if (e) {
          let t = this._o(e);
          t && this.ao(t);
        }
        for (let e of this.Zs) this.Js(e);
        ((this.Zs = []),
      ...
      updateMutationState(e, t, r) {
        (this.co(e, t, r), this.lo(e));
      }
      addLocalQueryTarget(e, t = !0) {
        let r = "not-current";
        if (this.isActiveQueryTarget(e)) {
          let t = this.storage.getItem(ap(this.persistenceKey, e));
          if (t) {
            let n = ay.$s(e, t);
            n && (r = n.state);
          }
        }
        return (t && this.ho.Qs(e), this.oo(), r);
      }
      ...
      clearQueryState(e) {
        this.removeItem(ap(this.persistenceKey, e));
      }
      ...
      shutdown() {
        this.started &&
          (this.window.removeEventListener("storage", this.js),
          this.removeItem(this.Xs),
          (this.started = !1));
      }
      getItem(e) {
        let t = this.storage.getItem(e);
        return (D(ag, "READ", e, t), t);
      }
      setItem(e, t) {
        (D(ag, "SET", e, t), this.storage.setItem(e, t));
      }
      removeItem(e) {
        (D(ag, "REMOVE", e), this.storage.removeItem(e));
      }
      Js(e) {
        if (e.storageArea === this.storage) {
          if ((D(ag, "EVENT", e.key, e.newValue), e.key === this.Xs))
            return void N(
          ...
          this.Ci.enqueueRetryable(async () => {
            if (this.started) {
              if (null !== e.key) {
                if (this.eo.test(e.key)) {
                  if (null == e.newValue) {
                    let t = this.Eo(e.key);
                    return this.Ro(t, null);
                  }
                  {
                    let t = this.Ao(e.key, e.newValue);
                    if (t) return this.Ro(t.clientId, t);
                  }
                } else if (this.no.test(e.key)) {
                  if (null !== e.newValue) {
                    let t = this.Vo(e.key, e.newValue);
                    if (t) return this.mo(t);
                  }
                } else if (this.ro.test(e.key)) {
                  if (null !== e.newValue) {
                    let t = this.fo(e.key, e.newValue);
                    if (t) return this.po(t);
                  }
                } else if (e.key === this.io) {
                  if (null !== e.newValue) {
                    let t = this._o(e.newValue);
                    if (t) return this.ao(t);
                  }
                  ...
                  let t = (function (e) {
                    ...
                    if (null != e)
                      try {
                        let r = JSON.parse(e);
                        (M("number" == typeof r, 30636, { yo: e }), (t = r));
                      } catch (e) {
                        N(
                          ag,
                  ...
                  t !== e$.ce && this.sequenceNumberHandler(t);
                } else if (e.key === this.so) {
                  let t = this.wo(e.newValue);
                  await Promise.all(t.map((e) => this.syncEngine.So(e)));
                }
              }
            } else this.Zs.push(e);
          });
      ...
      co(e, t, r) {
        let n = new am(this.currentUser, e, t, r),
          i = ad(this.persistenceKey, this.currentUser, e);
        this.setItem(i, n.Ws());
      }
      lo(e) {
        let t = ad(this.persistenceKey, this.currentUser, e);
        this.removeItem(t);
      }
      To(e) {
        let t = { clientId: this.zs, onlineState: e };
        this.storage.setItem(this.io, JSON.stringify(t));
      }
      Po(e, t, r) {
        let n = ap(this.persistenceKey, e),
          i = new ay(e, t, r);
        this.setItem(n, i.Ws());
      }
      Io(e) {
      ...
      Vo(e, t) {
        let r = this.no.exec(e),
          n = Number(r[1]),
          i = void 0 !== r[2] ? r[2] : null;
        return am.$s(new S(i), n, t);
      }
      fo(e, t) {
        let r = Number(this.ro.exec(e)[1]);
        return ay.$s(r, t);
      }
      _o(e) {
        return aw.$s(e);
      ...
      async mo(e) {
        ...
        D(ag, `Ignoring mutation for non-active user ${e.user.uid}`);
      }
      po(e) {
        return this.syncEngine.Do(e.targetId, e.state, e.error);
      }
      Ro(e, t) {
        let r = t ? this.Hs.insert(e, t) : this.Hs.remove(e),
          n = this.uo(this.Hs),
          i = this.uo(r),
          s = [],
          a = [];
    ...
    class aE {
      ...
      start() {
        return ((this.vo = new ab()), Promise.resolve());
      }
      handleUserChange(e, t, r) {}
      setOnlineState(e) {}
      shutdown() {}
    ...
    class aS {
      ...
      Oo() {
        for (let e of (D(aT, "Network connectivity changed: AVAILABLE"),
        this.Lo))
          e(0);
      }
      Bo() {
        for (let e of (D(aT, "Network connectivity changed: UNAVAILABLE"),
        this.Lo))
          e(1);
      }
      static v() {
    ...
    function aA() {
      return (
        null === aC
          ? (aC = 0x10000000 + Math.round(0x80000000 * Math.random()))
          : aC++,
        "0x" + aC.toString(16)
      );
    }
    let ak = "RestConnection",
      ax = {
    ...
    class aD {
      ...
      constructor(e) {
        ...
        ((this.qo = t + "://" + e.host),
          ...
          (this.$o =
            this.databaseId.database === rr
              ? `project_id=${r}`
              : `project_id=${r}&database_id=${n}`));
      }
      Wo(e, t, r, n, i) {
        let s = aA(),
          a = this.Qo(e, t.toUriEncodedString());
        D(ak, `Sending RPC '${e}' ${s}:`, a, r);
        let o = {
        ...
        let { host: l } = new URL(a),
          u = (0, w.isCloudWorkstation)(l);
        return this.zo(e, a, o, r, u).then(
          (t) => (D(ak, `Received RPC '${e}' ${s}: `, t), t),
          (t) => {
            throw (
              R(
                ak,
      ...
      Go(e, t, r) {
        ((e["X-Goog-Api-Client"] = "gl-js/ fire/" + C),
    ...
    class aP extends aD {
      ...
      static u_() {
        aP.c_ ||
          (aO(u(), l.STAT_EVENT, (e) => {
            e.stat === o.PROXY
              ? D(aR, "STAT_EVENT: detected buffering proxy")
              : e.stat === o.NOPROXY &&
                D(aR, "STAT_EVENT: detected no buffering proxy");
          }),
          (aP.c_ = !0));
      }
      zo(e, t, r, i, o) {
              ...
              try {
                switch (h.getLastErrorCode()) {
                  case a.NO_ERROR:
                    ...
                    (D(
                      aR,
                      `XHR for RPC '${e}' ${l} received:`,
                      JSON.stringify(t),
                    ),
                      o(t));
                    break;
                  case a.TIMEOUT:
                    (D(aR, `RPC '${e}' ${l} timed out`),
                      u(new F(V.DEADLINE_EXCEEDED, "Request time out")));
                    break;
                  case a.HTTP_ERROR:
                    let r = h.getStatus();
                    if (
                      ...
                      if (t && t.status && t.message) {
                        let e,
                          r =
                            ...
                            Object.values(V).indexOf(e) >= 0 ? e : V.UNKNOWN);
                        u(new F(r, t.message));
                      } else
                        u(
                          new F(
                    ...
                    } else u(new F(V.UNAVAILABLE, "Connection failed."));
                    break;
                  default:
                    P(9055, {
                      l_: e,
                ...
                D(aR, `RPC '${e}' ${l} completed.`);
              }
            }));
          let c = JSON.stringify(i);
          (D(aR, `RPC '${e}' ${l} sending request:`, i),
            h.send(t, "POST", c, r, 15));
        });
      }
      T_(e, t, r) {
        let n = aA(),
          ...
          a = this.createWebChannelTransport(),
          o = {
        ...
        (void 0 !== l && (o.longPollingTimeout = Math.round(1e3 * l)),
          ...
          this.Go(o.initMessageHeaders, t, r),
          (o.encodeInitMessageHeaders = !0));
        let u = s.join("");
        D(aR, `Creating RPC '${e}' stream ${n}: ${u}`, o);
        let h = a.createWebChannel(u, o);
        this.I_(h);
        let d = !1,
          f = !1,
          p = new aN({
            Jo: (t) => {
              f
                ...
                : (d ||
                    (D(aR, `Opening RPC '${e}' stream ${n} transport.`),
                    h.open(),
                    (d = !0)),
                  D(aR, `RPC '${e}' stream ${n} sending:`, t),
                  h.send(t));
            },
            Ho: () => h.close(),
          });
        return (
          aO(h, i.EventType.OPEN, () => {
            f || (D(aR, `RPC '${e}' stream ${n} transport opened.`), p.i_());
          }),
          aO(h, i.EventType.CLOSE, () => {
            f ||
              ((f = !0),
              D(aR, `RPC '${e}' stream ${n} transport closed`),
              p.o_(),
              this.E_(h));
          }),
          aO(h, i.EventType.ERROR, (t) => {
            f ||
              ((f = !0),
              R(
                aR,
              ...
              p.o_(
                new F(V.UNAVAILABLE, "The operation could not be completed"),
              ));
          }),
          aO(h, i.EventType.MESSAGE, (t) => {
            if (!f) {
              let r = t.data[0];
              M(!!r, 16349);
              let i = r?.error || r[0]?.error;
              if (i) {
                D(aR, `RPC '${e}' stream ${n} received error:`, i);
                let t = i.status,
                  r = (function (e) {
                    let t = c[e];
                    if (void 0 !== t) return n0(t);
                  })(t),
                  s = i.message;
                ("NOT_FOUND" === t &&
                  s.includes("database") &&
                  s.includes("does not exist") &&
                  s.includes(this.databaseId.database) &&
                  R(
                  ...
                  p.o_(new F(r, s)),
                  h.close());
              } else (D(aR, `RPC '${e}' stream ${n} received:`, r), p.__(r));
            }
          }),
          aP.u_(),
          setTimeout(() => {
    ...
    function aL() {
      return "u" > typeof window ? window : null;
    }
    function aM() {
    ...
    class aF {
      ...
      p_(e) {
        ...
        (n > 0 &&
          D(
            "ExponentialBackoff",
            `Backing off for ${n} ms (base delay: ${this.d_} ms, delay with jitter: ${t} ms, last attempt: ${r} ms ago)`,
          ),
      ...
      G_(e, t) {
        ...
        ((this.stream = this.j_(e, t)),
          ...
          this.stream.onMessage((e) => {
            r(() => (1 == ++this.F_ ? this.J_(e) : this.onNext(e)));
          }));
      }
      N_() {
        ((this.state = 5),
      ...
      Q_(e) {
        return (t) => {
          this.Ci.enqueueAndForget(() =>
            this.D_ === e
              ? t()
              : (D(aU, "stream callback skipped by getCloseGuardedDispatcher."),
                Promise.resolve()),
          );
        };
      }
    ...
    class aj extends aB {
            ...
            if ("targetChange" in t) {
              ...
              let s =
                ...
                o =
                  ...
                  e.useProto3Json
                    ? (M(void 0 === i || "string" == typeof i, 58123),
                      tZ.fromBase64String(i || ""))
                    : (M(
                        void 0 === i ||
                          i instanceof v.Buffer ||
                          i instanceof Uint8Array,
                        16193,
                      ),
                      tZ.fromUint8Array(i || new Uint8Array()))),
              ...
              r = new ir(
                ...
                (l &&
                  new F(
                    void 0 === l.code ? V.UNKNOWN : n0(l.code),
                    l.message || "",
                  )) ||
                  null,
              );
              ...
              let i = iI(e, n.document.name),
                s = im(n.document.updateTime),
                a = n.document.createTime
                  ? im(n.document.createTime)
                  : eg.min(),
                o = new rD({ mapValue: { fields: n.document.fields } }),
                l = rN.newFoundDocument(i, s, a, o);
              r = new ie(n.targetIds || [], n.removedTargetIds || [], l.key, l);
            } else if ("documentDelete" in t) {
              t.documentDelete;
              let n = t.documentDelete;
              n.document;
              let i = iI(e, n.document),
                s = n.readTime ? im(n.readTime) : eg.min(),
                a = rN.newNoDocument(i, s);
              r = new ie([], n.removedTargetIds || [], a.key, a);
            } else if ("documentRemove" in t) {
              t.documentRemove;
              let n = t.documentRemove;
              n.document;
              let i = iI(e, n.document);
              r = new ie([], n.removedTargetIds || [], i, null);
            } else {
              if (!("filter" in t)) return P(11601, { Vt: t });
              {
                t.filter;
                let e = t.filter;
                e.targetId;
                let { count: n = 0, unchangedNames: i } = e,
                  s = new nX(n, i);
                r = new it(e.targetId, s);
              }
            }
            return r;
          })(this.serializer, e),
          r = (function (e) {
            if (!("targetChange" in e)) return eg.min();
      ...
      Z_(e) {
        let t,
          r = {};
        ((r.database = iT(this.serializer)),
          (r.addTarget = (function (e, t) {
            let r,
              n = t.target;
            if (
              (((r = r2(n)
                ? { documents: iD(e, n) }
                : { query: iN(e, n).ft }).targetId = t.targetId),
              t.resumeToken.approximateByteSize() > 0)
            ) {
              r.resumeToken = ig(e, t.resumeToken);
              let n = id(e, t.expectedCount);
              null !== n && (r.expectedCount = n);
            } else if (t.snapshotVersion.compareTo(eg.min()) > 0) {
              r.readTime = ip(e, t.snapshotVersion.toTimestamp());
              let n = id(e, t.expectedCount);
              null !== n && (r.expectedCount = n);
            }
            return r;
      ...
      X_(e) {
        let t = {};
        ((t.database = iT(this.serializer)), (t.removeTarget = e), this.K_(t));
      }
    }
    class aq extends aB {
      constructor(e, t, r, n, i, s) {
      ...
      J_(e) {
        return (
          M(!!e.streamToken, 31322),
          (this.lastStreamToken = e.streamToken),
          M(!e.writeResults || 0 === e.writeResults.length, 55816),
          this.listener.ta()
        );
      }
      onNext(e) {
        var t, r;
        (M(!!e.streamToken, 12678),
          (this.lastStreamToken = e.streamToken),
          this.M_.reset());
        let n =
            ((t = e.writeResults),
            ...
            t && t.length > 0
              ? (M(void 0 !== r, 14353),
                t.map((e) => {
                  let t;
                  return (
                    (t = e.updateTime ? im(e.updateTime) : im(r)).isEqual(
                      eg.min(),
                    ) && (t = im(r)),
                    new nL(t, e.transformResults || [])
                  );
                }))
              : []),
          i = im(e.commitTime);
        return this.listener.na(i, n);
      }
      ra() {
        let e = {};
        ((e.database = iT(this.serializer)), this.K_(e));
      }
      ea(e) {
        let t = {
          streamToken: this.lastStreamToken,
          writes: e.map((e) => ik(this.serializer, e)),
        };
        this.K_(t);
      }
    }
      ...
      Wo(e, t, r, n) {
        return (
          ...
          Promise.all([
            ...
            .then(([i, s]) => this.connection.Wo(e, iv(t, r), n, i, s))
            .catch((e) => {
      ...
      jo(e, t, r, n, i) {
        return (
          ...
          Promise.all([
            ...
            .then(([s, a]) => this.connection.jo(e, iv(t, r), n, s, a, i))
            .catch((e) => {
              throw "FirebaseError" === e.name
                ? (e.code === V.UNAUTHENTICATED &&
                    (this.authCredentials.invalidateToken(),
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
        this.aa ? (N(t), (this.aa = !1)) : D("OnlineStateTracker", t);
      }
      Pa() {
        ...
        ((this.localStore = e),
          ...
          this.fa.Mo((e) => {
            r.enqueueAndForget(async () => {
              a6(this) &&
                (D(aG, "Restarting streams for network reachability change."),
    ...
    async function aW(e) {
      if (a6(e)) for (let t of e.ma) await t(!0);
    }
    async function aQ(e) {
      for (let t of e.ma) await t(!1);
    }
    function aJ(e, t) {
    ...
    function aY(e, t) {
      ...
      let n,
        i,
        s = aJ(e, t.targetId);
      if (void 0 !== s && e.Ia.has(s)) return;
      let a =
        (void 0 !== (n = aJ(e, (r = t.targetId))) && e.Ra.delete(n),
        (i = r % 2 != 0 ? e.Va.next() : e.Aa.next()),
        e.Ea.set(r, i),
        e.Ra.set(i, r),
        i);
      D(aG, "remoteStoreListen mapping SDK target ID to remote", t.targetId, a);
      let o = new iV(
        t.target,
        a,
        t.purpose,
      ...
      (e.Ia.set(a, o), a2(e) ? a1(e) : ou(e).O_() && aZ(e, o));
    }
    function aX(e, t) {
      let r = ou(e),
        n = aJ(e, t);
      (D(
        ...
        e.Ra.delete(n),
        r.O_() && a0(e, n),
        0 === e.Ia.size && (r.O_() ? r.L_() : a6(e) && e.ga.set("Unknown")));
    }
    function aZ(e, t) {
      if (
        (e.pa.$e(t.targetId),
        t.resumeToken.approximateByteSize() > 0 ||
          t.snapshotVersion.compareTo(eg.min()) > 0)
      ) {
        let r = e.Ra.get(t.targetId);
        if (void 0 === r)
          return void D(
            aG,
            "SDK target ID not found for remote ID: " + t.targetId,
          );
        let n = e.remoteSyncer.getRemoteKeysForTarget(r).size;
    ...
    function a1(e) {
      ((e.pa = new is({
        getRemoteKeysForTarget: (t) => {
          let r = e.Ra.get(t);
          return void 0 !== r ? e.remoteSyncer.getRemoteKeysForTarget(r) : nb();
        },
    ...
    function a2(e) {
      return a6(e) && !ou(e).x_() && e.Ia.size > 0;
    }
    function a6(e) {
      return 0 === e.da.size;
    }
    ...
    async function a4(e, t) {
      ((e.pa = void 0), a2(e) ? (e.ga.ha(t), a1(e)) : e.ga.set("Unknown"));
    }
    async function a8(e, t, r) {
      if ((e.ga.set("Online"), t instanceof ir && 2 === t.state && t.cause))
        try {
          await (async function (e, t) {
            ...
            for (let n of t.targetIds) {
              if (e.Ia.has(n)) {
                let t = e.Ra.get(n);
                (void 0 !== t &&
                  (await e.remoteSyncer.rejectListen(t, r),
                  e.Ea.delete(t),
                  e.Ra.delete(n)),
                  e.Ia.delete(n));
              }
          ...
          (D(aG, "Failed to remove targets %s: %s ", t.targetIds.join(","), r),
            await a7(e, r));
        }
      else if (
        (t instanceof ie
        ...
        try {
          let t,
            ...
            i,
            s,
            a = await s9(e.localStore);
          r.compareTo(a) >= 0 &&
            (await ((t = e.pa.Tt(r)).targetChanges.forEach((t, n) => {
              if (t.resumeToken.approximateByteSize() > 0) {
                let i = e.Ia.get(n);
                i && e.Ia.set(n, i.withResumeToken(t.resumeToken, r));
              }
            }),
            t.targetMismatches.forEach((t, r) => {
              ...
              (e.Ia.set(
                t,
                n.withResumeToken(tZ.EMPTY_BYTE_STRING, n.snapshotVersion),
              ),
                a0(e, t));
              let i = new iV(n.target, t, r, n.sequenceNumber);
              aZ(e, i);
            }),
            (n = new Map()),
            ...
            (s = new n7(
              ...
              i,
              t.documentUpdates,
              t.resolvedLimboDocuments,
            )),
            e.remoteSyncer.applyRemoteEvent(s)));
        } catch (t) {
          (D(aG, "Failed to raise snapshot:", t), await a7(e, t));
        }
    }
    async function a7(e, t, r) {
      ...
      (e.da.add(1),
        ...
        e.asyncQueue.enqueueRetryable(async () => {
          (D(aG, "Retrying IndexedDB access"),
            await r(),
            e.da.delete(1),
            await aW(e));
        }));
    ...
    function a9(e, t) {
      return t().catch((r) => a7(e, r, t));
    }
    async function oe(e) {
      var t;
      let r = oh(e),
        n = e.Ta.length > 0 ? e.Ta[e.Ta.length - 1].batchId : -1;
      for (; a6((t = e)) && t.Ta.length < 10; )
        try {
    ...
    function ot(e) {
      return a6(e) && !oh(e).x_() && e.Ta.length > 0;
    }
    function or(e) {
      oh(e).start();
    }
    ...
    async function oi(e) {
      let t = oh(e);
      for (let r of e.Ta) t.ea(r.mutations);
    }
    async function os(e, t, r) {
      let n = e.Ta.shift(),
        i = nJ.from(n, t, r);
      (await a9(e, () => e.remoteSyncer.applySuccessfulWrite(i)), await oe(e));
    }
    async function oa(e, t) {
      (t &&
        ...
        (await (async function (e, t) {
          var r;
          if (nZ((r = t.code)) && r !== V.ABORTED) {
            let r = e.Ta.shift();
            (oh(e).B_(),
              await a9(e, () => e.remoteSyncer.rejectFailedWrite(r.batchId, t)),
              await oe(e));
          }
        })(e, t)),
        ot(e) && or(e));
    ...
    async function oo(e, t) {
      (e.asyncQueue.verifyOperationInProgress(),
        D(aG, "RemoteStore received new credentials"));
      let r = a6(e);
      (e.da.add(3),
        await aQ(e),
        r && e.ga.set("Unknown"),
    ...
    async function ol(e, t) {
      t
        ? (e.da.delete(2), await aW(e))
        : t || (e.da.add(2), await aQ(e), e.ga.set("Unknown"));
    }
    function ou(e) {
      var t, r, n;
      return (
        e.ya ||
          ...
          e.ma.push(async (t) => {
            t
              ? (e.ya.B_(), a2(e) ? a1(e) : e.ga.set("Unknown"))
              : (await e.ya.stop(), (e.pa = void 0));
          })),
        e.ya
      );
    }
    ...
    class oc {
      ...
      static createAndSchedule(e, t, r, n, i) {
        let s = new oc(e, t, Date.now() + r, n, i);
        return (s.start(r), s);
      }
      start(e) {
      ...
      cancel(e) {
        null !== this.timerHandle &&
          ...
          this.deferred.reject(
            new F(V.CANCELLED, "Operation cancelled" + (e ? ": " + e : "")),
          ));
      }
      handleDelayElapsed() {
    ...
    function od(e, t) {
      if ((N("AsyncQueue", `${t}: ${e}`), eM(e)))
        return new F(V.UNAVAILABLE, `${t}: ${e}`);
      throw e;
    }
    class of {
      static emptySet(e) {
        return new of(e.comparator);
      }
      constructor(e) {
        ((this.comparator = e
          ? (t, r) => e(t, r) || ei.comparator(t.key, r.key)
          : (e, t) => ei.comparator(e.key, t.key)),
          (this.keyedMap = ng()),
          (this.sortedSet = new tK(this.comparator)));
      }
      has(e) {
      ...
      isEqual(e) {
        if (!(e instanceof of) || this.size !== e.size) return !1;
      ...
      track(e) {
        ...
        r
          ? 0 !== e.type && 3 === r.type
            ...
            : 3 === e.type && 1 !== r.type
              ? (this.Sa = this.Sa.insert(t, { type: r.type, doc: e.doc }))
              : 2 === e.type && 2 === r.type
                ? (this.Sa = this.Sa.insert(t, { type: 2, doc: e.doc }))
                : 2 === e.type && 0 === r.type
                  ? (this.Sa = this.Sa.insert(t, { type: 0, doc: e.doc }))
                  : 1 === e.type && 0 === r.type
                    ? (this.Sa = this.Sa.remove(t))
                    : 1 === e.type && 2 === r.type
                      ? (this.Sa = this.Sa.insert(t, { type: 1, doc: r.doc }))
                      : 0 === e.type && 1 === r.type
                        ? (this.Sa = this.Sa.insert(t, { type: 2, doc: e.doc }))
                        : P(63341, { Vt: e, ba: r })
          : (this.Sa = this.Sa.insert(t, e));
    ...
    class og {
      ...
      static fromInitialDocuments(e, t, r, n, i) {
        ...
        return (
          ...
          new og(e, t, of.emptySet(t), s, r, n, !0, !1, i)
        );
      }
      get hasPendingWrites() {
    ...
    class oy {
      ...
      terminate() {
        var e;
        let t;
        ((e = new F(V.ABORTED, "Firestore shutting down")),
          (t = this.queries),
          (this.queries = ov()),
          t.forEach((t, r) => {
            for (let t of r.va) t.onError(e);
          }));
      }
    }
    function ov() {
    ...
    async function ow(e, t) {
      let r = 3,
        n = t.query,
        i = e.queries.get(n);
      i ? !i.Fa() && t.Ma() && (r = 2) : ((i = new om()), (r = +!t.Ma()));
      try {
        switch (r) {
          case 0:
            i.Ca = await e.onListen(n, !0);
            break;
          case 1:
            i.Ca = await e.onListen(n, !1);
            break;
          case 2:
            await e.onFirstRemoteStoreListen(n);
        }
      } catch (r) {
        let e = od(r, `Initialization of query '${nl(t.query)}' failed`);
    ...
    async function ob(e, t) {
      let r = t.query,
        ...
        i = e.queries.get(r);
      if (i) {
        let e = i.va.indexOf(t);
        e >= 0 &&
          (i.va.splice(e, 1),
          0 === i.va.length ? (n = +!t.Ma()) : !i.Fa() && t.Ma() && (n = 2));
      }
      switch (n) {
        case 0:
    ...
    function oE(e, t, r) {
      ...
      if (n) for (let e of n.va) e.onError(r);
      e.queries.delete(t);
    }
    function o_(e) {
      e.xa.forEach((e) => {
    ...
    (((p = f || (f = {})).Ba = "default"), (p.Cache = "cache"));
    class oT {
      constructor(e, t, r) {
        ((this.query = e),
          (this.La = t),
      ...
      Na(e) {
        ...
        return (
          this.ka
            ? this.qa(e) && (this.La.next(e), (t = !0))
            : this.Ua(e, this.onlineState) && (this.$a(e), (t = !0)),
          (this.Ka = e),
          t
        );
      }
      ...
      Ua(e, t) {
        return (
          !(e.fromCache && this.Ma()) ||
          ((!this.options.Wa || "Offline" === t) &&
            (!e.docs.isEmpty() || e.hasCachedResults || "Offline" === t))
        );
      }
      qa(e) {
        if (e.docChanges.length > 0) return !0;
        let t = this.Ka && this.Ka.hasPendingWrites !== e.hasPendingWrites;
        return (
      ...
      Ma() {
        return this.options.source !== f.Cache;
      }
    }
    class oS {
      constructor(e, t) {
    ...
    class oC {
      ...
      Ks(e) {
        return iI(this.serializer, e);
      }
      qs(e) {
        return e.metadata.exists
          ? iA(this.serializer, e.document, !1)
          : rN.newNoDocument(
              this.Ks(e.metadata.name),
    ...
    class oA {
      ...
      Ha(e) {
        ...
        if (e.Qa.namedQuery) this.ja.push(e.Qa.namedQuery);
          ...
          let r = et.fromString(e.Qa.documentMetadata.name);
          this.collectionGroups.add(r.get(r.length - 2));
        } else
          e.Qa.document &&
            ((this.Ja[this.Ja.length - 1].document = e.Qa.document), ++t);
        return t !== this.progress.documentsLoaded
          ? ((this.progress.documentsLoaded = t), { ...this.progress })
          : null;
      }
      Za(e) {
        let t = new Map(),
          r = new oC(this.serializer);
        for (let n of e)
          if (n.metadata.queries) {
            let e = r.Ks(n.metadata.name);
            for (let r of n.metadata.queries) {
              let n = (t.get(r) || nb()).add(e);
              t.set(r, n);
            }
          }
        return t;
      ...
      async Xa(e) {
        let t = await ao(e, new oC(this.serializer), this.Ja, this.za.id),
          r = this.Za(this.documents);
        for (let t of this.ja) await al(e, t, r.get(t.name));
        return (
          (this.progress.taskState = "Success"),
          { progress: this.progress, Ya: this.collectionGroups, eu: t }
        );
      }
    }
    function ok(e) {
    ...
    class oN {
      ...
      _u(e, t) {
            ...
            (u && h
              ? u.data.isEqual(h.data)
                ...
                : this.uu(u, h) ||
                  ...
                  (f = !0),
                  ((o && this.iu(h, o) > 0) || (l && 0 > this.iu(h, l))) &&
                    (a = !0))
              : !u && h
        ...
        return { su: s, au: r, bs: a, mutatedKeys: i };
      }
      uu(e, t) {
        return (
      ...
      applyChanges(e, t, r, n) {
        ...
        (s.sort((e, t) => {
          ...
          return (
            ...
            })(r) - i(n) || this.iu(e.doc, t.doc)
          );
        }),
          this.cu(r),
          (n = n ?? !1));
        let a = t && !n ? this.lu() : [],
          o = 0 === this.ru.size && this.current && !n ? 1 : 0,
          l = o !== this.nu;
        return ((this.nu = o), 0 !== s.length || l)
          ? {
              snapshot: new og(
                this.query,
                e.su,
      ...
      Pu(e) {
        return (
          !this.tu.has(e) &&
          !!this.su.has(e) &&
          !this.su.get(e).hasLocalMutations
        );
      }
      cu(e) {
        e &&
          (e.addedDocuments.forEach((e) => (this.tu = this.tu.add(e))),
          e.modifiedDocuments.forEach((e) => {}),
          e.removedDocuments.forEach((e) => (this.tu = this.tu.delete(e))),
      ...
      lu() {
        ...
        return (
          e.forEach((e) => {
            this.ru.has(e) || t.push(new oD(e));
          }),
          this.ru.forEach((r) => {
            e.has(r) || t.push(new ox(r));
          }),
          t
        );
      }
      Tu(e) {
        ((this.tu = e.ks), (this.ru = nb()));
        let t = this._u(e.documents);
        return this.applyChanges(t, !0);
      }
      Iu() {
        return og.fromInitialDocuments(
          this.query,
          this.su,
          this.mutatedKeys,
          0 === this.nu,
    ...
    class oL {
      constructor(e, t, r, n, i, s) {
        ((this.localStore = e),
          ...
          (this.Ru = {}),
          (this.Au = new nd((e) => no(e), na)),
          (this.Vu = new Map()),
          (this.du = new Set()),
          (this.mu = new tK(ei.comparator)),
          (this.fu = new Map()),
          (this.gu = new sj()),
          (this.pu = {}),
          (this.yu = new Map()),
    ...
    async function oF(e, t, r, n) {
      let i,
        s = await at(e.localStore, nt(t)),
        a = s.targetId,
        o = e.sharedClientState.addLocalQueryTarget(a, r);
      return (
        n && (i = await oU(e, t, a, "current" === o, s.resumeToken)),
        e.isPrimaryClient && r && aY(e.remoteStore, s),
        i
      );
    }
    async function oU(e, t, r, n, i) {
      e.bu = (t, r, n) =>
        (async function (e, t, r, n) {
          let i = t.view._u(r);
          i.bs &&
            (i = await an(e.localStore, t.query, !1).then(({ documents: e }) =>
              t.view._u(e, i),
            ));
          ...
          return (oX(e, t.targetId, o.hu), o.snapshot);
        })(e, t, r, n);
      let s = await an(e.localStore, t, !0),
        a = new oN(t, s.ks),
        o = a._u(s.documents),
        l = n9.createSynthesizedTargetChangeForCurrentChange(
          r,
      ...
      return (
        e.Au.set(t, h),
        e.Vu.has(r) ? e.Vu.get(r).push(t) : e.Vu.set(r, [t]),
        u.snapshot
      );
    }
    async function oB(e, t, r) {
      let n = e.Au.get(t),
        i = e.Vu.get(n.targetId);
      i.length > 1
        ? (e.Vu.set(
            n.targetId,
            i.filter((e) => !na(e, t)),
        ...
        : e.isPrimaryClient
          ? (e.sharedClientState.removeLocalQueryTarget(n.targetId),
            e.sharedClientState.isActiveQueryTarget(n.targetId) ||
              (await ar(e.localStore, n.targetId, !1)
                .then(() => {
                  (e.sharedClientState.clearQueryState(n.targetId),
                    r && aX(e.remoteStore, n.targetId),
                    oJ(e, n.targetId));
                })
                .catch(ek)))
          : (oJ(e, n.targetId), await ar(e.localStore, n.targetId, !0));
    }
    async function oj(e, t) {
      let r = e.Au.get(t),
        n = e.Vu.get(r.targetId);
      e.isPrimaryClient &&
        1 === n.length &&
        (e.sharedClientState.removeLocalQueryTarget(r.targetId),
        aX(e.remoteStore, r.targetId));
    }
    async function oq(e, t, r) {
      let n = ln(e);
      try {
        var i, s;
        let e,
          ...
          l,
          u,
          h = await ((i = n.localStore),
          (o = ep.now()),
          (l = t.reduce((e, t) => e.add(t.key), nb())),
          i.persistence
            .runTransaction("Locally write mutations", "readwrite", (r) => {
              ...
              return i.xs
                ...
                .next((e) => {
                  (n = e).forEach((e, t) => {
                    t.isValidDocument() || (s = s.add(e));
                  });
                })
                .next(() => i.localDocuments.getOverlayedDocuments(r, n))
                .next((n) => {
                  e = n;
                  let s = [];
                  for (let r of t) {
                    let t = (function (e, t) {
                      ...
                      for (let n of e.fieldTransforms) {
                        let e = t.data.field(n.field),
                          i = nS(n.transform, e || null);
                        null != i &&
                          (null === r && (r = rD.empty()), r.set(n.field, i));
                      }
                      return r || null;
                ...
                .next((t) => {
                  a = t;
                  let n = t.applyToLocalDocumentSet(e, s);
                  return i.documentOverlayCache.saveOverlays(r, t.batchId, n);
                });
            })
            .then(() => ({ batchId: a.batchId, changes: nm(e) })));
        (n.sharedClientState.addPendingMutation(h.batchId),
          (s = h.batchId),
          (u = n.pu[n.currentUser.toKey()]) || (u = new tK(Q)),
          (u = u.insert(s, r)),
          (n.pu[n.currentUser.toKey()] = u),
          await o0(n, h.changes),
          await oe(n.remoteStore));
      } catch (t) {
        let e = od(t, "Failed to persist write");
        r.reject(e);
      }
    }
    async function oz(e, t) {
      try {
        ...
        let i,
          s,
          a = await ((r = e.localStore),
          (i = (n = t).snapshotVersion),
          (s = r.vs),
          r.persistence
            .runTransaction("Apply remote event", "readwrite-primary", (e) => {
              let t = r.xs.newChangeBuffer({ trackRemovals: !0 });
              s = r.vs;
              let a = [];
              n.targetChanges.forEach((t, o) => {
                var l;
                let u = s.get(o);
                if (!u) return;
                a.push(
                  r.li
                    .removeMatchingKeys(e, t.removedDocuments, o)
                    .next(() => r.li.addMatchingKeys(e, t.addedDocuments, o)),
                );
                let h = u.withSequenceNumber(e.currentSequenceNumber);
                (null !== n.targetMismatches.get(o)
                  ? (h = h
                      .withResumeToken(tZ.EMPTY_BYTE_STRING, eg.min())
                      .withLastLimboFreeSnapshotVersion(eg.min()))
                  : t.resumeToken.approximateByteSize() > 0 &&
                    (h = h.withResumeToken(t.resumeToken, i)),
                  (s = s.insert(o, h)),
                  (l = h),
                  (0 === u.resumeToken.approximateByteSize() ||
                    ...
                    t.addedDocuments.size +
                      ...
                      t.removedDocuments.size >
                      0) &&
                    a.push(r.li.updateTargetData(e, h)));
              });
              let o = nf,
                l = nb();
              if (
                (n.documentUpdates.forEach((t) => {
                  n.resolvedLimboDocuments.has(t) &&
                    a.push(
                      r.persistence.referenceDelegate.updateLimboDocument(e, t),
                    );
                }),
                a.push(
                  ae(e, t, n.documentUpdates).next((e) => {
                    ((o = e.Bs), (l = e.Ls));
                  }),
                ),
                !i.isEqual(eg.min()))
                ...
                let t = r.li
                  .getLastRemoteSnapshotVersion(e)
                  .next((t) =>
                    r.li.setTargetsMetadata(e, e.currentSequenceNumber, i),
                  );
                a.push(t);
              }
              return ex
                .waitFor(a)
                .next(() => t.apply(e))
                .next(() => r.localDocuments.getLocalViewOfDocuments(e, o, l))
                .next(() => o);
            })
            .then((e) => ((r.vs = s), e)));
        (t.targetChanges.forEach((t, r) => {
          ...
          n &&
            ...
            t.addedDocuments.size > 0
              ...
              : t.modifiedDocuments.size > 0
                ? M(n.Eu, 14607)
                : t.removedDocuments.size > 0 && (M(n.Eu, 42227), (n.Eu = !1)));
        }),
          await o0(e, a, t));
      } catch (e) {
        await ek(e);
    ...
    async function oK(e, t, r) {
      ...
      let n = e.fu.get(t),
        i = n && n.key;
      if (i) {
        let r = new tK(ei.comparator);
        r = r.insert(i, rN.newNoDocument(i, eg.min()));
        let n = nb().add(i),
          s = new n7(eg.min(), new Map(), new tK(Q), r, n);
        (await oz(e, s), (e.mu = e.mu.remove(i)), e.fu.delete(t), oZ(e));
      } else
        await ar(e.localStore, t, !1)
          .then(() => oJ(e, t, r))
          .catch(ek);
    }
        ...
        n.persistence.runTransaction(
          ...
          (e) => {
            let t,
              ...
              s,
              a = i.batch.keys(),
              o = n.xs.newChangeBuffer({ trackRemovals: !0 });
            return ((r = (t = i.batch).keys()),
            (s = ex.resolve()),
            r.forEach((r) => {
              s = s
                .next(() => o.getEntry(e, r))
                .next((e) => {
                  let n = i.docVersions.get(r);
                  (M(null !== n, 48541),
                    0 > e.version.compareTo(n) &&
                      (t.applyToRemoteDocument(e, i),
                      e.isValidDocument() &&
                        (e.setReadTime(i.commitVersion), o.addEntry(e))));
                });
            }),
            s.next(() => n.mutationQueue.removeMutationBatch(e, t)))
              .next(() => o.apply(e))
              ...
              .next(() => n.localDocuments.getDocuments(e, a));
          },
        ));
        (oQ(e, r, null),
          oW(e, r),
    ...
    function oQ(e, t, r) {
      let n = e.pu[e.currentUser.toKey()];
      if (n) {
        let i = n.get(t);
        (i && (r ? i.reject(r) : i.resolve(), (n = n.remove(t))),
          (e.pu[e.currentUser.toKey()] = n));
      }
    }
    function oJ(e, t, r = null) {
      for (let n of (e.sharedClientState.removeLocalQueryTarget(t),
      e.Vu.get(t)))
        (e.Au.delete(n), r && e.Ru.Du(n, r));
      (e.Vu.delete(t),
        e.isPrimaryClient &&
          e.gu.Gr(t).forEach((t) => {
            e.gu.containsKey(t) || oY(e, t);
          }));
    }
    function oY(e, t) {
      ...
      let r = e.mu.get(t);
      null !== r &&
        (aX(e.remoteStore, r), (e.mu = e.mu.remove(t)), e.fu.delete(r), oZ(e));
    }
    function oX(e, t, r) {
      for (let n of r)
        n instanceof ox
          ? (e.gu.addReference(n.key, t),
            (function (e, t) {
              let r = t.key,
                n = r.path.canonicalString();
              e.mu.get(r) ||
                e.du.has(n) ||
                (D(oR, "New document in limbo: " + r), e.du.add(n), oZ(e));
            })(e, n))
          : n instanceof oD
            ? (D(oR, "Document no longer in limbo: " + n.key),
              e.gu.removeReference(n.key, t),
              e.gu.containsKey(n.key) || oY(e, n.key))
            : P(19791, { Cu: n });
    }
    function oZ(e) {
      for (; e.du.size > 0 && e.mu.size < e.maxConcurrentLimboResolutions; ) {
        let t = e.du.values().next().value;
        e.du.delete(t);
        let r = new ei(et.fromString(t)),
          n = e.wu.next();
        (e.fu.set(n, new oP(r)),
          (e.mu = e.mu.insert(r, n)),
          aY(
            e.remoteStore,
            new iV(nt(r8(r.path)), n, "TargetPurposeLimboResolution", e$.ce),
          ));
      }
    }
      ...
      e.Au.isEmpty() ||
          ...
          s.push(
            e.bu(o, t, r).then((t) => {
              if ((t || r) && e.isPrimaryClient) {
                let n = t
                  ? !t.fromCache
                  : r?.targetChanges.get(o.targetId)?.current;
        ...
        await (async function (e, t) {
          try {
            ...
            if (!eM(e)) throw e;
            D(s4, "Failed to update sequence numbers: " + e);
          }
          for (let r of t) {
            let t = r.targetId;
            if (!r.fromCache) {
    ...
    async function o1(e, t) {
      if (!e.currentUser.isEqual(t)) {
        D(oR, "User change. New user:", t.toKey());
        let r = await s7(e.localStore, t);
        ((e.currentUser = t),
          e.yu.forEach((e) => {
            e.forEach((e) => {
              e.reject(
    ...
    function o2(e, t) {
      ...
      if (r && r.Eu) return nb().add(r.key);
      {
        ...
        for (let t of n) {
          let n = e.Au.get(t);
          r = r.unionWith(n.view.ou);
        }
        return r;
      }
    }
    async function o6(e, t) {
      let r = await an(e.localStore, t.query, !0),
        n = t.view.Tu(r);
      return (e.isPrimaryClient && oX(e, t.targetId, n.hu), n);
    }
    async function o5(e, t) {
      return as(e.localStore, t).then((t) => o0(e, t));
    }
    async function o3(e, t, r, n) {
      var i, s;
      let a,
        ...
        i.persistence.runTransaction(
          ...
          (e) =>
            a
              .Xn(e, t)
              .next((t) =>
                t ? i.localDocuments.getDocuments(e, t) : ex.resolve(null),
              ),
        ));
      null !== o
        ? ("pending" === r
            ? await oe(e.remoteStore)
            : "acknowledged" === r || "rejected" === r
              ? (oQ(e, t, n || null),
                oW(e, t),
                (s = e.localStore),
                s.mutationQueue.nr(t))
              : P(6720, "Unknown batchState", { vu: r }),
          await o0(e, o))
        : D(oR, "Cannot apply mutation batch with id: " + t);
    }
    async function o4(e, t) {
      if ((lr(e), ln(e), !0 === t && !0 !== e.Su)) {
        let t = e.sharedClientState.getAllActiveQueryTargets(),
          r = await o8(e, t.toArray());
        for (let t of ((e.Su = !0), await ol(e.remoteStore, !0), r))
          aY(e.remoteStore, t);
      } else if (!1 === t && !1 !== e.Su) {
        let t = [],
          r = Promise.resolve();
        (e.Vu.forEach((n, i) => {
          (e.sharedClientState.isLocalQueryTarget(i)
            ? t.push(i)
            : (r = r.then(() => (oJ(e, i), ar(e.localStore, i, !0)))),
            aX(e.remoteStore, i));
        }),
          await r,
          await o8(e, t),
          ...
          e.gu.zr(),
          (e.fu = new Map()),
          (e.mu = new tK(ei.comparator)),
          (e.Su = !1),
          await ol(e.remoteStore, !1));
      }
    }
    async function o8(e, t, r) {
      let n = [],
        i = [];
      for (let r of t) {
        let t,
          s = e.Vu.get(r);
        if (s && 0 !== s.length)
          for (let r of ((t = await at(e.localStore, nt(s[0]))), s)) {
            let t = e.Au.get(r),
              n = await o6(e, t);
            n.snapshot && i.push(n.snapshot);
          }
        else {
          let n = await ai(e.localStore, r);
          ((t = await at(e.localStore, n)),
            await oU(e, o7(n), r, !1, t.resumeToken));
        }
        n.push(t);
      }
      return (e.Ru.H_(i), n);
    ...
    function o7(e) {
      ...
      return (
        ...
        (i = e.filters),
        (s = e.limit),
        new r4(t, r, n, i, s, "F", e.startAt, e.endAt)
      );
    }
    function o9(e) {
      return e.localStore.persistence.hs();
    }
    async function le(e, t, r, n) {
      if (e.Su)
        return void D(oR, "Ignoring unexpected query state notification.");
      let i = e.Vu.get(t);
      if (i && i.length > 0)
        switch (r) {
          case "current":
          case "not-current": {
            let n = await as(e.localStore, nh(i[0])),
              s = n7.createSynthesizedRemoteEventForCurrentChange(
                t,
                "current" === r,
                tZ.EMPTY_BYTE_STRING,
              );
            await o0(e, n, s);
            break;
          }
          case "rejected":
            (await ar(e.localStore, t, !0), oJ(e, t, n));
            break;
          default:
            P(64155, r);
        }
    ...
    async function lt(e, t, r) {
      ...
      if (n.Su) {
        for (let e of t) {
          if (n.Vu.has(e) && n.sharedClientState.isActiveQueryTarget(e)) {
            D(oR, "Adding an already active target " + e);
            continue;
          }
          let t = await ai(n.localStore, e),
            r = await at(n.localStore, t);
          (await oU(n, o7(t), r.targetId, !1, r.resumeToken),
            aY(n.remoteStore, r));
        }
        for (let e of r)
          n.Vu.has(e) &&
            (await ar(n.localStore, e, !1)
              .then(() => {
                (aX(n.remoteStore, e), oJ(n, e));
              })
              .catch(ek));
      }
    }
    function lr(e) {
      return (
        (e.remoteStore.remoteSyncer.applyRemoteEvent = oz.bind(null, e)),
        (e.remoteStore.remoteSyncer.getRemoteKeysForTarget = o2.bind(null, e)),
        (e.remoteStore.remoteSyncer.rejectListen = oK.bind(null, e)),
        (e.Ru.H_ = oI.bind(null, e.eventManager)),
        (e.Ru.Du = oE.bind(null, e.eventManager)),
        e
      );
    }
    function ln(e) {
      return (
        (e.remoteStore.remoteSyncer.applySuccessfulWrite = oG.bind(null, e)),
        (e.remoteStore.remoteSyncer.rejectFailedWrite = oH.bind(null, e)),
        e
      );
    }
    class li {
      ...
      async initialize(e) {
        ((this.serializer = aV(e.databaseInfo.databaseId)),
          (this.sharedClientState = this.Mu(e)),
          (this.persistence = this.xu(e)),
          await this.persistence.start(),
          (this.localStore = this.Ou(e)),
          (this.gcScheduler = this.Nu(e, this.localStore)),
      ...
      Ou(e) {
        ...
        return (
          (t = this.persistence),
          (r = new s3()),
          new s8(t, r, e.initialUser, this.serializer)
        );
      }
      xu(e) {
        return new sH(sQ.Vi, this.serializer);
      }
      Mu(e) {
        return new aE();
      }
    ...
    class ls extends li {
      ...
      Nu(e, t) {
        return (
          M(this.persistence.referenceDelegate instanceof sJ, 46915),
          new sC(
      ...
      xu(e) {
        let t =
          void 0 !== this.cacheSizeBytes
            ? sp.withCacheSize(this.cacheSizeBytes)
            : sp.DEFAULT;
        return new sH((e) => sJ.Vi(e, t), this.serializer);
      }
    }
    class la extends li {
      constructor(e, t, r) {
      ...
      async initialize(e) {
        (await super.initialize(e),
          await this.Lu.initialize(this, e),
          await ln(this.Lu.syncEngine),
          await oe(this.Lu.remoteStore),
          await this.persistence.zi(
            () => (
              this.gcScheduler &&
      ...
      Bu(e, t) {
        let r = new ez(t, this.persistence);
        return new eq(e.asyncQueue, r);
      }
      xu(e) {
        let t = s2(e.databaseInfo.databaseId, e.databaseInfo.persistenceKey),
          r =
            void 0 !== this.cacheSizeBytes
              ? sp.withCacheSize(this.cacheSizeBytes)
              : sp.DEFAULT;
    ...
    class lo {
      async initialize(e, t) {
        this.localStore ||
          ...
          (this.sharedClientState.onlineStateHandler = (e) =>
            o$(this.syncEngine, e, 1)),
          (this.remoteStore.remoteSyncer.handleCredentialChange = o1.bind(
            null,
            this.syncEngine,
          )),
          await ol(this.remoteStore, this.syncEngine.isPrimaryClient));
      }
      ...
      createDatastore(e) {
        var t;
        let r = aV(e.databaseInfo.databaseId),
          n = new aP(e.databaseInfo);
        return (
          (t = e.authCredentials),
          new a$(t, e.appCheckCredentials, n, r)
        );
      }
      createRemoteStore(e) {
        var t, r;
      ...
      async terminate() {
        (await (async function (e) {
          (D(aG, "RemoteStore shutting down."),
            e.da.add(5),
            await aQ(e),
            e.fa.shutdown(),
            e.ga.set("Unknown"));
    ...
    function ll(e, t = 10240) {
      let r = 0;
      return {
        async read() {
          if (r < e.byteLength) {
            let n = { value: e.slice(r, r + t), done: !1 };
            return ((r += t), n);
          }
          return { done: !0 };
        },
    ...
    class lu {
      ...
      error(e) {
        this.muted ||
          (this.observer.error
            ? this.ku(this.observer.error, e)
            : N("Uncaught Error in snapshot listener:", e.toString()));
      }
      Ku() {
        this.muted = !0;
      }
    ...
    class lh {
      ...
      async $u() {
        let e = await this.Wu();
        if (null === e) return null;
        let t = this.Uu.decode(e),
          r = Number(t);
        return (
          isNaN(r) && this.Qu(`length string (${t}) is not valid number`),
          new oS(JSON.parse(await this.Gu(r)), e.length + r)
        );
      }
      zu() {
      ...
      async Gu(e) {
        ...
        let t = this.Uu.decode(this.buffer.slice(0, e));
        return ((this.buffer = this.buffer.slice(e)), t);
      }
      Qu(e) {
        throw (this.qu.cancel(), Error(`Invalid bundle format: ${e}`));
      }
      async ju() {
        let e = await this.qu.read();
        if (!e.done) {
    ...
    class lc {
      constructor(e, t) {
        ...
        let r = this.Fu();
        if (!r || !r.Ga())
          throw Error(`The first element of the bundle is not a metadata object, it is
         ${JSON.stringify(r?.Qa)}`);
        this.metadata = r;
        do null !== (r = this.Fu()) && this.elements.push(r);
        while (null !== r);
      }
      getMetadata() {
      ...
      Fu() {
        ...
        let e = this.Wu();
        return new oS(JSON.parse(this.Gu(e)), e);
      }
      Gu(e) {
      ...
      Wu() {
        ...
        for (; t < this.bundleData.length; ) {
          if ("{" === this.bundleData[t]) {
            if (t === e)
              throw Error("First character is a bracket and not a number");
            return ((this.cursor = t), Number(this.bundleData.slice(e, t)));
          }
          t++;
        }
        throw Error("Reached the end of bundle when more is expected.");
      }
    }
    class ld {
      constructor(e) {
      ...
      async lookup(e) {
        if ((this.ensureCommitNotCalled(), this.mutations.length > 0))
          throw (
            (this.lastTransactionError = new F(
              V.INVALID_ARGUMENT,
        ...
        let t = await (async function (e, t) {
          let r = { documents: t.map((t) => ib(e.serializer, t)) },
            n = await e.jo(
              "BatchGetDocuments",
              ...
              h =
                ...
                "found" in t
                  ? (M(!!t.found, 43571),
                    ...
                    t.found.updateTime,
                    (n = iI(r, t.found.name)),
                    (s = im(t.found.updateTime)),
                    (a = t.found.createTime
                      ? im(t.found.createTime)
                      : eg.min()),
                    (o = new rD({ mapValue: { fields: t.found.fields } })),
                    rN.newFoundDocument(n, s, a, o))
                  : "missing" in t
                    ? (M(!!t.missing, 3894),
                      M(!!t.readTime, 22933),
                      (l = iI(r, t.missing)),
                      (u = im(t.readTime)),
                      rN.newNoDocument(l, u))
                    : P(7234, { result: t }));
            i.set(h.key.toString(), h);
          });
          let s = [];
          return (
            t.forEach((e) => {
              let t = i.get(e.toString());
              (M(!!t, 55234, { key: e }), s.push(t));
            }),
            s
          );
        })(this.datastore, e);
      ...
      delete(e) {
        (this.write(new nH(e, this.precondition(e))),
          this.writtenDocs.add(e.toString()));
      }
      async commit() {
        ...
        (this.mutations.forEach((t) => {
          ...
          e.forEach((e, t) => {
            let r = ei.fromPath(t);
            this.mutations.push(new nW(r, this.precondition(r)));
          }),
          await (async function (e, t) {
            let r = { writes: t.map((t) => ik(e.serializer, t)) };
            await e.Wo("Commit", e.serializer.databaseId, et.emptyPath(), r);
      ...
      recordVersion(e) {
        ...
        if (e.isFoundDocument()) t = e.version;
          ...
          if (!e.isNoDocument()) throw P(50498, { Hu: e.constructor.name });
          t = eg.min();
        }
    ...
    class lf {
      constructor(e, t, r, n, i) {
        ((this.asyncQueue = e),
          ...
          (this.deferred = i),
          (this.Zu = r.maxAttempts),
          (this.M_ = new aF(this.asyncQueue, "transaction_retry")));
      }
      Xu() {
        ((this.Zu -= 1), this.Yu());
      }
    ...
    class lg {
      constructor(e, t, r, n, i) {
        ((this.authCredentials = e),
          (this.appCheckCredentials = t),
          (this.asyncQueue = r),
          (this._databaseInfo = n),
          (this.user = S.UNAUTHENTICATED),
          (this.clientId = W.newId()),
          (this.authCredentialListener = () => Promise.resolve()),
          (this.appCheckCredentialListener = () => Promise.resolve()),
          (this._uninitializedComponentsProvider = i),
          this.authCredentials.start(r, async (e) => {
            (D(lp, "Received user=", e.uid),
          ...
          this.appCheckCredentials.start(
            r,
            (e) => (
              D(lp, "Received new app check token=", e),
        ...
        return (
          this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async () => {
            try {
              ...
              let t = od(r, "Failed to shutdown persistence");
              e.reject(t);
            }
          }),
          e.promise
    ...
    async function lm(e, t) {
      (e.asyncQueue.verifyOperationInProgress(),
        D(lp, "Initializing OfflineComponentProvider"));
      let r = e.configuration;
      await t.initialize(r);
      let n = r.initialUser;
      (e.setCredentialChangeListener(async (e) => {
        n.isEqual(e) || (await s7(t.localStore, e), (n = e));
      }),
    ...
    async function ly(e, t) {
      e.asyncQueue.verifyOperationInProgress();
      let r = await lv(e);
      (D(lp, "Initializing OnlineComponentProvider"),
        await t.initialize(r, e.configuration),
        e.setCredentialChangeListener((e) => oo(t.remoteStore, e)),
        e.setAppCheckTokenChangeListener((e, r) => oo(t.remoteStore, r)),
        (e._onlineComponents = t));
    }
    async function lv(e) {
      if (!e._offlineComponents)
        if (e._uninitializedComponentsProvider) {
          D(lp, "Using user provided OfflineComponentProvider");
          try {
            await lm(e, e._uninitializedComponentsProvider._offline);
          } catch (t) {
            if (
          ...
          (D(lp, "Using default OfflineComponentProvider"),
            await lm(e, new ls(void 0)));
      ...
      return (
        e._onlineComponents ||
          (e._uninitializedComponentsProvider
            ? (D(lp, "Using user provided OnlineComponentProvider"),
              await ly(e, e._uninitializedComponentsProvider._online))
            : (D(lp, "Using default OnlineComponentProvider"),
              await ly(e, new lo()))),
        e._onlineComponents
      );
    }
    function lb(e) {
      return lv(e).then((e) => e.localStore);
    }
    function lI(e) {
      return lw(e).then((e) => e.syncEngine);
    }
    function lE(e) {
      return lw(e).then((e) => e.datastore);
    }
    async function l_(e) {
      let t = await lw(e),
        r = t.eventManager;
      return (
        (r.onListen = oM.bind(null, t.syncEngine)),
        (r.onUnlisten = oB.bind(null, t.syncEngine)),
        (r.onFirstRemoteStoreListen = oV.bind(null, t.syncEngine)),
        (r.onLastRemoteStoreUnlisten = oj.bind(null, t.syncEngine)),
        r
      );
    }
    function lT(e, t, r, n) {
      let i = new lu(n),
        s = new oT(t, i, r);
      return (
        e.asyncQueue.enqueueAndForget(async () => ow(await l_(e), s)),
        () => {
          (i.Ku(),
            e.asyncQueue.enqueueAndForget(async () => ob(await l_(e), s)));
        }
      );
    }
    function lS(e, t, r = {}) {
      ...
      return (
        e.asyncQueue.enqueueAndForget(async () => {
          ...
          return (
            ...
            (a = new lu({
              next: (e) => {
                (a.Ku(), s.enqueueAndForget(() => ob(i, o)));
                let l = e.docs.has(t);
                !l && e.fromCache
                  ? n.reject(
                      new F(
    ...
    function lA(e, t) {
      let r = new U();
      return (
        e.asyncQueue.enqueueAndForget(async () => oq(await lI(e), t, r)),
        r.promise
      );
    }
    function lk(e) {
    ...
    class lN {
      constructor(e) {
        if (void 0 === e.host) {
          ...
          ((this.host = lD), (this.ssl = !0));
        } else ((this.host = e.host), (this.ssl = e.ssl ?? !0));
        if (
          ...
          this.experimentalForceLongPolling
            ...
            : void 0 === e.experimentalAutoDetectLongPolling
              ...
              : (this.experimentalAutoDetectLongPolling =
                  !!e.experimentalAutoDetectLongPolling),
          (this.experimentalLongPollingOptions = lk(
    ...
    function lO(e, t, r, n = {}) {
      e = eh(e, lR);
      let i = (0, w.isCloudWorkstation)(t),
        s = e._getSettings(),
        a = { ...s, emulatorOptions: e._getEmulatorOptions() },
        o = `${t}:${r}`;
      (i && (0, w.pingServer)(`https://${o}`),
        s.host !== lD &&
          s.host !== o &&
          R(
            "Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.",
          ));
      let l = { ...s, host: o, ssl: i, emulatorOptions: n };
      if (!(0, w.deepEqual)(l, a) && (e._setSettings(l), n.mockUserToken)) {
        let t, r;
        if ("string" == typeof n.mockUserToken)
          ((t = n.mockUserToken), (r = S.MOCK_USER));
        else {
          t = (0, w.createMockUserToken)(
            n.mockUserToken,
            e._app?.options.projectId,
          );
          let i = n.mockUserToken.sub || n.mockUserToken.user_id;
          if (!i)
            throw new F(
              V.INVALID_ARGUMENT,
        ...
        e._authCredentials = new q(new B(t, r));
      }
    }
    class lP {
      constructor(e, t, r) {
      ...
      withConverter(e) {
        return new lP(this.firestore, e, this._query);
      }
    }
    class lL {
      constructor(e, t, r) {
      ...
      get parent() {
        return new lM(this.firestore, this.converter, this._key.path.popLast());
      }
      withConverter(e) {
      ...
      toJSON() {
        return {
          type: lL._jsonSchemaVersion,
          referencePath: this._key.toString(),
        };
      }
      static fromJSON(e, t, r) {
        if (ef(t, lL._jsonSchema))
          return new lL(e, r || null, new ei(et.fromString(t.referencePath)));
      }
    }
    ((lL._jsonSchemaVersion = "firestore/documentReference/1.0"),
      (lL._jsonSchema = {
        type: ed("string", lL._jsonSchemaVersion),
        referencePath: ed("string"),
      }));
    class lM extends lP {
      constructor(e, t, r) {
        (super(e, t, r8(r)), (this._path = r), (this.type = "collection"));
      }
      get id() {
      ...
      get parent() {
        ...
        return e.isEmpty() ? null : new lL(this.firestore, null, new ei(e));
      }
      withConverter(e) {
        return new lM(this.firestore, e, this._path);
      }
    }
    function lV(e, t, ...r) {
      if (
        ((e = (0, w.getModularInstance)(e)),
        1 == arguments.length && (t = W.newId()),
        es("doc", "path", t),
        e instanceof lR)
      ) {
        let n = et.fromString(t, ...r);
        return (ea(n), new lL(e, null, new ei(n)));
      }
      {
        if (!(e instanceof lL || e instanceof lM))
          throw new F(
            V.INVALID_ARGUMENT,
            "Expected first argument to doc() to be a CollectionReference, a DocumentReference or FirebaseFirestore",
          );
        let n = e._path.child(et.fromString(t, ...r));
        return (
          ea(n),
          new lL(e.firestore, e instanceof lM ? e.converter : null, new ei(n))
        );
      }
    }
    let lF = "AsyncQueue";
    class lU {
      constructor(e = Promise.resolve()) {
        ((this.rc = []),
          ...
          (this.uc = !1),
          (this.cc = []),
          (this.M_ = new aF(this, "async_queue_retry")),
          (this.lc = () => {
            let e = aM();
            (e && D(lF, "Visibility state changed to " + e.visibilityState),
              this.M_.w_());
          }),
          (this.hc = e));
        const t = aM();
        t &&
          ...
          t.addEventListener("visibilitychange", this.lc);
      }
      get isShuttingDown() {
        return this.sc;
      }
      ...
      enterRestrictedMode(e) {
        if (!this.sc) {
          ...
          t &&
            ...
            t.removeEventListener("visibilitychange", this.lc);
        }
      }
      enqueue(e) {
      ...
      async Ic() {
        if (0 !== this.rc.length) {
          try {
            ...
            if (!eM(e)) throw e;
            D(lF, "Operation failed with retryable error: " + e);
          }
            ...
            e()
              .catch((e) => {
                throw (
                  (this._c = e),
                  (this.ac = !1),
                  N("INTERNAL UNHANDLED ERROR: ", lB(e)),
                  e
                );
              })
              .then((e) => ((this.ac = !1), e))
      ...
      enqueueAfterDelay(e, t, r) {
        ...
        let n = oc.createAndSchedule(this, e, t, r, (e) => this.Ec(e));
        return (this.oc.push(n), n);
      }
      Pc() {
        this._c && P(47125, { Rc: lB(this._c) });
      }
      ...
      Vc(e) {
        for (let t of this.oc) if (t.timerId === e) return !0;
        return !1;
      }
      dc(e) {
        return this.Ac().then(() => {
          for (let t of (this.oc.sort(
    ...
    class lj {
      constructor() {
        ((this._progressObserver = {}),
          (this._taskCompletionResolver = new U()),
          (this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
    ...
    class lq extends lR {
      constructor(e, t, r, n) {
        (super(e, t, r, n),
          (this.type = "firestore"),
          (this._queue = new lU()),
          (this._persistenceKey = n?.name || "[DEFAULT]"));
      }
      async _terminate() {
        if (this._firestoreClient) {
          let e = this._firestoreClient.terminate();
          ((this._queue = new lU(e)),
        ...
        e._firestoreClient ||
          (function (e) {
            ...
            let a,
              ...
              l =
                ((t = e._databaseId),
                (r = e._app?.options.appId || ""),
                (n = e._persistenceKey),
                (i = e._app?.options.apiKey),
                new rt(
                  t,
                  r,
                  n,
                  o.host,
                  o.ssl,
                  o.experimentalForceLongPolling,
                  o.experimentalAutoDetectLongPolling,
                  lk(o.experimentalLongPollingOptions),
                  o.useFetchStreams,
                  o.isUsingEmulator,
                  i,
                ));
            (e._componentsProvider ||
              (o.localCache?._offlineComponentProvider &&
                o.localCache?._onlineComponentProvider &&
                (e._componentsProvider = {
                  _offline: o.localCache._offlineComponentProvider,
                  _online: o.localCache._onlineComponentProvider,
                })),
              (e._firestoreClient = new lg(
                e._authCredentials,
                e._appCheckCredentials,
                e._queue,
                l,
                e._componentsProvider &&
                  ((s = e._componentsProvider),
                  (a = s?._online.build()),
                  { _offline: s?._offline.build(a), _online: a }),
              )));
          })(e),
        e._firestoreClient
      );
    ...
    class l$ {
      ...
      static fromBase64String(e) {
        try {
          return new l$(tZ.fromBase64String(e));
        } catch (e) {
          throw new F(
            V.INVALID_ARGUMENT,
      ...
      static fromUint8Array(e) {
        return new l$(tZ.fromUint8Array(e));
      }
      toBase64() {
      ...
      toJSON() {
        return { type: l$._jsonSchemaVersion, bytes: this.toBase64() };
      }
      static fromJSON(e) {
        if (ef(e, l$._jsonSchema)) return l$.fromBase64String(e.bytes);
      }
    }
    ((l$._jsonSchemaVersion = "firestore/bytes/1.0"),
      (l$._jsonSchema = {
        type: ed("string", l$._jsonSchemaVersion),
        bytes: ed("string"),
      }));
    class lK {
      constructor(...e) {
    ...
    class lH {
      ...
      toJSON() {
        return {
          ...
          type: lH._jsonSchemaVersion,
        };
      }
      static fromJSON(e) {
        if (ef(e, lH._jsonSchema)) return new lH(e.latitude, e.longitude);
      }
    }
    ((lH._jsonSchemaVersion = "firestore/geoPoint/1.0"),
      (lH._jsonSchema = {
        type: ed("string", lH._jsonSchemaVersion),
        latitude: ed("number"),
        longitude: ed("number"),
      }));
    class lW {
      ...
      toJSON() {
        return { type: lW._jsonSchemaVersion, vectorValues: this._values };
      }
      static fromJSON(e) {
        if (ef(e, lW._jsonSchema)) {
          if (
            Array.isArray(e.vectorValues) &&
            e.vectorValues.every((e) => "number" == typeof e)
          )
            return new lW(e.vectorValues);
          throw new F(
            V.INVALID_ARGUMENT,
    ...
    ((lW._jsonSchemaVersion = "firestore/vectorValue/1.0"),
      (lW._jsonSchema = {
        type: ed("string", lW._jsonSchemaVersion),
        vectorValues: ed("object"),
      }));
    let lQ = /^__.*__$/;
    class lJ {
      constructor(e, t, r) {
      ...
      toMutation(e, t) {
        return null !== this.fieldMask
          ? new nz(e, this.data, this.fieldMask, t, this.fieldTransforms)
          : new nq(e, this.data, t, this.fieldTransforms);
      }
    }
    class lY {
      constructor(e, t, r) {
      ...
      toMutation(e, t) {
        return new nz(e, this.data, this.fieldMask, t, this.fieldTransforms);
      }
    }
    function lX(e) {
      switch (e) {
    ...
    class lZ {
      ...
      yc(e) {
        let t = this.path?.child(e),
          r = this.i({ path: t, arrayElement: !1 });
        return (r.wc(e), r);
      }
      Sc(e) {
        let t = this.path?.child(e),
      ...
      fc() {
        if (this.path)
          for (let e = 0; e < this.path.length; e++) this.wc(this.path.get(e));
      }
      wc(e) {
        if (0 === e.length) throw this.Dc("Document fields must not be empty");
        if (lX(this.dataSource) && lQ.test(e))
    ...
    function l1(e) {
      let t = e._freezeSettings(),
        r = aV(e._databaseId);
      return new l0(e._databaseId, !!t.ignoreUndefinedProperties, r);
    }
    function l2(e, t, r, n, i, s = {}) {
      let a,
        o,
        l = e.V(s.merge || s.mergeFields ? 2 : 0, t, r, i);
      ut("Data must be an object, but it was:", l, n);
      let u = l9(n, l);
      if (s.merge) ((a = new tY(l.fieldMask)), (o = l.fieldTransforms));
    ...
    class l5 extends lG {
      ...
      _toFieldTransform(e) {
        let t = new lZ(
            {
              dataSource: 3,
              targetDoc: e.settings.targetDoc,
          ...
          r = new nA(this.vc.map((e) => l7(e, t)));
        return new nP(e.path, r);
      }
      isEqual(e) {
        return e instanceof l5 && (0, w.deepEqual)(this.vc, e.vc);
      }
    }
    function l3(e, t, r, n) {
      let i = e.V(1, t, r);
      ut("Data must be an object, but it was:", i, n);
      let s = [],
        a = rD.empty();
      return (
        tz(n, (e, n) => {
          let o = ui(t, e, r);
          n = (0, w.getModularInstance)(n);
          let l = i.Sc(o);
          if (n instanceof l6) s.push(o);
          else {
            let e = l7(n, l);
            null != e && (s.push(o), a.set(o, e));
          }
        }),
        new lY(a, new tY(s), i.fieldTransforms)
      );
    }
    function l4(e, t, r, n, i, s) {
      let a = e.V(1, t, r),
        o = [ur(t, n, r)],
        l = [i];
      if (s.length % 2 != 0)
      ...
      for (let e = o.length - 1; e >= 0; --e)
        if (!ua(u, o[e])) {
          let t = o[e],
            r = l[e];
          r = (0, w.getModularInstance)(r);
          let n = a.Sc(t);
          if (r instanceof l6) u.push(t);
          else {
            let e = l7(r, n);
            null != e && (u.push(t), h.set(t, e));
          }
        }
      return new lY(h, new tY(u), a.fieldTransforms);
    }
    function l8(e, t, r, n = !1) {
      return l7(r, e.V(n ? 4 : 3, t));
    }
    function l7(e, t) {
      if (ue((e = (0, w.getModularInstance)(e))))
        return (ut("Unsupported field value:", t, e), l9(e, t));
      if (e instanceof lG)
        return (
          (function (e, t) {
            if (!lX(t.dataSource))
      ...
      return (function (e, t) {
        var r, n, i;
        if (null === (e = (0, w.getModularInstance)(e)))
          return { nullValue: "NULL_VALUE" };
        if ("number" == typeof e)
          return ((r = t.serializer), eH((n = e)) ? n_(n) : nE(r, n));
        if ("boolean" == typeof e) return { booleanValue: e };
        if ("string" == typeof e) return { stringValue: e };
        if (e instanceof Date) {
          let r = ep.fromDate(e);
          return { timestampValue: ip(t.serializer, r) };
        }
        if (e instanceof ep) {
          let r = new ep(e.seconds, 1e3 * Math.floor(e.nanoseconds / 1e3));
          return { timestampValue: ip(t.serializer, r) };
        }
        if (e instanceof lH)
          return {
        ...
        if (e instanceof l$)
          return { bytesValue: ig(t.serializer, e._byteString) };
        if (e instanceof lL) {
          let r = t.databaseId,
          ...
          return {
            mapValue: {
              fields: {
                ...
                [ru]: {
                  arrayValue: {
                    values: ((i = e) instanceof lW ? i.toArray() : i).map(
                      (e) => {
                        if ("number" != typeof e)
                          throw t.Dc(
        ...
        if (iM(e)) return e._toProto(t.serializer);
        throw t.Dc(`Unsupported field value: ${eu(e)}`);
      })(e, t);
    }
    function l9(e, t) {
      let r = {};
    ...
    function ut(e, t, r) {
      if (!ue(r) || !el(r)) {
        let n = eu(r);
        throw "an object" === n
          ? t.Dc(e + " a custom object")
          : t.Dc(e + " " + n);
      }
    }
    function ur(e, t, r) {
      if ((t = (0, w.getModularInstance)(t)) instanceof lK)
        return t._internalPath;
      if ("string" == typeof t) return ui(e, t);
      throw us(
    ...
    function ui(e, t, r) {
      ...
      try {
        return new lK(...t.split("."))._internalPath;
      } catch (n) {
        throw us(
    ...
    function us(e, t, r, n, i) {
      ...
      return (
        (s || a) &&
          ...
          a && (l += ` in document ${i}`),
          (l += ")")),
        new F(V.INVALID_ARGUMENT, o + e + l)
      );
    }
    function ua(e, t) {
    ...
    class uo {
      convertValue(e, t = "none") {
        switch (rc(e)) {
          ...
          case 6:
            return this.convertBytes(t6(e.bytesValue));
          case 7:
      ...
      convertVectorValue(e) {
        return new lW(
          e.fields?.[ru].arrayValue?.values?.map((e) => t2(e.doubleValue)),
        );
      }
      convertGeoPoint(e) {
        return new lH(t2(e.latitude), t2(e.longitude));
      }
      convertArray(e, t) {
      ...
      convertServerTimestamp(e, t) {
        switch (t) {
          ...
          case "estimate":
            return this.convertTimestamp(re(e));
          default:
            return null;
        }
      }
      ...
      convertDocumentKey(e, t) {
        let r = et.fromString(e);
        M(iL(r), 9688, { name: e });
        let n = new rn(r.get(1), r.get(3)),
          i = new ei(r.popFirst(5));
        return (
          n.isEqual(t) ||
            N(
      ...
      [
                ...
                n.resolve(
                  (async function (e, t, r) {
                    ...
                    let {
                        ...
                        r.forEach((e) => {
                          ...
                          ((s[t] = e.alias),
                            "count" === e.aggregateType
                              ? a.push({ alias: t, count: {} })
                              : "avg" === e.aggregateType
                                ? a.push({
                                    alias: t,
                                    avg: { field: iO(e.fieldPath) },
                                  })
                                : "sum" === e.aggregateType &&
                                  a.push({
                                    alias: t,
                                    sum: { field: iO(e.fieldPath) },
                                  }));
                        }),
                        {
                          request: {
                      ...
                      e.serializer,
                      ((n = t).Re || (n.Re = nr(n, n.explicitOrderBy)), n.Re),
                      r,
                    );
                    e.connection.Ko || delete i.parent;
                    let o = (
                      await e.jo(
                        "RunAggregationQuery",
                        e.serializer.databaseId,
                    ...
                    M(1 === o.length, 64727);
                    let l = o[0].result?.aggregateFields;
        ...
        function (e, t, r) {
          ...
          return (
            e.asyncQueue.enqueueAndForget(async () => {
              let i = await lE(e);
              new lf(e.asyncQueue, i, r, t, n).Xu();
            }),
            n.promise
          );
        },
        ...
        function (e, t) {
          ...
          return (
            e.asyncQueue.enqueueAndForget(async () =>
              (async function (e, t, r) {
                try {
                  let n = await e.persistence.runTransaction(
                    "read document",
                    "readonly",
                    (r) => e.localDocuments.getDocument(r, t),
                  );
                  n.isFoundDocument()
                    ? r.resolve(n)
                    : n.isNoDocument()
                  ...
                  let e = od(n, `Failed to get document '${t} from cache`);
                  r.reject(e);
                }
              })(await lb(e), t, r),
            ),
        ...
        function (e, t) {
          ...
          return (
            e.asyncQueue.enqueueAndForget(async () =>
              (async function (e, t, r) {
                try {
                  let n = await an(e, t, !0),
                    i = new oN(t, n.ks),
                    s = i._u(n.documents),
                    a = i.applyChanges(s, !1);
                  r.resolve(a.snapshot);
                } catch (n) {
                  let e = od(n, `Failed to execute query '${t} against cache`);
                  r.reject(e);
                }
              })(await lb(e), t, r),
            ),
              ...
              e.asyncQueue.enqueueAndForget(async () => {
                ...
                (async function (e, t, r) {
                  try {
                    ...
                    r._updateProgress(ok(a));
                    let o = new oA(a, t.serializer),
                      l = await t.Fu();
                    for (; l; ) {
                      let e = await o.Ha(l);
                      (e && r._updateProgress(e), (l = await t.Fu()));
                    }
                    let u = await o.Xa(e.localStore);
                    return (
                      await o0(e, u.eu, void 0),
                      await ((i = e.localStore),
                      i.persistence.runTransaction(
                        "Save bundle",
                        "readwrite",
                        (e) => i.Pi.saveBundleMetadata(e, a),
                      )),
                      r._completeWith(u.progress),
                      Promise.resolve(u.Ya)
                    );
                  } catch (e) {
                    return (
                      R(oR, `Loading bundle failed with ${e}`),
                      r._failWith(e),
                      Promise.resolve(new Set())
                    );
                  }
        ...
        function (e, t, ...r) {
          if (
            ((e = (0, w.getModularInstance)(e)),
            es("collection", "path", t),
            e instanceof lR)
          ) {
            let n = et.fromString(t, ...r);
            return (eo(n), new lM(e, null, n));
          }
          {
            if (!(e instanceof lL || e instanceof lM))
              throw new F(
            ...
            let n = e._path.child(et.fromString(t, ...r));
            return (eo(n), new lM(e.firestore, null, n));
          }
        },
        "aQ",
        0,
        ...
        0,
        function (e, t) {
          let r = "object" == typeof e ? e : (0, g.getApp)(),
            n = (0, g._getProvider)(r, "firestore").getImmediate({
              identifier: "string" == typeof e ? e : t || rr,
            });
          if (!n._initialized) {
            let e = (0, w.getDefaultEmulatorHostnameAndPort)("firestore");
            e && lO(n, ...e);
          }
          return n;
        },
        ...
        function (e, t) {
          var r;
          return ((r = lz((e = eh(e, lq)))),
          r.asyncQueue.enqueue(async () => {
            var e;
            return (
              (e = await lb(r)),
              e.persistence.runTransaction("Get named query", "readonly", (r) =>
                e.Pi.getNamedQuery(r, t),
              )
            );
          })).then((t) => (t ? new lP(e, null, t.query) : null));
        },
        "ab",
        0,
        function (e, t) {
          ...
          return (
            e.asyncQueue.enqueueAndForget(async () => {
              var t;
              return ((t = await l_(e)), void (t.xa.add(r), r.next()));
            }),
            () => {
              (r.Ku(),
                e.asyncQueue.enqueueAndForget(async () => {
                  var t;
                  return ((t = await l_(e)), void t.xa.delete(r));
                }));
            }
          );
        },
        ...
        function (e) {
          return e.asyncQueue.enqueue(async () => {
            ...
            let r;
            return (
              (r = (t = await lb(e)).indexManager),
              t.persistence.runTransaction(
                "Delete All Indexes",
                "readwrite",
                (e) => r.deleteAllFieldIndexes(e),
              )
            );
          });
        },
        ...
        function (e, t) {
          return e.asyncQueue.enqueue(async () => {
            var r;
            return ((r = await lb(e)), void (r.Cs.As = t));
          });
        },
        "am",
        0,
        function (e) {
          if (n1) throw Error("a TestingHooksSpi instance is already set");
          n1 = e;
        },
        "an",
        0,
        ...
        class {
          constructor(e, t, r) {
            ((this.alias = e), (this.aggregateType = t), (this.fieldPath = r));
          }
        },
        "ap",
        0,
        ...
        class extends la {
          ...
          async initialize(e) {
            await super.initialize(e);
            let t = this.Lu.syncEngine;
            (this.sharedClientState instanceof aI &&
          ...
          Mu(e) {
            ...
            return new aI(t, e.asyncQueue, r, e.clientId, e.initialUser);
          }
        },
        "b",
        0,
        ...
        function (e, t) {
          return (
            (e = (0, w.getModularInstance)(e)),
            (t = (0, w.getModularInstance)(t)),
            e instanceof lP &&
              t instanceof lP &&
              e.firestore === t.firestore &&
              na(e._query, t._query) &&
    ...
    class ud {
      ...
      get(e) {
        if (this._document) {
          let t = this._document.data.field(ur("DocumentSnapshot.get", e));
    ...
    class uy extends um {
      ...
      _apply(e) {
        ...
        return (
          u_(e._query, t),
          new lP(e.firestore, e.converter, nn(e._query, t))
        );
      }
      _parse(e) {
        let t = l1(e.firestore);
        return (function (e, t, r, n, i, s, a) {
          ...
          if (i.isKeyField()) {
            ...
            if ("in" === s || "not-in" === s) {
              uE(a, s);
              let t = [];
              for (let r of a) t.push(uI(n, e, r));
              o = { arrayValue: { values: t } };
            } else o = uI(n, e, a);
          } else
            (("in" !== s && "not-in" !== s && "array-contains-any" !== s) ||
              uE(a, s),
              (o = l8(r, t, a, "in" === s || "not-in" === s)));
          return rV.create(i, s, o);
        })(
          e._query,
          "where",
          t,
    ...
    class uv extends ug {
      ...
      _parse(e) {
        ...
        return 1 === t.length ? t[0] : rF.create(t, this._getOperator());
      }
      _apply(e) {
        let t = this._parse(e);
        return 0 === t.getFilters().length
          ...
          : ((function (e, t) {
              let r = e;
              for (let e of t.getFlattenedFilters()) (u_(r, e), (r = nn(r, e)));
            })(e._query, t),
            new lP(e.firestore, e.converter, nn(e._query, t)));
      }
    ...
    class uw extends um {
      ...
      _apply(e) {
        ...
        return new lP(e.firestore, e.converter, ni(e._query, t));
      }
    }
    class ub extends um {
      constructor(e, t, r) {
      ...
      _apply(e) {
        return new lP(
          e.firestore,
          e.converter,
          ns(e._query, this._limit, this._limitType),
        );
      }
    }
    function uI(e, t, r) {
      if ("string" == typeof (r = (0, w.getModularInstance)(r))) {
        if ("" === r)
          throw new F(
            V.INVALID_ARGUMENT,
        ...
        let n = t.path.child(et.fromString(r));
        if (!ei.isDocumentKey(n))
          throw new F(
            V.INVALID_ARGUMENT,
        ...
        return rv(e, new ei(n));
      }
      if (r instanceof lL) return rv(e, r._key);
      throw new F(
        V.INVALID_ARGUMENT,
        `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${eu(r)}.`,
      );
    }
    function uE(e, t) {
    ...
    class uC extends ud {
      ...
      get(e, t = {}) {
        if (this._document) {
          let r = this._document.data.field(ur("DocumentSnapshot.get", e));
          if (null !== r)
    ...
    ((uC._jsonSchemaVersion = "firestore/documentSnapshot/1.0"),
      (uC._jsonSchema = {
        type: ed("string", uC._jsonSchemaVersion),
        bundleSource: ed("string", "DocumentSnapshot"),
        bundleName: ed("string"),
        bundle: ed("string"),
      }));
    class uA extends uC {
      data(e = {}) {
    ...
    class uk {
      ...
      toJSON() {
        ...
        let e = {};
        ((e.type = uk._jsonSchemaVersion),
          (e.bundleSource = "QuerySnapshot"),
          (e.bundleName = W.newId()),
    ...
    ((uk._jsonSchemaVersion = "firestore/querySnapshot/1.0"),
      (uk._jsonSchema = {
        type: ed("string", uk._jsonSchemaVersion),
        bundleSource: ed("string", "QuerySnapshot"),
        bundleName: ed("string"),
        bundle: ed("string"),
      }));
    function ux(e, t, r) {
      ...
      return new uC(
        ...
        t._key,
        n,
        new uS(r.hasPendingWrites, r.fromCache),
        t.converter,
      );
    }
    (new WeakMap(),
      (function (e = !0) {
        (A(g.SDK_VERSION),
            ...
            new m.Component(
              ...
              (t, { instanceIdentifier: r, options: n }) => {
                let i = t.getProvider("app").getImmediate(),
                  s = new lq(
                    new z(t.getProvider("auth-internal")),
                    new H(i, t.getProvider("app-check-internal")),
                    ri(i, r),
                    i,
                  );
                return (
                  (n = { useFetchStreams: e, ...n }),
                  s._setSettings(n),
                  s
                );
              },
          ...
          (0, g.registerVersion)(uu, uh, void 0),
          (0, g.registerVersion)(uu, uh, "esm2020"));
      })(),
      e.s(
        [
          "addDoc",
          ...
          function (e) {
            e = eh(e, lL);
            let t = eh(e.firestore, lq);
            return lS(lz(t), e._key).then((r) => ux(t, e, r));
          },
          "getDocs",
          0,
          function (e) {
            ...
            return (
              up(e._query),
              lC(r, e._query).then((r) => new uk(t, n, e, r))
            );
          },
          "limit",
          0,
          function (e) {
            return (ec("limit", e), ub._create("limit", e, "F"));
          },
          "onSnapshot",
          0,
          function (e, ...t) {
            ...
            let s = { includeMetadataChanges: !1, source: "default" },
              a = 0;
            "object" != typeof t[0] || uc(t[a]) || (s = t[a++]);
            let o = {
            ...
            if (uc(t[a])) {
              let e = t[a];
              ((t[a] = e.next?.bind(e)),
                (t[a + 1] = e.error?.bind(e)),
                (t[a + 2] = e.complete?.bind(e)));
            }
            if (e instanceof lL)
              ((n = eh(e.firestore, lq)),
                (i = r8(e._key.path)),
              ...
              let s = eh(e, lP);
              ((n = eh(s.firestore, lq)), (i = s._query));
              let o = new ul(n);
              ((r = {
                next: (e) => {
                  t[a] && t[a](new uk(n, o, s, e));
                },
                error: t[a + 1],
                complete: t[a + 2],
              }),
            ...
            return lT(lz(n), i, o, r);
          },
          "orderBy",
          0,
          function (e, t = "asc") {
            let r = ur("orderBy", e);
            return uw._create(r, t);
          },
          "query",
          0,
          function (e, t, ...r) {
            let n = [];
            for (let i of (t instanceof ug && n.push(t),
            (function (e) {
              let t = e.filter((e) => e instanceof uv).length,
                r = e.filter((e) => e instanceof uy).length;
              if (t > 1 || (t > 0 && r > 0))
                throw new F(
                  V.INVALID_ARGUMENT,
          ...
          function (e, t, r) {
            var n, i;
            e = eh(e, lL);
            let s = eh(e.firestore, lq),
              a = uT(e.converter, t, r),
              o = l1(s);
            return (
              (n = s),
              (i = [
                l2(o, "setDoc", e._key, a, null !== e.converter, r).toMutation(
                  e._key,
                  nM.none(),
                ),
              ]),
          ...
          function (e, t, r, ...n) {
            var i, s;
            e = eh(e, lL);
            let a = eh(e.firestore, lq),
              o = l1(a);
            return (
              (i = a),
              (s = [
                ("string" == typeof (t = (0, w.getModularInstance)(t)) ||
                t instanceof lK
                  ? l4(o, "updateDoc", e._key, t, r, n)
                  : l3(o, "updateDoc", e._key, t)
                ).toMutation(e._key, nM.exists(!0)),
              ]),
              lA(lz(i), s)
            );
          },
  ...
  (e) => {
    "use strict";
    ((0, e.i(92953).registerVersion)("firebase", "12.13.0", "app"), e.s([]));
  },
  45754,
  612444,
  (e) => {
    "use strict";
    var t = e.i(464104);
    (e.s(["getAuth", () => t.p], 45754),
      e.s(["connectAuthEmulator", () => t.L], 612444));
  },
  959141,
  (e) => {
    "use strict";
    ...
    let o =
      ...
      l = (0, n.getAuth)(o),
      u = (0, s.aX)(o);
    if ("true" === t.default.env.NEXT_PUBLIC_USE_FIREBASE_EMULATOR) {
      l.emulatorConfig ||
        (0, i.connectAuthEmulator)(l, "http://127.0.0.1:9099", {
          disableWarnings: !0,
        });
      try {
        (0, a.aQ)(u, "127.0.0.1", 8080);
      } catch (e) {}
    }
    e.s(["auth", 0, l, "db", 0, u], 959141);
  },
]);
