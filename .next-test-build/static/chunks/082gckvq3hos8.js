  ...
  (t) => {
    ...
    !(function t(e, a, n, r) {
      ...
      function v(t) {
        ...
        return "function" == typeof r ? new r(t) : (t(M, M), null);
      }
      var y =
          ((o = (function () {
        ...
        w =
          ...
          "function" == typeof cancelAnimationFrame
            ? ((l = function (t) {
                var e = Math.random();
                return (
                  (h[e] = requestAnimationFrame(function a(n) {
                    f === n || f + c - 1 < n
                      ? ((f = n), delete h[e], t())
        ...
        x =
          ...
          function () {
            ...
            if (!n && p) {
              ...
              var a = u;
              function r(t, e) {
                a.postMessage({ options: t || {}, callback: e });
              }
              ((a.init = function (t) {
                var e = t.transferControlToOffscreen();
                a.postMessage({ canvas: e }, [e]);
              }),
                (a.fire = function (t, e, n) {
                  if (d) return (r(t, null), d);
                  ...
                  return (d = v(function (e) {
                    ...
                    (a.addEventListener("message", i),
                      r(t, o),
                      (m[o] = i.bind(null, { data: { callback: o } })));
                  }));
                }),
                (a.reset = function () {
                  for (var t in (a.postMessage({ reset: !0 }), m))
                    (m[t](), delete m[t]);
                }));
            }
            return u;
      ...
      function k(t, a) {
        var o,
          ...
          l = !!T(a || {}, "resize"),
          s = !1,
          c = T(a, "disableForReducedMotion", Boolean),
          h = p && T(a || {}, "useWorker") ? x() : null,
          f = i ? O : B,
        ...
        function m(a) {
          var m,
            g = c || T(a, "disableForReducedMotion", Boolean),
            p = T(a, "zIndex", Number);
          if (g && d)
            return v(function (t) {
              t();
          ...
          function C() {
            ((o = null),
              l && ((s = !1), e.removeEventListener("resize", x)),
              i &&
                t &&
          ...
          l && !s && ((s = !0), e.addEventListener("resize", x, !1)),
          h)
            ? h.fire(a, M, C)
            : (function (e, a, i) {
                for (
                  var l,
                    ...
                    d,
                    m,
                    g = T(e, "particleCount", I),
                    p = T(e, "angle", Number),
                    M = T(e, "spread", Number),
                    x = T(e, "startVelocity", Number),
                    C = T(e, "decay", Number),
                    P = T(e, "gravity", Number),
                    E = T(e, "drift", Number),
                    O = T(e, "colors", S),
                    B = T(e, "ticks", Number),
                    k = T(e, "shapes"),
                    ...
                    F = !!T(e, "flat"),
                    R =
                      (((l = T(e, "origin", Object)).x = T(l, "x", Number)),
                      (l.y = T(l, "y", Number)),
                      l),
                    N = g,
                    z = [],
                  ...
                  z.push(
                    (function (t) {
                      ...
                      startVelocity: x,
                      color: O[N % O.length],
                      shape: k[Math.floor(Math.random() * (k.length - 0)) + 0],
                      ticks: B,
                      decay: C,
                      gravity: P,
                      drift: E,
                    ...
                    (m = v(function (t) {
                      ...
                      ((c = w.frame(function t() {
                        (n &&
                          ...
                          ((a.width = s.width = r.width),
                          (a.height = s.height = r.height)),
                          a.width ||
                            a.height ||
                            (f(s), (a.width = s.width), (a.height = s.height)),
                          d.clearRect(0, 0, a.width, a.height),
                          (u = u.filter(function (t) {
                            return (function (t, e) {
                              ...
                              var a,
                                ...
                                C = e.wobbleX + e.random * e.tiltCos,
                                T = e.wobbleY + e.random * e.tiltSin;
                              if (
                                ((t.fillStyle =
                                  "rgba(" +
                                  e.color.r +
                                ...
                                var I = (Math.PI / 10) * e.wobble,
                                  P = 0.1 * Math.abs(C - w),
                                  S = 0.1 * Math.abs(T - x),
                                  E = e.shape.bitmap.width * e.scalar,
                                  O = e.shape.bitmap.height * e.scalar,
                                  B = new DOMMatrix([
                                    Math.cos(I) * P,
                                    Math.sin(I) * P,
                                    -Math.sin(I) * S,
                                ...
                                B.multiplySelf(new DOMMatrix(e.shape.matrix));
                                var k = t.createPattern(
                                  y.transform(e.shape.bitmap),
                                  "no-repeat",
                                );
                                (k.setTransform(B),
                                  (t.globalAlpha = 1 - v),
                                  (t.fillStyle = k),
                                  t.fillRect(e.x - E / 2, e.y - O / 2, E, O),
                                  (t.globalAlpha = 1));
                                ...
                                t.ellipse
                                  ? t.ellipse(
                                      e.x,
                                      e.y,
                                      Math.abs(C - w) * e.ovalScalar,
                                      Math.abs(T - x) * e.ovalScalar,
                                      (Math.PI / 10) * e.wobble,
                                      0,
                                      2 * Math.PI,
                                    )
                                  : ((u = e.x),
                                    (d = e.y),
                                    (m = Math.abs(C - w) * e.ovalScalar),
                                    (g = Math.abs(T - x) * e.ovalScalar),
                                    (p = (Math.PI / 10) * e.wobble),
                                    (M = 2 * Math.PI),
                                    t.save(),
                                    t.translate(u, d),
                                    t.rotate(p),
                                ...
                                (t.moveTo(Math.floor(e.x), Math.floor(e.y)),
                                  ...
                                  t.lineTo(Math.floor(C), Math.floor(T)),
                                  t.lineTo(
                                    Math.floor(w),
      ...
      function A() {
        return (g || (g = k(null, { useWorker: !0, resize: !0 })), g);
      }
      ((a.exports = function () {
        ...
        (a.exports.shapeFromPath = function (t) {
          ...
          "string" == typeof t ? (n = t) : ((n = t.path), (r = t.matrix));
          var e = new Path2D(n),
            a = document.createElement("canvas").getContext("2d");
          if (!r) {
            for (
              var n, r, o, i, l = 1e3, s = 1e3, c = 0, h = 0, f = 0;
              f < 1e3;
              f += 2
            )
              for (var u = 0; u < 1e3; u += 2)
                a.isPointInPath(e, f, u, "nonzero") &&
                  ((l = Math.min(l, f)),
                  (s = Math.min(s, u)),
                  (c = Math.max(c, f)),
                  (h = Math.max(h, u)));
            o = c - l;
            var d = Math.min(10 / o, 10 / (i = h - s));
            r = [
              d,
              0,
              0,
          ...
          return { type: "path", path: n, matrix: r };
        }),
    ...
    let a = e.exports;
    (e.exports.create, t.s(["default", 0, a]));
  },
]);
