...
`;
    ...
    function l(e) {
      let t = e.some((e) => Object.keys(e.alternates ?? {}).length > 0),
        ...
        o = "";
      for (let s of ((o += '<?xml version="1.0" encoding="UTF-8"?>\n'),
      (o += '<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"'),
      r &&
        (o += ' xmlns:image="http://www.google.com/schemas/sitemap-image/1.1"'),
      i &&
        (o += ' xmlns:video="http://www.google.com/schemas/sitemap-video/1.1"'),
      t
...
`;
        ...
        (s.changeFrequency &&
          (o += `<changefreq>${s.changeFrequency}</changefreq>
`),
          "number" == typeof s.priority &&
            (o += `<priority>${s.priority}</priority>
`),
          (o += "</url>\n"));
      }
      return o + "</urlset>\n";
  ...
  (e) => {
    ...
    function x() {
      return {
        ...
        sitemap: "https://hey-fede.de/sitemap.xml",
      };
    }
    e.s(["default", 0, x], 339621);
    var y = e.i(973853);
    async function R() {
      let e = await x(),
        t = (0, y.resolveRouteData)(e, "robots");
      return new w.NextResponse(t, {
        headers: {
    ...
    let _ = new t.AppRouteRouteModule({
      ...
      { workAsyncStorage: A, workUnitAsyncStorage: E, serverHooks: $ } = _;
    async function C(e, t, i) {
      (i.requestMeta && (0, o.setRequestMeta)(e, i.requestMeta),
        _.isDev &&
          (0, o.addRequestMeta)(
            e,
      ...
      let w = "/robots.txt/route";
      w = w.replace(/\/index$/, "") || "/";
      let x = await _.prepare(e, t, { srcPage: w, multiZoneDraftMode: !1 });
      if (!x)
        return (
          (t.statusCode = 400),
          t.end("Bad Request"),
      ...
      let {
        ...
        j = !!(C.dynamicRoutes[k] || C.routes[T]),
        M = async () => (
          (null == q ? void 0 : q.render404)
            ? await q.render404(e, t, E, !1)
      ...
      if (j && !$) {
        let e = !!C.routes[T],
          t = C.dynamicRoutes[k];
        if (t && !1 === t.fallback && !e) {
          if (A.adapterPath) return await M();
          throw new m.NoFallbackError();
        }
      }
      let U = null;
      !j || _.isDev || $ || (U = "/index" === (U = T) ? "/" : U);
      let D = !0 === _.isDev || !j,
        H = j && !D;
      S &&
        N &&
      ...
      let I = e.method || "GET",
        ...
        K = !!(null == q ? void 0 : q.isWrappedByNextServer),
        G = !!(0, o.getRequestMeta)(e, "minimalMode"),
        L =
          (0, o.getRequestMeta)(e, "incrementalCache") ||
          (await _.getIncrementalCache(e, A, C, G));
      ...
      let V = {
          ...
          renderOpts: {
            ...
            onInstrumentationRequestError: (t, r, i, o) =>
              _.onRequestError(e, t, i, o, q),
          },
          sharedContext: { buildId: y, deploymentId: R },
        },
      ...
      try {
        let o,
          ...
          l = async (o) => {
            ...
            return (
              (G && j) || u.delete(h.NEXT_CACHE_TAGS_HEADER),
              !d.cacheControl ||
...
//# sourceMappingURL=%5Broot-of-the-server%5D__033oq~l._.js.map
