...
- Name: liquid-transition.spec.ts >> LiquidTransition >> Transition Trigger: Click a navigation link and verify the LiquidTransition overlay element becomes briefly visible
- Location: tests/e2e/liquid-transition.spec.ts:4:7
