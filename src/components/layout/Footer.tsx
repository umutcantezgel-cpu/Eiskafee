      ...
      <div className="hf-footer-grid">
        ...
        <div>
          ...
          >
            ...
            <TransitionLink href="/kontakt" className="hf-footer-link">
              Kontakt
            </TransitionLink>
          </nav>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            <a
              ...
              aria-label="Hey Fede! auf Instagram"
              style={{ color: "#9a7060", transition: "color .2s" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "#CC624C")}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Hey Fede! auf Facebook"
              style={{ color: "#9a7060", transition: "color .2s" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "#CC624C")}
              onMouseLeave={(e) => (e.currentTarget.style.color = "#9a7060")}
            >
