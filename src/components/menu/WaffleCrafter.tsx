...
const InventoryItem = ({
  ...
  item: any;
  onDrop: (item: any, point: { x: number; y: number }) => void;
}) => {
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background: "#fff",
        cursor: "grab",
        boxShadow: "0 4px 14px rgba(45,31,25,.08)",
        minWidth: 88,
        flexShrink: 0,
        userSelect: "none",
        touchAction: "none",
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        borderRadius: "50%",
        background:
          "radial-gradient(circle at 50% 50%, #f5efe8 0%, #E4C0A8 100%)",
        boxShadow:
          "0 24px 60px rgba(204,98,76,0.18), inset 0 -8px 24px rgba(45,31,25,0.08)",
        overflow: "hidden",
        userSelect: "none",
        touchAction: "none",
      }}
        ...
        {active.map((t) => {
          ...
          return (
            <motion.div
              key={t.instanceId}
              initial={
                reduced ? { opacity: 0 } : { scale: 0, rotate: -45, opacity: 0 }
              }
              animate={
                reduced
                  ? { opacity: 1 }
                  : { scale: 1, rotate: t.rot, opacity: 1 }
              }
              ...
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                boxShadow: "0 4px 10px rgba(45,31,25,0.18)",
                pointerEvents: "none",
              }}
            >
...
export function WaffleCrafter() {
  ...
  return (
    <div style={{ marginTop: 14 }}>
      ...
      >
        {WAFFLE_INVENTORY.map((item) => (
          <InventoryItem key={item.id} item={item} onDrop={onDrop} />
        ))}
      </div>
      ...
      >
        ...
        >
          Zieh die Toppings auf deine Waffel — und sieh deine Kreation
          entstehen. Nur eine Vorschau!
        </p>
