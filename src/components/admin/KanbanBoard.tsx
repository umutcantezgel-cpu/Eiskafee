    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100vh-140px)]">
      {STATUS_COLUMNS.map((column) => {
        ...
        return (
          <div
            key={column}
            className={`flex flex-col rounded-3xl ${bgColor} border border-peach/50 p-4`}
          >
                    ...
                    >
                      ...
                      <div className="mb-3">
                        ...
                        {order.items.map((item, idx) => (
                          <p
                            key={idx}
                            className="text-xs text-charcoal/70 font-bold leading-tight mt-1"
                          >
                            {item.quantity}x{" "}
                            <span
                      ...
                      <div className="flex justify-between items-center mt-4 pt-3 border-t border-peach/50">
                        <span className="font-heading text-terracotta">
