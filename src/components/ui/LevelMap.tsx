    ...
    >
      <div style={{ position: 'relative', width: 36, height: '100%' }}>
        ...
        <div style={{
          ...
          background: 'repeating-linear-gradient(to bottom, #E4C0A8 0, #E4C0A8 6px, transparent 6px, transparent 12px)',
        }}/>
            ...
            >
              ...
              >
                <motion.div
                  animate={{
                    scale: active ? 1.4 : 1,
                    backgroundColor: active ? '#CC624C' : '#eedfcc',
                  }}
                  transition={reduced ? { duration: 0 } : { type: 'spring', stiffness: 400, damping: 18 }}
                  style={{
                    width: 14, height: 14, borderRadius: '50%',
                    border: '2px solid #CC624C', position: 'relative',
                  }}
                >
                  {active && !reduced && (
                    <motion.div
                ...
                {active && (
                  <motion.div
                    ...
                    style={{
                      ...
                      color: '#CC624C', whiteSpace: 'nowrap',
                      background: '#f5efe8', padding: '4px 12px', borderRadius: 50,
