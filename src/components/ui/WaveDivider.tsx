...
export function WaveDivider({
  ...
  const d = useTransform(activeOffset, (o) => {
    const oo = flip ? -o : o;
    if (variant === 1)
      return `M0,${30 + oo} C240,${56 + oo * 1.2} 480,${4 - oo * 0.8} 720,${30 + oo} C960,${56 + oo * 1.2} 1200,${4 - oo * 0.8} 1440,${30 + oo} L1440,60 L0,60 Z`;
    if (variant === 2)
      return `M0,${22 + oo * 1.4} C180,${52 + oo} 360,${2 - oo * 0.6} 540,${26 + oo} C720,${50 + oo * 0.9} 900,${8 - oo * 0.5} 1080,${34 + oo} C1260,${56 + oo * 0.8} 1380,${24 - oo * 0.4} 1440,${30 + oo} L1440,60 L0,60 Z`;
