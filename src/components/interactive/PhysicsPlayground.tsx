...
export function PhysicsPlayground() {
  ...
  return (
    ...
    >
      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', pointerEvents: 'none', fontFamily: 'var(--font-calistoga), serif', fontSize: '1.5rem', color: '#CC624C', opacity: 0.5 }}>
        Klicken für mehr!
      </div>
    </div>
  );
