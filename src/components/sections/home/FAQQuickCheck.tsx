  ...
  return (
    <section className="bg-cream py-24 relative z-10">
      <FadeUp className="max-w-[800px] mx-auto px-6">
        ...
        <p className="text-center font-body text-brown-mid mb-12">
          Hier sind die häufigsten Fragen, die unsere Gäste in Wetzlar stellen.
          Für noch mehr Details schau einfach auf unserer ausführlichen
          FAQ-Seite vorbei.
        </p>
          ...
          {topFaqs.map((faq, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="font-heading text-brown text-[1.15rem] leading-tight">
                    {faq.q}
                  </span>
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-transform duration-300 ${isOpen ? "bg-terracotta text-white rotate-180" : "bg-cream text-terracotta"}`}
                  >
                ...
                <AnimatePresence>
                  {isOpen && (
                    ...
                    >
                      <div className="px-6 pb-6 font-body text-brown-mid leading-relaxed">
