export const FAQ_DATA: { q: string; a: string }[] = [
  ...
  // ── Bestellung & Lieferung (10) ────────────────────────────────────
  {
    q: "Kann ich bei Hey Fede online bestellen?",
    a: "Ja, du kannst über unsere Webseite bei uns bestellen und dir deine Lieblings-Desserts direkt nach Hause liefern lassen. Alternativ kannst du auch telefonisch oder per WhatsApp vorbestellen und deine Bestellung abholen.",
  },
  {
    q: "Liefert Hey Fede?",
    a: "Ja, wir liefern im Raum Wetzlar. So kannst du unsere Bubble Waffles, Pancakes und Eis-Kreationen bequem zu Hause genießen, ohne unsere Dessertbar in der Altstadt besuchen zu müssen.",
  },
  {
  ...
  {
    q: "Wie bestelle ich bei Hey Fede online?",
    a: "Gehe einfach auf unsere Webseite und öffne unseren Order-Hub. Dort findest du unsere aktuelle Karte, kannst deine Wunsch-Kreation zusammenstellen und bequem nach Hause liefern lassen.",
  },
  {
  ...
  },
  {
    ...
    a: "Wir akzeptieren Barzahlung, EC-Karte, Kreditkarte und kontaktloses Bezahlen. Bei Online-Bestellungen stehen dir weitere digitale Zahlungsmethoden zur Verfügung.",
  },
  {
