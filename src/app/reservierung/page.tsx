    ...
    <div className="min-h-screen bg-[#f5efe8]">
      <div className="bg-[#E4C0A8] pt-[110px] px-6 pb-12 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="font-calistoga text-[2.2rem] text-[#2d1f19] mb-3">Tisch reservieren</h1>
          <p className="font-nunito text-[#5c3d35] max-w-sm mx-auto text-sm">Plane deinen Besuch</p>
        </div>
      </div>
      ...
      <div className="max-w-[500px] mx-auto px-6 py-10 pb-32">
        <FadeUp className="space-y-8">
          {/* Guests */}
          <div>
            <div className="text-[11px] font-black text-[#CC624C] tracking-[1.4px] uppercase mb-3">Anzahl Gäste</div>
            <div className="bg-white rounded-2xl p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Icons.Users size={22} className="text-[#CC624C]" strokeWidth={1.8} />
                <span className="font-calistoga text-xl text-[#2d1f19]">{guests} Personen</span>
              </div>
              <div className="flex items-center bg-[#eedfcc] rounded-full p-1 gap-1">
                ...
                >
                  <Icons.Minus size={16} className="text-[#2d1f19]" strokeWidth={2.5} />
                </button>
                <button 
                  onClick={() => setGuests(guests + 1)}
                  className="w-8 h-8 rounded-full bg-[#CC624C] flex items-center justify-center shadow-sm"
                >
          ...
          {/* Date */}
          <div>
            <div className="text-[11px] font-black text-[#CC624C] tracking-[1.4px] uppercase mb-3">Datum</div>
          ...
          {/* Time */}
          <div>
            <div className="text-[11px] font-black text-[#CC624C] tracking-[1.4px] uppercase mb-3">
              Uhrzeit · Fr 25.01
            </div>
          ...
          {/* Area */}
          <div>
            <div className="text-[11px] font-black text-[#CC624C] tracking-[1.4px] uppercase mb-3">Bereich (optional)</div>
            <div className="grid grid-cols-2 gap-2">
              {areas.map(a => {
                ...
                return (
                  ...
                  >
                    <Icon size={16} className={isSelected ? 'text-[#E4C0A8]' : 'text-[#CC624C]'} strokeWidth={1.8} />
          ...
          {/* Special Requests */}
          <div>
            <div className="text-[11px] font-black text-[#CC624C] tracking-[1.4px] uppercase mb-3">Besonderer Anlass?</div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#fef8f5] border-t border-[#eedfcc] p-4 z-50">
        <div className="max-w-[500px] mx-auto">
          <div className="bg-[#eedfcc] rounded-xl p-3 mb-3 flex justify-between items-center text-xs">
            <span className="font-bold text-[#5c3d35]">Fr 25.01 · {selectedTime} · {guests} Personen</span>
            <span className="font-black text-[#CC624C] text-[11px]">BEARBEITEN</span>
          </div>
