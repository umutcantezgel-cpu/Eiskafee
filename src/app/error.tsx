...
export default function ErrorPage({
  ...
  return (
    <div className="min-h-screen bg-[#f5efe8] flex flex-col items-center justify-center p-5 text-center">
      ...
      <h1 className="font-calistoga text-4xl text-[#2d1f19] mb-4">
      ...
      <div className="flex gap-4">
        <button
          onClick={() => reset()}
          className="flex items-center gap-2 bg-[#b34832] text-[#f5efe8] px-6 py-3 rounded-xl font-bold shadow-clay hover:bg-[#a84936] transition-colors"
        >
          <RefreshCcw size={18} />
          Nochmal versuchen
        </button>
