...
const FAQS = [
  { question: "Liefert ihr?", answer: "Ja, in ausgewählte PLZs (z.B. 35576, 35578). Check es im Checkout!" },
  { question: "Was ist in der Box?", answer: "2 Waffeln, 4 Soßen, Erdbeeren & sehr viel Liebe." },
  { question: "Vegan?", answer: "Einige Toppings/Soßen sind vegan. Am Teig tüfteln wir noch!" },
  { question: "Reservieren?", answer: "Einfach via WhatsApp oder über die Reservierungs-Seite." }
];
  ...
  return (
    <div className="min-h-[400vh] bg-transparent text-[#2d1f19] font-nunito relative">
      ...
      <section className="min-h-[100vh] flex flex-col justify-center items-center px-6 relative pt-20">
        <GiganticTypography highlightWords={["helfen?"]} highlightColor="#CC624C" className="text-center justify-center max-w-[1200px] mx-auto">
      ...
      <section id="faq" className="min-h-[150vh] px-6 relative z-10 flex flex-col justify-center items-center">
      ...
      <section className="min-h-[150vh] px-6 relative z-10 flex flex-col justify-center items-center overflow-hidden">
        ...
        <div className="w-full max-w-[1200px] grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div style={{ y: formY }} className="z-10">
            <form onSubmit={handleSubmit} className="bg-cream/90 backdrop-blur-xl p-8 md:p-12 rounded-[40px] shadow-clay border border-peach/50 flex flex-col gap-6">
              <h2 className="font-calistoga text-3xl text-charcoal mb-4">Schreib uns</h2>
              
              <div>
                <label className="block text-sm font-black text-brown/70 uppercase tracking-widest mb-2 ml-2">Dein Name</label>
                <input 
                  type="text" required
                  value={formData.name}
              ...
              <div>
                <label className="block text-sm font-black text-brown/70 uppercase tracking-widest mb-2 ml-2">Deine E-Mail</label>
                <input 
                  type="email" required
              ...
              <div>
                <label className="block text-sm font-black text-brown/70 uppercase tracking-widest mb-2 ml-2">Nachricht</label>
                <textarea 
                  required
          ...
          <div className="flex flex-col gap-8 z-10">
             ...
             >
                ...
                <h3 className="font-calistoga text-3xl text-[#3a9d52] mb-4">Direkt Texten?</h3>
                <p className="text-[#3a9d52]/80 text-lg font-bold mb-8">Schreib uns einfach auf WhatsApp. Wir antworten superschnell.</p>
