...
export default function TestRealtimePage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8 bg-cream text-charcoal">
      <h1 className="text-3xl font-heading text-terracotta">
        Realtime Hooks Test
      </h1>
      ...
      <div className="p-6 bg-white rounded-xl shadow-clay">
        ...
        <p>
          Role: <span className="font-bold text-peach">{role || "None"}</span>
        </p>
      </div>
      ...
      <div className="p-6 bg-white rounded-xl shadow-clay">
        ...
        <p className="mt-2 text-sm text-gray-500">
          Gehe in die Firebase Console ➔ Firestore ➔ `store_settings/general`
          und ändere `isOnline` oder `currentWaitTime`. Die Änderung sollte hier
          sofort erscheinen.
        </p>
      </div>
