    ...
    <div className="min-h-screen bg-[#f5efe8] flex flex-col">
      ...
      <div className="bg-[#f5efe8] sticky top-0 z-10 px-5 pt-4 pb-3 flex items-center justify-between">
        ...
        <div className="text-center">
          <div className="font-calistoga text-lg text-[#2d1f19] leading-tight">{orderType === "delivery" ? "Lieferzeit" : "Abholzeit"}</div>
      ...
      <div className="px-5 flex-1 overflow-y-auto pb-6">
        {orderType !== "delivery" && (
          <FadeUp delay={0.1}>
            <div className="font-nunito text-[11px] font-black text-[#CC624C] tracking-[1.4px] uppercase mb-2.5">Ort</div>
            <div className="bg-white rounded-[18px] p-3.5 flex gap-3 items-start mb-5 shadow-sm">
              ...
              <div className="flex-1">
                ...
                <div className="font-nunito text-[11.5px] text-[#7a5a52] mt-0.5">{FULL_ADDRESS}</div>
        ...
        <FadeUp delay={0.2}>
          <div className="font-nunito text-[11px] font-black text-[#CC624C] tracking-[1.4px] uppercase mb-2.5">Welcher Tag?</div>
        ...
        <FadeUp delay={0.3}>
          <div className="font-nunito text-[11px] font-black text-[#CC624C] tracking-[1.4px] uppercase mb-2.5">Welche Uhrzeit?</div>
