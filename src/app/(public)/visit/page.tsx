...
export const metadata = buildMetadata({
  ...
  description: 'Besuche Hey Fede! in der Langgasse 68, Wetzlar. Alle Infos zu Anfahrt, Parken, Öffnungszeiten und Lieferando-Bestellungen.',
  path: '/visit',
  keywords: [
    'Anfahrt Hey Fede',
...
export default function VisitPage() {
  return (
    ...
    <div className="min-h-screen bg-[#f5efe8] animate-fade-in">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div>
                ...
                <div className="flex flex-col gap-3">
                  {[
                    { id: 'lieferando', title: 'Lieferando', sub: 'Keine Liefergebühr · Direkt nach Hause', Icon: Truck, accent: true, href: BUSINESS.lieferandoUrl },
                    { id: 'abholung',   title: 'Abholung',   sub: `Vor Ort: ${FULL_ADDRESS}`,        Icon: MapPin, accent: false, href: DIRECTIONS_URL },
                  ].map(c => (
                    <div key={c.id}
      ...
      <SchemaScripts schema={[buildPlaceSchema(), buildTouristDestinationSchema()]} />
    </>
  );
}
