        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="font-heading text-5xl md:text-6xl text-charcoal mb-6 leading-[1.1]">
              Dein Eiscafé Wetzlar in der historischen Altstadt
            </h1>
            <p className="font-body text-lg text-brown-mid leading-relaxed mb-8 max-w-[500px]">
              ...
              Momente und erstklassigen Dessertgenuss in Wetzlar.
            </p>
      ...
      <section className="py-24 bg-white relative">
        <FadeUp className="max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-lg prose-headings:font-heading prose-headings:text-charcoal prose-p:font-body prose-p:text-brown-mid mt-12 mx-auto">
            ...
            <h2>Qualität & Vielfalt: Hausgemacht und Allergenfreundlich</h2>
            <p>
              Unser Versprechen an dich: Bei Hey Fede! bekommst du
              ausschließlich hausgemachte Produkte aus frischen, hochwertigen
              Zutaten. Wir bieten eine feine Auswahl an veganen Eissortimenten
              und pflanzlichen Milchalternativen, damit bewusste Genießer voll
              auf ihre Kosten kommen. Auch bei Laktoseintoleranz halten wir
              schmackhafte Alternativen bereit. Unser Serviceteam informiert
              dich jederzeit kompetent über Inhaltsstoffe und hilft dir, die
              passende Kreation auszuwählen.
            </p>
            <p>
              Möchtest du unsere Eisspezialitäten und süßen Kreationen entspannt
              auf der eigenen Couch genießen? Über unseren schnellen
              Online-Bestellservice liefern wir Eisbecher, Waffeln, Crêpes und
              Shakes direkt zu dir nach Hause. Unser Liefergebiet umfasst das
              gesamte Stadtgebiet Wetzlar sowie umliegende Gemeinden im
              Lahn-Dill-Kreis. Alternativ kannst du deine Bestellung auch bequem
              zur Wunschzeit in der Langgasse 68 abholen.
            </p>
          </div>
        </FadeUp>
      </section>
      ...
      <section className="py-16 bg-cream">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="font-body text-charcoal/60 text-center mb-8 max-w-lg mx-auto">
            Entdecke echte Impressionen aus unserem Eiscafé Hey Fede! in der
            Wetzlarer Altstadt. Erlebe die liebevolle Zubereitung unserer
            Eisbecher, Waffeln und Erfrischungen hautnah.
          </p>
      ...
      <section className="py-24 bg-terracotta relative text-center text-white overflow-hidden">
        ...
        <FadeUp className="max-w-2xl mx-auto px-6 relative z-10 pt-12">
          ...
          <p className="font-body text-lg text-cream/90 mb-10">
            Entdecke unsere vielfältige Karte mit hausgemachtem Eis, frischen
            Crêpes, knusprigen Bubble Waffles und cremig beladenen Special
            Shakes. Genieße deine Auszeit direkt bei uns vor Ort in der
            Wetzlarer Langgasse oder lass dir deine Lieblingsdesserts bequem
            nach Hause liefern — wir freuen uns auf deinen Besuch!
          </p>
          <a
            href="/menu"
